...
public class IssueFCBDocumentForBillPaymentSettlementData {
	private static final Logger logger = Logger.getLogger(IssueFCBDocumentForBillPaymentSettlementData.class);
	...
	public static void main(String[] args) {
		...
		List<SettlementData> settlementData = GeneralDao.Instance.find("from SettlementData where id in (" +
				...
				" and clearingProfile = 170602 and documentNumber is null order by id");
		...
		IssueFCBThread issueFCBThread = new IssueFCBThread(stlData);
