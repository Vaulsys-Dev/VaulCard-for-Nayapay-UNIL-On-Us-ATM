...
public class ChargeSettlement {
	...
	public static void main(String[] args) {
		...
		try {
			clearingProfile = ClearingService.findClearingProfile(170603L);
		...
		if (clearingProfile != null) {
			...
			ChargeSettlementServiceImpl.Instance.settle(clearingProfile, settleUntilTime, false, true, true);
		}
//		System.exit(0);
	}
}
