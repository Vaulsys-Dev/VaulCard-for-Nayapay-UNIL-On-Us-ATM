...
public class BillSettlement {
	...
	public static void main(String[] args) {
		...
		try {
			clearingProfile = ClearingService.findClearingProfile(170602L);
		...
		if (clearingProfile != null) {
			...
			BillPaymentSettlementServiceImpl.Instance.settle(clearingProfile, settleUntilTime, false, true, true);
		}
//		System.exit(0);
	}
}
