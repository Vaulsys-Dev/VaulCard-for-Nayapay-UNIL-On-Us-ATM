...
public class ATMCurrencySettlement {
	...
	public static void main(String[] args) {
		...
		try {
			clearingProfile = ClearingService.findClearingProfile(170616L);
		...
		if (clearingProfile != null) {
			...
			ATMCurrencySettlementServiceImpl.Instance.settle(clearingProfile, settleUntilTime, false, true, true);
		}
//		System.exit(0);
	}
}
