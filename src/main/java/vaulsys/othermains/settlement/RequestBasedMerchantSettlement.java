...
public class RequestBasedMerchantSettlement {
    ...
    public static void main(String[] args) {
        ...
        try {
                clearingProfile = ClearingService.findClearingProfile(170606L);
        ...
        if (clearingProfile != null) {
                ...
                RequestBasedSettlementServiceImpl.Instance.settle(clearingProfile, settleUntilTime, false, true, true);
        }
//      System.exit(0);
    }
}
