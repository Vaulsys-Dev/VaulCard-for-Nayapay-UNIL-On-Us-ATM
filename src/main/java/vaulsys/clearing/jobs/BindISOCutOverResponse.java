...
public class BindISOCutOverResponse extends AbstractISOClearingJob {

	public static final BindISOCutOverResponse Instance = new BindISOCutOverResponse();
	public BindISOCutOverResponse(){}
    ...
    public void execute(Message incomingMessage, Transaction refTransaction, ProcessContext processContext)
        ...
        Long bankId =Util.longValueOf( protocolMessage.getString(32));
        ...
        if (refTrnx != null) {
            logger.debug("refrence transaction of received 810 is transaction with id:	" + refTrnx.getId());
