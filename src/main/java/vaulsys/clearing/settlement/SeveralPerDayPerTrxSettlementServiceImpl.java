...
public class SeveralPerDayPerTrxSettlementServiceImpl extends SettlementService {

	private static final Logger logger = Logger.getLogger(SeveralPerDayPerTrxSettlementServiceImpl.class);
	
	private SeveralPerDayPerTrxSettlementServiceImpl(){}
	
	public static final SeveralPerDayPerTrxSettlementServiceImpl Instance = new SeveralPerDayPerTrxSettlementServiceImpl();
