...
public class PerTransactionBillPaymentSettlementServiceImpl extends BillPaymentSettlementServiceImpl{
	private static final Logger logger = Logger.getLogger(PerTransactionBillPaymentSettlementServiceImpl.class);
	
	private PerTransactionBillPaymentSettlementServiceImpl(){}
	
	public static final PerTransactionBillPaymentSettlementServiceImpl Instance = new PerTransactionBillPaymentSettlementServiceImpl();
