...
public class KioskPerTransactionBillPaymentSettlementServiceImpl extends BillPaymentSettlementServiceImpl{
	private static final Logger logger = Logger.getLogger(PerTransactionBillPaymentSettlementServiceImpl.class);
	
	private KioskPerTransactionBillPaymentSettlementServiceImpl(){}
	
	public static final KioskPerTransactionBillPaymentSettlementServiceImpl Instance = new KioskPerTransactionBillPaymentSettlementServiceImpl();
