...
public class PerTransactionOnlineBillSettlementServiceImpl extends SettlementService {
	private static final Logger logger = Logger.getLogger(PerTransactionOnlineBillSettlementServiceImpl.class);
	
	private PerTransactionOnlineBillSettlementServiceImpl(){}
	
	public static final PerTransactionOnlineBillSettlementServiceImpl Instance = new PerTransactionOnlineBillSettlementServiceImpl();
	...
	protected List<Terminal> findAllTerminalsBasedOnSettlementRecord(List<Terminal> terminals, List<Long> termCodes, ClearingProfile clearingProfile) {
		if (terminals == null)
			terminals = new ArrayList<Terminal>();
		List<ThirdPartyVirtualTerminal> thirdPartyTerminals = TerminalService.findAllTerminalsWithTrxUntilTimeBasedOnSettlementRecord(terminals, termCodes, ThirdPartyVirtualTerminal.class, clearingProfile);
	...
	List<String> findDesiredTerminalCodes(DateTime accountUntilTime, Boolean justToday, ClearingProfile clearingProfile) {
		...
		List<String> thirdPartyTerminals = TerminalService.findAllTerminalsWithTrxUntilTime(ThirdPartyVirtualTerminal.class, accountUntilTime, justToday, guaranteePeriod);
	...
	protected List findDesiredTerminalCodesBasedOnSettlementRecord(DateTime accountUntilTime, Boolean justToday, ClearingProfile clearingProfile) {
		...
		List<String> thirdPartyTerminals = TerminalService.findAllTerminalsWithTrxUntilTimeBasedOnSettlementRecord(ThirdPartyVirtualTerminal.class, accountUntilTime, justToday, guaranteePeriod, clearingProfile);
		return thirdPartyTerminals;
	}
