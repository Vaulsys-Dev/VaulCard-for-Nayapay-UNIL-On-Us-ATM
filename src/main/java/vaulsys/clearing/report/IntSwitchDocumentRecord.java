...
@Entity
@Table(name = "intswitch_repbal")
public class IntSwitchDocumentRecord implements IEntity<Long> {
	@Id
//	@GeneratedValue(generator = "switch-gen")
    @GeneratedValue(generator="intswitchrepbal-seq-gen")
    @org.hibernate.annotations.GenericGenerator(name = "intswitchrepbal-seq-gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
    		parameters = {
