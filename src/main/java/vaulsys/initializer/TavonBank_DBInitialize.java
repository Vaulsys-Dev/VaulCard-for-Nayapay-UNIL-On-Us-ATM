...
public class TavonBank_DBInitialize {

	public static final long TAVON_BIN = 502807;
...
//	public static final long EPAY_FNP_SHOP_CODE = 1024;
	...
	public static final String ATM_CONFIG_FILE = "C:/Documents and Settings/saber/My Documents/ATM-Config/PasargadATMConfig.2010-03-29.xlsx";
...
//	private static final String EPAY_FNP_TERMINAL_PUBLIC_KEY = "";
	...
	public static void main(String[] args) {
		...
		try {
			new TavonBank_DBInitialize().cereateDB();
		} catch (Exception e) {
			e.printStackTrace();
		...
		GeneralDao.Instance.beginTransaction();
		try {
			new TavonBank_DBInitialize().createCycleAccountJob();
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(2);
		}
...
//		initializer.addEpayTerminalServicePolicy(authorizationProfile_EPAY);
	...
	*/	
		...
		addOrganization.addBillPaymentOrg(clearingProfilePerdayBILL, feeProfileOrg, organizationFinancialEntityGroup,
				orgTerminalGroup);
		
		System.out.println("------- Creating MySelf Institution -------");
		
		AddInstitution.initMyInst(TAVON_BIN, TAVON_BIN, MYSELF_ACQUIER_TERMINAL_CODE, MYSELF_ISSUER_TERMINAL_CODE, switchTerminalGroup, securityProfileDefault, authorizationProfileDefault, null, feeProfileDefault, null, My_MAC_KEY, My_PIN_KEY, null, "سوئیچ تات", "سوئیچ تات");
/*
...
//				feeProfileDefault, chargeAssignmentPolicy, null, null, EPAY_FNP_MASTER_KEY, "سايت اينترنتی (IPG)" ,
//				"سايت اینترنتی تات");
