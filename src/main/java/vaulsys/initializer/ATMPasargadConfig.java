...
public abstract class ATMPasargadConfig  {
	...
	private static Integer atmType = ATMType.NCR;
	private static Integer bankType = BANKType.PASARGAD;
	private static Long Config = 11L;
	...
	/*TAVON*/
	private static final String tavon_updateablePageFontColor = "00;67;80m"; 
...
//AldTODO before 	private static final String pasargad_updateablePageFontColor = "00;80m";
	...
	/*RESALAT*/
	private static final String resalat_updateablePageFontColor = "27;80m";	
	
	/*GARDESHGARI*/
	private static final String gardeshgari_updateablePageFontColor = "00;80m";	
	...
	private static final String TAT_CONFIG_BANK_NAME_FA = "بانک تات"; 
	private static final String TAT_CONFIG_BANK_NAME_EN = "Tat Bank";
	private static final String TAT_CONFIG_BANK_MOUNTTO_FA = "تجربه، اعتماد، توسعه";
	private static final String TAT_CONFIG_BANK_MOUNTTO_EN = " ";
	
	private static final String TAVON_CONFIG_BANK_NAME_FA = "بانک توسعه تعاون";
	private static final String TAVON_CONFIG_BANK_NAME_EN = "Tosee Tavon Bank";
	private static final String TAVON_CONFIG_BANK_MOUNTTO_FA = "همتی برتر برای فردایی بهتر";
	private static final String TAVON_CONFIG_BANK_MOUNTTO_EN = "Tosee Tavon Bank";	
	
	private static final String GARDESHGARI_CONFIG_BANK_NAME_FA = "بانک گردشگردی";
	private static final String GARDESHGARI_CONFIG_BANK_NAME_EN = "Tourism Bank";
	private static final String GARDESHGARI_CONFIG_BANK_MOUNTTO_FA = "بانک گردشگردی";
	private static final String GARDESHGARI_CONFIG_BANK_MOUNTTO_EN = "Tourism Bank";
	
	private static final String RESALAT_CONFIG_BANK_NAME_FA = "بانک قرض الحسنه رسالت";
	private static final String RESALAT_CONFIG_BANK_NAME_EN = "Resalat Bank";
	private static final String RESALAT_CONFIG_BANK_MOUNTTO_FA = "بانک قرض الحسنه رسالت";
	private static final String RESALAT_CONFIG_BANK_MOUNTTO_EN = "Resalat Bank";	
...
//	private static final String closeDoubleQuotationFa = "[ESC](1[0xAE][ESC](7"; 
	...
	static {
		...
		allFunctionsList.put("CashIn", "واریز وجه");
		allFunctionsList.put("Withdrawal", "برداشت وجه");
		allFunctionsList.put("PartialDispense", "برداشت جزیی");
		...
		allFunctionsList.put("TransferToAccountByShenase", "انتقال به سپرده با شناسه");
		allFunctionsList.put("Sheba", "درخواست شبا");
		allFunctionsList.put("HotCard", "مسدود کردن کارت");
		...
		allFunctionsList.put("purchaseTopupCharge", "خرید شارژ مستقیم");
		allFunctionsList.put("Stock", "اعلام سهام");
		allFunctionsList.put("Billpayment", "پرداخت قبض");
		allFunctionsList.put("SatnaTransfer", "انتقال ساتنا");
		allFunctionsList.put("PayaTransfer", "انتقال پایا");
		allFunctionsList.put("ChargeStatement", "صورتحساب شارژ");
		allFunctionsList.put("Restriction", "محدودیت کارت");
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			ATMPasargadConfig.setSelectedFunctionList(allFunctionsList.values().toArray());
			new ATMPasargadConfig(){
...
//			new ATMPasargadConfig().addConfig();
	...
	public ATMPasargadConfig() {
		
	}
	
	public ATMPasargadConfig(Long config,String bankName,String atmTypeStr,Boolean doCaptureCard,String desc) {
	...
	public void setBankParameter(Integer bankType ){
    	...
    	else if (BANKType.TAAVON.equals(bankType)){
    		updateablePageFontColor = tavon_updateablePageFontColor;
    		CONFIG_BANK_NAME_FA = TAVON_CONFIG_BANK_NAME_FA;
    		CONFIG_BANK_NAME_EN = TAVON_CONFIG_BANK_NAME_EN;
    		CONFIG_BANK_MOUNTTO_FA = TAVON_CONFIG_BANK_MOUNTTO_FA;
    		CONFIG_BANK_MOUNTTO_EN = TAVON_CONFIG_BANK_MOUNTTO_EN;
    	} 
    	else if (BANKType.GARDESHGARI.equals(bankType)){
    		updateablePageFontColor = gardeshgari_updateablePageFontColor;
    		CONFIG_BANK_NAME_FA = GARDESHGARI_CONFIG_BANK_NAME_FA;
    		CONFIG_BANK_NAME_EN = GARDESHGARI_CONFIG_BANK_NAME_EN;
    		CONFIG_BANK_MOUNTTO_FA = GARDESHGARI_CONFIG_BANK_MOUNTTO_FA;
    		CONFIG_BANK_MOUNTTO_EN = GARDESHGARI_CONFIG_BANK_MOUNTTO_EN;
    	} 
    	else if (BANKType.RESALAT.equals(bankType)){
    		updateablePageFontColor = resalat_updateablePageFontColor;
    		CONFIG_BANK_NAME_FA = RESALAT_CONFIG_BANK_NAME_FA;
    		CONFIG_BANK_NAME_EN = RESALAT_CONFIG_BANK_NAME_EN;
    		CONFIG_BANK_MOUNTTO_FA = RESALAT_CONFIG_BANK_MOUNTTO_FA;
    		CONFIG_BANK_MOUNTTO_EN = RESALAT_CONFIG_BANK_MOUNTTO_EN;
    	} else {
    		updateablePageFontColor = pasargad_updateablePageFontColor;
    		CONFIG_BANK_NAME_FA = PASARGAD_CONFIG_BANK_NAME_FA;
    		CONFIG_BANK_NAME_EN = PASARGAD_CONFIG_BANK_NAME_EN;
    ...
    public void addConfig() throws Exception {
    	...
    	if (BANKType.PASARGAD.equals(bankType)){
    		...
    		addTavonConfig(atmTerminalGroup);
    	} 
    	else if (BANKType.GARDESHGARI.equals(bankType)){
    		...
    		if(updateConfig)
    			updateConfigForThirdParty(atmTerminalGroup);
    		else
    			addNewConfig(atmTerminalGroup);
    	} else {
    		addNewConfig(atmTerminalGroup);
  ...
  //Mirkamali(Task162)
  	private void updateConfigForThirdParty(TerminalGroup atmTerminalGroup)throws Exception {
...
//  				+ "[ESC][OC]00;67;80m");
  		...
  		ATMConfiguration configuration = GeneralDao.Instance.load(ATMConfiguration.class, Config);
  		List<ATMRequest> requestsThirdPArtyPayment = CharityHelp(configuration, response);
  		
  		for(ATMRequest request : requestsThirdPArtyPayment){
  			configuration.addRequset(request);
  			getGeneralDao().saveOrUpdate(request);
  		}
  		
//  		ATMConfiguration configuration = GeneralDao.Instance.load(ATMConfiguration.class, Config);
//		
//		Map<Integer, ATMResponse> responseMap = null;
//		
...
//		responseMap = sharedResponsesShetab();
//		for (Integer integer : responseMap.keySet()) {
//			getGeneralDao().saveOrUpdate(responseMap.get(integer));
    ...
    private void addPasargadConfig(TerminalGroup atmTerminalGroup) throws Exception {
		...
		if (!atmType.equals(ATMType.NCR)) {	
			if (!Util.hasText(Description))
				configuration.setName("تنظیمات پیش فرض خودپرداز با تعریف همراه اول و انگلیسی و ده هزارتومانی و رایتل به همراه شارژ مستقیم");
			else
		...
		{
			if (!Util.hasText(Description))
				configuration.setName("تنظیمات پیش فرض خودپرداز با تعریف همراه اول و انگلیسی و ده هزارتومانی و رایتل به همراه شارژ مستقیم - NCR");
			else
		...
		if (CheckMustBeAddThisFunction("Withdrawal")) {
		...
		if (CheckMustBeAddThisFunction("PartialDispense")) {
		...
		if (CheckMustBeAddThisFunction("Restriction")) {
			List<ATMRequest> requestsRestriction = Restriction(configuration/*, responsePasargadSubsidiary*/);
			if (requestsRestriction != null)
				requests.addAll(requestsRestriction);
		}
...
//		gholami(Task45875)
		if (CheckMustBeAddThisFunction("TransferToAccountByShenase")) {
			List<ATMRequest> requestsTransferToAccountByShenase = TransferToAccountByShenase(configuration, responsePasargadSubsidiary);
			if (requestsTransferToAccountByShenase != null)
				requests.addAll(requestsTransferToAccountByShenase);
		}
		...
		//TASK Task001 : Sheba
		if (CheckMustBeAddThisFunction("Sheba")) {
			List<ATMRequest> requestsSheba = Sheba(configuration, responsePasargadSubsidiary); 
			if (requestsSheba != null)
				requests.addAll(requestsSheba);
		}
		
		
		//TASK Task015 : HotCard
		if (CheckMustBeAddThisFunction("HotCard")) {
			List<ATMRequest> requestsHotCard = HotCard(configuration, responsePasargadSubsidiary);  //AldTODO Task016 : Aya Niazi Hast responsePasargadSubsidiary befrestim
			if (requestsHotCard != null)
				requests.addAll(requestsHotCard);
		}
		
		//TASK Task004 : Deposit
		if (CheckMustBeAddThisFunction("CashIn")) {
			List<ATMRequest> requestsCashIn = CashIn(configuration, responsePasargadSubsidiary);  
			if (requestsCashIn != null)
				requests.addAll(requestsCashIn);
		}
		...
		if (CheckMustBeAddThisFunction("purchaseTopupCharge")) {
			List<ATMRequest> requestsPurchaseTopupCharge = purchaseTopupCharge(configuration, responsePasargadSubsidiary);
			if(requestsPurchaseTopupCharge != null)
				requests.addAll(requestsPurchaseTopupCharge);
		}
		
		//TASK Task081 : ATM Saham feature
		if (CheckMustBeAddThisFunction("Stock")) {
			List<ATMRequest> requestsStock = Stock(configuration, responsePasargadSubsidiary);
			if(requestsStock != null)
				requests.addAll(requestsStock);
		}
		
		//TASK Task114 : SatnaTransfer
//		if (CheckMustBeAddThisFunction("SatnaTransfer")) {
//			List<ATMRequest> requestsStnaTransfer = SatnaTransfer(configuration, responsePasargadSubsidiary);
//			if(requestsStnaTransfer != null)
//				requests.addAll(requestsStnaTransfer);
//		}	
		
		//TASK Task114 : SatnaTransfer
//		if (CheckMustBeAddThisFunction("PayaTransfer")) {
//			List<ATMRequest> requestsPayaTransfer = PayaTransfer(configuration, responsePasargadSubsidiary);
//			if(requestsPayaTransfer != null)
//				requests.addAll(requestsPayaTransfer);
//		}
		
		// TASK Task117 (3404) : Charge Statement
//		if (CheckMustBeAddThisFunction("ChargeStatement")) {
//			List<ATMRequest> requestsChargeStatement = ChargeStatement(configuration, responsePasargadSubsidiary);
//			if(requestsChargeStatement != null)
//				requests.addAll(requestsChargeStatement);
//		}
...
//		getGeneralDao().save(receiptError);
	...
	private void addTavonConfig(TerminalGroup atmTerminalGroup) throws Exception {
		ATMConfiguration configuration = null;
		if (!updateConfig){
			Map<String, Object> params = new HashMap<String, Object>();
			params.put("id", Config);
...
//			requests.addAll(requestsCancel);
		...
		//TASK Task114 : SatnaTransfer
		if (CheckMustBeAddThisFunction("SatnaTransfer")) {
			List<ATMRequest> requestsSatnaTransfer = SatnaTransfer(configuration, responsePasargadSubsidiary);
			if(requestsSatnaTransfer != null)
				requests.addAll(requestsSatnaTransfer);
		}	
...
//		getGeneralDao().save(receiptError);
	...
	private void addNewConfig(TerminalGroup atmTerminalGroup) throws Exception {
		...
		if (!atmType.equals(ATMType.NCR)) {		
			configuration.setName("تنظیمات پیش فرض خودپرداز");
		}
		else
		{
			configuration.setName("تنظیمات پیش فرض خودپرداز  - NCR");
		}
		configuration.setMaxDespensingNotes(MAX_DESPENSING_NOTES);
		configuration.setReceiptLineLength(RECEIPT_LINE_LENGTH);
		configuration.setReceiptLeftMargin(RECEIPT_LEFT_MARGIN);
...
//		getGeneralDao().save(receiptError);
	...
	//TASK Task004 : Deposit
	public List<ATMRequest> CashIn(ATMConfiguration configuration, OARResponse oarResponse) throws Exception{//nazashtam dar ndcConvertor jadid
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
		...
		String customerReceiptFaText ="[GR simpleCashInReceiptFa()]"; 
//		String customerReceiptFaText =
//				headerFa
//		+ "[LF][LF][GR center(GR c2F('رسید واریز وجه'))]"
//		+ newLine
//		+ lineFa
//		+ receivedDateFa
...
//		+ footerFa;
		...
		String customerReceiptEnText = /*"[ESC][OC]4q[ESC][OC]2p" +*/
				headerEn
				+ (!atmType.equals(ATMType.NCR) ? "[LF][LF][GR center('CashIn Receipt')]" : "[LF][LF][GR center(GR c2NCRE('CashIn Receipt'))]")
//				+ newLine + newLine 
				+ newLine  
				+ lineEn
				+ receivedDateEn
...
//				+ newLine + newLine 
		...
		String journalReceiptText = "[GR simpleCashInJournal()]" ;
//		String journalReceiptText = "[LF]CashIn:[SO]1[GR ifx.Auth_Amt][SO]1REF:[GR ifx.Src_TrnSeqCntr][SO]1PAN:[GR ifx.actualAppPAN][SO]1TIME:[GR ifx.receivedDt][SO]1TERMINAL:[GR ifx.TerminalId]";
		...
		/*********************/
		atmRequestPasargadFa.setOpkey("ABABA   ");
		atmRequestPasargadFa.setIfxType(IfxType.DEPOSIT_RQ);
		atmRequestPasargadFa.setTrnType(TrnType.DEPOSIT);
		...
		atmRequestTimeOutPasargadFa.setOpkey("ABABA  F");
		atmRequestTimeOutPasargadFa.setNextOpkey("ABABA  F");
		atmRequestTimeOutPasargadFa.setIfxType(IfxType.DEPOSIT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadFa.setTrnType(TrnType.DEPOSIT);
		...
		/*********************/
		/********************/
		atmRequestPasargadEn.setOpkey("IBABA   ");
		atmRequestPasargadEn.setIfxType(IfxType.DEPOSIT_RQ);
		atmRequestPasargadEn.setTrnType(TrnType.DEPOSIT);
		...
		atmRequestTimeOutPasargadEn.setOpkey("IBABA  F");
		atmRequestTimeOutPasargadEn.setNextOpkey("IBABA  F");
		atmRequestTimeOutPasargadEn.setIfxType(IfxType.DEPOSIT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadEn.setTrnType(TrnType.DEPOSIT);
		...
		/********************/
		atmRequestPasargadSubFa.setOpkey("ABABB   ");
		atmRequestPasargadSubFa.setNextOpkey("ABABA   ");
		atmRequestPasargadSubFa.setIfxType(IfxType.DEPOSIT_RQ);
		atmRequestPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestPasargadSubFa.setTrnType(TrnType.DEPOSIT);
		...
		atmRequestTimeOutPasargadSubFa.setOpkey("ABABB  F");
		atmRequestTimeOutPasargadSubFa.setNextOpkey("ABABA  F");
		atmRequestTimeOutPasargadSubFa.setIfxType(IfxType.DEPOSIT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubFa.setTrnType(TrnType.DEPOSIT);
		...
		/*********************/
		atmRequestPasargadSubEn.setOpkey("IBABB   ");
		atmRequestPasargadSubEn.setNextOpkey("IBABA   ");
		atmRequestPasargadSubEn.setIfxType(IfxType.DEPOSIT_RQ);
		atmRequestPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestPasargadSubEn.setTrnType(TrnType.DEPOSIT);
		...
		atmRequestTimeOutPasargadSubEn.setOpkey("IBABB  F");
		atmRequestTimeOutPasargadSubEn.setNextOpkey("IBABA  F");
		atmRequestTimeOutPasargadSubEn.setIfxType(IfxType.DEPOSIT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubEn.setTrnType(TrnType.DEPOSIT);
		...
		screen00Fa.setScreenno("388");
		screen00Fa.setDesc("واریز وجه-موفق فارسی");
		screen00Fa.setScreenData("388[FF][SI]@@[ESC]P2051[ESC]\\");
//Comment in 92.07.08 		screen00Fa.setScreenData("388[FF][SI]@@[ESC]P2114[ESC]\\");
		screen00Fa.setLanguage(UserLanguage.FARSI_LANG);
		getGeneralDao().saveOrUpdate(screen00Fa);
		screen00.add(screen00Fa);
		GeneralDao.Instance.save(screen00Fa);
		
		ResponseScreen screen00En = new ResponseScreen();
		screen00En.setScreenno("788");
		screen00En.setDesc("واریز وجه-موفق انگلیسی");
		screen00En.setScreenData("788[FF][SI]@@[ESC]P2451[ESC]\\");
//Comment in 92.07.08		screen00En.setScreenData("788[FF][SI]@@[ESC]P2514[ESC]\\");
		...
		screenReceiptFa.setDesc("واریز وجه-خطای رسید-فارسی");
		...
		ResponseScreen screenReceiptEn = new ResponseScreen();
		screenReceiptEn.setScreenno("787");
		screenReceiptEn.setDesc("واریز وجه-خطای رسید-انگلیسی");
		screenReceiptEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenReceiptEn.setScreenData("787[FF][SI]@@[ESC]P2543[ESC]\\");
		screenRecieptList.add(screenReceiptEn);
		getGeneralDao().saveOrUpdate(screenReceiptEn);
		...
		screenTimeoutFa.setDesc("واریز وجه-Timeout-فارسی");
		...
		screenTimeoutEn.setDesc("واریز وجه-Timeout-انگلیسی");
		...
		FunctionCommandResponse atmResponse00 = new FunctionCommandResponse();
		atmResponse00.setName("واریز وجه-موفق");
		atmResponse00.setBeRetain(false);
		atmResponse00.setDispense(null);
//		atmResponse00.setFunctionCommand(NDCFunctionIdentifierConstants.CASHIN);
		atmResponse00.setNextState("096");
		atmResponse00.setScreen(screen00);
		atmResponse00.setReceipt(receiptList);
//		atmResponse00.setBuf_Id("r1");
		getGeneralDao().saveOrUpdate(atmResponse00);
		
		
		FunctionCommandResponse responseChashInReceiptExceptionPasargad = new FunctionCommandResponse();
		responseChashInReceiptExceptionPasargad.setName("واریز وجه-داخلی-خطای رسید");
		responseChashInReceiptExceptionPasargad.setBeRetain(false);
		responseChashInReceiptExceptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseChashInReceiptExceptionPasargad.setNextState("098");
		responseChashInReceiptExceptionPasargad.setScreen(screenRecieptList);
		responseChashInReceiptExceptionPasargad.setReceipt(null);
		getGeneralDao().saveOrUpdate(responseChashInReceiptExceptionPasargad);
			
		
		FunctionCommandResponse responseTimeOut = new FunctionCommandResponse();
		responseTimeOut.setName("واریز وجه-time out");
		responseTimeOut.setBeRetain(false);
//		responseTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.CASHIN);
		responseTimeOut.setNextState("713");
		responseTimeOut.setScreen(screenTimeoutList);
		responseTimeOut.setReceipt(null);
//		responseTimeOut.setBuf_Id("r2");
		getGeneralDao().saveOrUpdate(responseTimeOut);
		/*********************/
		atmRequestPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), atmResponse00);
		atmRequestPasargadFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChashInReceiptExceptionPasargad);
		atmRequestTimeOutPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestTimeOutPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseTimeOut);
		
		atmRequestPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
		atmRequestPasargadSubFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChashInReceiptExceptionPasargad);
		atmRequestTimeOutPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestTimeOutPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseTimeOut);

		atmRequestPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), atmResponse00);
		atmRequestPasargadEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChashInReceiptExceptionPasargad);
		atmRequestTimeOutPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestTimeOutPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseTimeOut);
		
		atmRequestPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
		atmRequestPasargadSubEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChashInReceiptExceptionPasargad);
		atmRequestTimeOutPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestTimeOutPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseTimeOut);
	...
	public List<ATMRequest> CashIn_OnlyForBackup(ATMConfiguration configuration, OARResponse oarResponse) throws Exception{//nazashtam dar ndcConvertor jadid
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
...
//		ATMRequest atmRequestTimeOutPasargadSubEn = new ATMRequest();
		...
		String customerReceiptFaText = headerFa
		+ "[LF][LF][GR center(GR c2F('رسید واریز وجه'))]"
		+ newLine
		+ lineFa
		+ receivedDateFa
...
//		+ newLine + newLine
		...
		/*********************/
		atmRequestPasargadFa.setOpkey("ABAAC   ");
		atmRequestPasargadFa.setIfxType(IfxType.DEPOSIT_RQ);
		atmRequestPasargadFa.setTrnType(TrnType.DEPOSIT);
		atmRequestPasargadFa.setCurrency(currency);
		atmRequestPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		...
		atmRequestTimeOutPasargadFa.setOpkey("ABAAC  F");
		atmRequestTimeOutPasargadFa.setNextOpkey("ABAAC  F");
		atmRequestTimeOutPasargadFa.setIfxType(IfxType.DEPOSIT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadFa.setTrnType(TrnType.DEPOSIT);
		atmRequestTimeOutPasargadFa.setCurrency(currency);
		atmRequestTimeOutPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
...
//		atmRequestPasargadSubFa.setCurrency(currency);
//		atmRequestPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestPasargadSubFa.setFit(ATMPasargadConfig.FITType.PASARGAD);
//
...
//		atmRequestTimeOutPasargadSubFa.setCurrency(currency);
//		atmRequestTimeOutPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestTimeOutPasargadSubFa.setFit(ATMPasargadConfig.FITType.PASARGAD);
...
//		atmRequestPasargadEn.setCurrency(currency);
//		atmRequestPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPasargadEn.setFit(ATMPasargadConfig.FITType.PASARGAD);
//
...
//		atmRequestTimeOutPasargadEn.setCurrency(currency);
//		atmRequestTimeOutPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestTimeOutPasargadEn.setFit(ATMPasargadConfig.FITType.PASARGAD);
...
//		atmRequestPasargadSubEn.setCurrency(currency);
//		atmRequestPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPasargadSubEn.setFit(ATMPasargadConfig.FITType.PASARGAD);
//
//		atmRequestTimeOutPdasargadSubEn.setOpkey("IBAAB  F");
...
//		atmRequestTimeOutPasargadSubEn.setCurrency(currency);
//		atmRequestTimeOutPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestTimeOutPasargadSubEn.setFit(ATMPasargadConfig.FITType.PASARGAD);

		/*********************/
		List<ResponseScreen> screen00 = new ArrayList<ResponseScreen>();
		ResponseScreen screen00Fa = new ResponseScreen();
		screen00Fa.setScreenno("388");//066
		screen00Fa.setDesc("واریز وجه-موفق فارسی");
		screen00Fa.setScreenData("388[FF][SI]@@[ESC]P2112[ESC]\\");
		screen00Fa.setLanguage(UserLanguage.FARSI_LANG);
		...
		atmResponse00Fa.setName("واریز وجه-موفق");
		atmResponse00Fa.setBeRetain(false);
		atmResponse00Fa.setDispense(null);
//		atmResponse00Fa.setFunctionCommand(NDCFunctionIdentifierConstants.CASHIN);
		atmResponse00Fa.setNextState("096");
		atmResponse00Fa.setScreen(screen00);
		atmResponse00Fa.setReceipt(receiptList);
//		atmResponse00Fa.setBuf_Id("r0059060061");
		...
		responseChashInReceiptExceptionPasargad.setName("واریز وجه-داخلی-خطای رسید");
		responseChashInReceiptExceptionPasargad.setBeRetain(false);
//		responseChashInReceiptExceptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.CASHIN);
		responseChashInReceiptExceptionPasargad.setNextState("098");
		responseChashInReceiptExceptionPasargad.setScreen(screenRecieptList);
		responseChashInReceiptExceptionPasargad.setReceipt(null);
//		responseChashInReceiptExceptionPasargad.setBuf_Id("r2062063064");
		getGeneralDao().saveOrUpdate(responseChashInReceiptExceptionPasargad);
...
//		responseTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.CASHIN);
		...
		responseTimeOut.setScreen(screenTimeoutList);
		responseTimeOut.setReceipt(null);
//		responseTimeOut.setBuf_Id("r2062063064");
		getGeneralDao().saveOrUpdate(responseTimeOut);
		/*********************/
...
//			+ footerFa;
		...
		String customerReceiptEnText = /*"[ESC][OC]4q[ESC][OC]2p" +*/
			headerEn
			+ (!atmType.equals(ATMType.NCR) ? "[LF][LF][GR center('Withdrawal Receipt')]" : "[LF][LF][GR center(GR c2NCRE('Withdrawal Receipt'))]")
//			+ newLine + newLine 
			+ newLine  
			+ lineEn
			+ receivedDateEn
...
//			+ newLine + newLine 
		...
		//String journalReceiptText = "[LF]Withdrawal:[SO]1[GR ifx.Auth_Amt][SO]1REF:[GR ifx.Src_TrnSeqCntr][SO]1PAN:[GR ifx.actualAppPAN][SO]1TIME:[GR ifx.receivedDt][SO]1TERMINAL:[GR ifx.TerminalId]";
		...
		//Task019
//		atmRequestReceiptOptionShetabFa.setOpkey("AAAA   B");
//		atmRequestReceiptOptionShetabFa.setIfxType(IfxType.WITHDRAWAL_RQ);
//		atmRequestReceiptOptionShetabFa.setTrnType(TrnType.WITHDRAWAL);
...
//		atmRequestReceiptOptionShetabFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		//Task019
//		atmRequestReceiptOptionShetabEn.setOpkey("IAAA   B");
//		atmRequestReceiptOptionShetabEn.setIfxType(IfxType.WITHDRAWAL_RQ);
//		atmRequestReceiptOptionShetabEn.setTrnType(TrnType.WITHDRAWAL);
...
//		atmRequestReceiptOptionShetabEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		//Task019
//		atmRequestReceiptOptionPasargadFa.setOpkey("ABAAA  B");
//		atmRequestReceiptOptionPasargadFa.setIfxType(IfxType.WITHDRAWAL_RQ);
//		atmRequestReceiptOptionPasargadFa.setTrnType(TrnType.WITHDRAWAL);
...
//				atmRequestTimeOutPasargadSubFa.setNextOpkey("ABAAA  F");
		...
		//Task019
//		atmRequestReceiptOptionPasargadSubFa.setOpkey("ABAAB  B");
//		atmRequestReceiptOptionPasargadSubFa.setNextOpkey("ABAAA  B");
//		atmRequestReceiptOptionPasargadSubFa.setIfxType(IfxType.WITHDRAWAL_RQ);
//		atmRequestReceiptOptionPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
//		atmRequestReceiptOptionPasargadSubFa.setTrnType(TrnType.WITHDRAWAL);
...
//		atmRequestReceiptOptionPasargadSubFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);		
		...
		//Task019
//		atmRequestReceiptOptionPasargadEn.setOpkey("IBAAA  B");
//		atmRequestReceiptOptionPasargadEn.setIfxType(IfxType.WITHDRAWAL_RQ);
//		atmRequestReceiptOptionPasargadEn.setTrnType(TrnType.WITHDRAWAL);
...
//		atmRequestTimeOutPasargadSubEn.setSecondaryTrnType(TrnType.GETACCOUNT); //Task019 : Bug Repaire
		...
		//Task019
//		atmRequestReceiptOptionPasargadSubEn.setOpkey("IBAAB  B");
//		atmRequestReceiptOptionPasargadSubEn.setNextOpkey("IBAAA  B");
//		atmRequestReceiptOptionPasargadSubEn.setIfxType(IfxType.WITHDRAWAL_RQ);
//		atmRequestReceiptOptionPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
//		atmRequestReceiptOptionPasargadSubEn.setTrnType(TrnType.WITHDRAWAL);
...
//		screen01Fa.setDesc("برداشت یک مرحله ای عدم چاپ رسید-موفق فارسی");
...
//		screen01En.setDesc("برداشت یک مرحله ای عدم چاپ رسید-موفق انگلیسی");
...
//		atmResponse01Fa.setName("برداشت یک مرحله ای عدم چاپ رسید-موفق");
...
//			+ newLine + newLine
			+ newLine
			+ (!atmType.equals(ATMType.NCR) ? "[GR center('Withdrawal Receipt')]" : "[GR center(GR c2NCRE('Withdrawal Receipt'))]")
			+ newLine
			+ lineEn
			+ receivedDateEn 
//			+ newLine + newLine + newLine
...
//			+ newLine + newLine 
		...
		//"[LF]Partial Widthdrawal:[SO]1[GR ifx.Auth_Amt][SO]1REF:[GR ifx.Src_TrnSeqCntr][SO]1PAN:[GR ifx.actualAppPAN][SO]1TIME:[GR ifx.receivedDt][SO]1Step:[GR ifx.currentStep][SO]1Total Steps:[GR ifx.totalStep]";
...
//		responseTimeOut.setNextScreen("398");
	...
	private List<ATMRequest> BankStatement(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		...
		ATMRequest atmRequestReceiptOptionPasargadSubFa = new ATMRequest();
		ATMRequest atmRequestReceiptOptionPasargadEn = new ATMRequest();
		ATMRequest atmRequestReceiptOptionPasargadSubEn = new ATMRequest();
...
//			+ newLine + newLine + newLine
		...
		atmRequestReceiptOptionPasargadFa.setOpkey("ABFAA  B");
		atmRequestReceiptOptionPasargadFa.setIfxType(IfxType.BANK_STATEMENT_RQ);
		atmRequestReceiptOptionPasargadFa.setTrnType(TrnType.BANKSTATEMENT);
		atmRequestReceiptOptionPasargadFa.setCurrency(currency);
		atmRequestReceiptOptionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestReceiptOptionPasargadFa.setFit(FITType.PASARGAD);		
		atmRequestReceiptOptionPasargadFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		atmRequestReceiptOptionPasargadSubFa.setOpkey("ABFAB  B");
		atmRequestReceiptOptionPasargadSubFa.setNextOpkey("ABFAA  B");
		atmRequestReceiptOptionPasargadSubFa.setIfxType(IfxType.BANK_STATEMENT_RQ);
		atmRequestReceiptOptionPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestReceiptOptionPasargadSubFa.setTrnType(TrnType.BANKSTATEMENT);
//		atmRequestReceiptOptionPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestReceiptOptionPasargadSubFa.setCurrency(currency);
		atmRequestReceiptOptionPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestReceiptOptionPasargadSubFa.setFit(FITType.PASARGAD);
		...
		atmRequestReceiptOptionPasargadEn.setOpkey("IBFAA  B");
		atmRequestReceiptOptionPasargadEn.setIfxType(IfxType.BANK_STATEMENT_RQ);
		atmRequestReceiptOptionPasargadEn.setTrnType(TrnType.BANKSTATEMENT);
		atmRequestReceiptOptionPasargadEn.setCurrency(currency);
		atmRequestReceiptOptionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestReceiptOptionPasargadEn.setFit(FITType.PASARGAD);		
		atmRequestReceiptOptionPasargadEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		atmRequestReceiptOptionPasargadSubEn.setOpkey("IBFAB  B");
		atmRequestReceiptOptionPasargadSubEn.setNextOpkey("IBFAA  B");
		atmRequestReceiptOptionPasargadSubEn.setIfxType(IfxType.BANK_STATEMENT_RQ);
		atmRequestReceiptOptionPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestReceiptOptionPasargadSubEn.setTrnType(TrnType.BANKSTATEMENT);
//		atmRequestReceiptOptionPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestReceiptOptionPasargadSubEn.setCurrency(currency);
		atmRequestReceiptOptionPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestReceiptOptionPasargadSubEn.setFit(FITType.PASARGAD);
...
//		-----------------------------Balance-----------------------------------
		...
		List<ResponseScreen> screenRecieptList = new ArrayList<ResponseScreen>();
//		Ifx ifx= new Ifx();
//		ifx.getBankStatementData().get(0);
		ResponseScreen screenReceiptFa = new ResponseScreen();
		screenReceiptFa.setScreenno("388"); // 387 -> 388
		screenReceiptFa.setDesc("صورتحساب-خطای رسید-فارسی");
		screenReceiptFa.setLanguage(UserLanguage.FARSI_LANG);
		if (!atmType.equals(ATMType.NCR)) {
			screenReceiptFa.setScreenData("388[FF][SI]@@[ESC]P2158[ESC]\\ "    //387 -> 388
					+ "[ESC](K[ESC][OC]"
					+ updateablePageFontColor
					+ "[SI]B=[GR c2F('ردیف')]"
					+ "[SI]B7[GR c2F('تاریخ')]"
					...
					+ "[SI]BJ[GR c2F('مقدار')]"
					+ "[SI]CJ[GR c2F('-------------------------------------------')]"
					+ "[SI]D=[GR stsF(ifx,1)]" + "[SI]D7[GR stsF(ifx,2)]" + "[SI]D4[GR stsF(ifx,3)]" + "[SI]DJ[GR stsF(ifx,4)]"
					+ "[SI]E=[GR stsF(ifx,1)]" + "[SI]E7[GR stsF(ifx,2)]" + "[SI]E4[GR stsF(ifx,3)]" + "[SI]EJ[GR stsF(ifx,4)]"
					+ "[SI]F=[GR stsF(ifx,1)]" + "[SI]F7[GR stsF(ifx,2)]" + "[SI]F4[GR stsF(ifx,3)]" + "[SI]FJ[GR stsF(ifx,4)]"
					+ "[SI]G=[GR stsF(ifx,1)]" + "[SI]G7[GR stsF(ifx,2)]" + "[SI]G4[GR stsF(ifx,3)]" + "[SI]GJ[GR stsF(ifx,4)]"
					+ "[SI]H=[GR stsF(ifx,1)]" + "[SI]H7[GR stsF(ifx,2)]" + "[SI]H4[GR stsF(ifx,3)]" + "[SI]HJ[GR stsF(ifx,4)]"
					+ "[SI]I=[GR stsF(ifx,1)]" + "[SI]I7[GR stsF(ifx,2)]" + "[SI]I4[GR stsF(ifx,3)]" + "[SI]IJ[GR stsF(ifx,4)]"
					+ "[SI]J=[GR stsF(ifx,1)]" + "[SI]J7[GR stsF(ifx,2)]" + "[SI]J4[GR stsF(ifx,3)]" + "[SI]JJ[GR stsF(ifx,4)]"
					+ "[SI]K=[GR stsF(ifx,1)]" + "[SI]K7[GR stsF(ifx,2)]" + "[SI]K4[GR stsF(ifx,3)]" + "[SI]KJ[GR stsF(ifx,4)]"
					+ "[SI]L=[GR stsF(ifx,1)]" + "[SI]L7[GR stsF(ifx,2)]" + "[SI]L4[GR stsF(ifx,3)]" + "[SI]LJ[GR stsF(ifx,4)]"
					+ "[SI]M=[GR stsF(ifx,1)]" + "[SI]M7[GR stsF(ifx,2)]" + "[SI]M4[GR stsF(ifx,3)]" + "[SI]MJ[GR stsF(ifx,4)]"
					+ "[SI]OJ[GR stsF(ifx,5)]"
					+ "[SI]NJ[GR c2F('-------------------------------------------')]"
			...
			screenReceiptFa.setScreenData("388[FF][SI]@@[ESC]P2158[ESC]\\ "    //387 -> 388
					...
					+ "[SI]BA[GR c2F('مقدار')]"
					+ "[SI]CA[GR c2E('-----------------------------')]"
					+ "[SI]D=[GR stsF(ifx,1)]" + "[SI]D4[GR stsF(ifx,2)]" + "[SI]DO[GR stsF(ifx,3)]" + "[SI]DA[GR stsF(ifx,4)]"
					+ "[SI]E=[GR stsF(ifx,1)]" + "[SI]E4[GR stsF(ifx,2)]" + "[SI]EO[GR stsF(ifx,3)]" + "[SI]EA[GR stsF(ifx,4)]"
					+ "[SI]F=[GR stsF(ifx,1)]" + "[SI]F4[GR stsF(ifx,2)]" + "[SI]FO[GR stsF(ifx,3)]" + "[SI]FA[GR stsF(ifx,4)]"
					+ "[SI]G=[GR stsF(ifx,1)]" + "[SI]G4[GR stsF(ifx,2)]" + "[SI]GO[GR stsF(ifx,3)]" + "[SI]GA[GR stsF(ifx,4)]"
					+ "[SI]H=[GR stsF(ifx,1)]" + "[SI]H4[GR stsF(ifx,2)]" + "[SI]HO[GR stsF(ifx,3)]" + "[SI]HA[GR stsF(ifx,4)]"
					+ "[SI]I=[GR stsF(ifx,1)]" + "[SI]I4[GR stsF(ifx,2)]" + "[SI]IO[GR stsF(ifx,3)]" + "[SI]IA[GR stsF(ifx,4)]"
					+ "[SI]J=[GR stsF(ifx,1)]" + "[SI]J4[GR stsF(ifx,2)]" + "[SI]JO[GR stsF(ifx,3)]" + "[SI]JA[GR stsF(ifx,4)]"
					+ "[SI]K=[GR stsF(ifx,1)]" + "[SI]K4[GR stsF(ifx,2)]" + "[SI]KO[GR stsF(ifx,3)]" + "[SI]KA[GR stsF(ifx,4)]"
					+ "[SI]L=[GR stsF(ifx,1)]" + "[SI]L4[GR stsF(ifx,2)]" + "[SI]LO[GR stsF(ifx,3)]" + "[SI]LA[GR stsF(ifx,4)]"
					+ "[SI]M=[GR stsF(ifx,1)]" + "[SI]M4[GR stsF(ifx,2)]" + "[SI]MO[GR stsF(ifx,3)]" + "[SI]MA[GR stsF(ifx,4)]"
					+ "[SI]OF[GR stsF(ifx,5)]"
					+ "[SI]NA[GR c2E('-----------------------------')]"
					+ "[ESC](6[ESC][OC]"
					+ updateablePageFontColor
					+ "[SI]OA[GR c2F('ریال')]" + "[SI]O5[GR c2F('موجودی')]"
					);
		}
		...
		ResponseScreen screenRecieptEn = new ResponseScreen();
		screenRecieptEn.setScreenno("788"); //787 -> 788
		screenRecieptEn.setDesc("صورتحساب-خطای رسید-انگلیسی");
		screenRecieptEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenRecieptEn.setScreenData("788[FF][SI]@@[ESC]P2558[ESC]\\"  //787 -> 788
				+ "[ESC](1[ESC][OC]" 
				+ updateablePageFontColor
				+ "[SI]BA[GR c2E('ROW')]"
				+ "[SI]BE[GR c2E('DATE')]"
				...
				+ "[SI]B3[GR c2E('VALUE')]"
				+ "[SI]CA[GR c2E('------------------------------')]"
				+ "[SI]DA[GR stsE(ifx,1)]" + "[SI]DD[GR stsE(ifx,2)]" + "[SI]DN[GR stsE(ifx,3)]" + "[SI]D3[GR stsE(ifx,4)]"
				+ "[SI]EA[GR stsE(ifx,1)]" + "[SI]ED[GR stsE(ifx,2)]" + "[SI]EN[GR stsE(ifx,3)]" + "[SI]E3[GR stsE(ifx,4)]"
				+ "[SI]FA[GR stsE(ifx,1)]" + "[SI]FD[GR stsE(ifx,2)]" + "[SI]FN[GR stsE(ifx,3)]" + "[SI]F3[GR stsE(ifx,4)]"
				+ "[SI]GA[GR stsE(ifx,1)]" + "[SI]GD[GR stsE(ifx,2)]" + "[SI]GN[GR stsE(ifx,3)]" + "[SI]G3[GR stsE(ifx,4)]"
				+ "[SI]HA[GR stsE(ifx,1)]" + "[SI]HD[GR stsE(ifx,2)]" + "[SI]HN[GR stsE(ifx,3)]" + "[SI]H3[GR stsE(ifx,4)]"
				+ "[SI]IA[GR stsE(ifx,1)]" + "[SI]ID[GR stsE(ifx,2)]" + "[SI]IN[GR stsE(ifx,3)]" + "[SI]I3[GR stsE(ifx,4)]"
				+ "[SI]JA[GR stsE(ifx,1)]" + "[SI]JD[GR stsE(ifx,2)]" + "[SI]JN[GR stsE(ifx,3)]" + "[SI]J3[GR stsE(ifx,4)]"
				+ "[SI]KA[GR stsE(ifx,1)]" + "[SI]KD[GR stsE(ifx,2)]" + "[SI]KN[GR stsE(ifx,3)]" + "[SI]K3[GR stsE(ifx,4)]"
				+ "[SI]LA[GR stsE(ifx,1)]" + "[SI]LD[GR stsE(ifx,2)]" + "[SI]LN[GR stsE(ifx,3)]" + "[SI]L3[GR stsE(ifx,4)]"
				+ "[SI]MA[GR stsE(ifx,1)]" + "[SI]MD[GR stsE(ifx,2)]" + "[SI]MN[GR stsE(ifx,3)]" + "[SI]M3[GR stsE(ifx,4)]"
				+ "[SI]OE[GR stsE(ifx,5)]"
				+ "[SI]NA[GR c2E('------------------------------')]"
				);
		screenRecieptList.add(screenRecieptEn);
...
//		--------------------------------------Statement on screen----------------------------------
		FunctionCommandResponse responseReceiptOptionPasargad = new FunctionCommandResponse();
		responseReceiptOptionPasargad.setName("صورتحساب-داخلی-عدم چاپ رسید");
		responseReceiptOptionPasargad.setBeRetain(false);
		responseReceiptOptionPasargad.setDispense(null);
		responseReceiptOptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseReceiptOptionPasargad.setNextState("096"); //Change 098 -> 096
		responseReceiptOptionPasargad.setScreen(screenRecieptList);
		responseReceiptOptionPasargad.setReceipt(receiptList00);
		getGeneralDao().saveOrUpdate(responseReceiptOptionPasargad);
//		-----------------------------------------------------------------------------------------
...
//		-----------------------------------Statement on screen----------------------------------
		...
		FunctionCommandResponse responseReceiptOptionCreditPasargad = new FunctionCommandResponse();  
		responseReceiptOptionCreditPasargad.setName("صورتحساب-اعتباری داخلی-عدم چاپ رسید");
		responseReceiptOptionCreditPasargad.setBeRetain(false);
		responseReceiptOptionCreditPasargad.setDispense(null);
		responseReceiptOptionCreditPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseReceiptOptionCreditPasargad.setNextState("196"); //Change 198 -> 196
		responseReceiptOptionCreditPasargad.setScreen(screenRecieptList);
		responseReceiptOptionCreditPasargad.setReceipt(receiptList00);
		getGeneralDao().saveOrUpdate(responseReceiptOptionCreditPasargad);
...
//		atmRequestCreditPasargadTimeoutEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		...
		atmRequestFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), response00);
		atmRequestFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestTimeoutFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestReceiptOptionPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionPasargad);
		
		atmRequestSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
		atmRequestSubFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestSubTimeoutFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestReceiptOptionPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionPasargad);
		
		atmRequestEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), response00);
		atmRequestEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestTimeoutEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestReceiptOptionPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionPasargad);
		
		atmRequestSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);//me
		atmRequestSubEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestSubTimeoutEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);//me
		atmRequestReceiptOptionPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionPasargad);
...
//		---------------------------------end gholami
	...
	public  List<ATMRequest> Restriction(ATMConfiguration configuration/*, OARResponse oarResponse*/)throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
		
		ATMRequest atmRequestPreMaxAmtOnTransactionPasargadFa = new ATMRequest();
		ATMRequest atmRequestPreMaxAmtOnTransactionPasargadEn = new ATMRequest();
		ATMRequest atmRequestPreMaxAmtOnTransactionCreditFa = new ATMRequest();
		ATMRequest atmRequestPreMaxAmtOnTransactionCreditEn = new ATMRequest();

		ATMRequest atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa = new ATMRequest();
		ATMRequest atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn = new ATMRequest();
		ATMRequest atmRequestTimeOutPreMaxAmtOnTransactionCreditFa = new ATMRequest();
		ATMRequest atmRequestTimeOutPreMaxAmtOnTransactionCreditEn = new ATMRequest();
		...
		/***************** Prepare MaxAmtOnTransaction: Farsi-English, Pasargad-Credit **********************/
		//Pasargad,Farsi
		atmRequestPreMaxAmtOnTransactionPasargadFa.setOpkey("ABFBC   ");
		atmRequestPreMaxAmtOnTransactionPasargadFa.setIfxType(IfxType.PREPARE_RESTRICTION);
		atmRequestPreMaxAmtOnTransactionPasargadFa.setTrnType(TrnType.PREPARE_RESTRICTION);
		atmRequestPreMaxAmtOnTransactionPasargadFa.setCurrency(currency);
		atmRequestPreMaxAmtOnTransactionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPreMaxAmtOnTransactionPasargadFa.setFit(FITType.PASARGAD);
		//Pasargad,Farsi,Timeout
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa.setOpkey("ABFBC  F");
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa.setIfxType(IfxType.PREPARE_RESTRICTION_REV_REPEAT);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa.setTrnType(TrnType.PREPARE_RESTRICTION);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa.setCurrency(currency);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa.setFit(FITType.PASARGAD);
		
		//Pasargad,English
		atmRequestPreMaxAmtOnTransactionPasargadEn.setOpkey("IBFBC   ");
		atmRequestPreMaxAmtOnTransactionPasargadEn.setIfxType(IfxType.PREPARE_RESTRICTION);
		atmRequestPreMaxAmtOnTransactionPasargadEn.setTrnType(TrnType.PREPARE_RESTRICTION);
		atmRequestPreMaxAmtOnTransactionPasargadEn.setCurrency(currency);
		atmRequestPreMaxAmtOnTransactionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPreMaxAmtOnTransactionPasargadEn.setFit(FITType.PASARGAD);
		//Pasargad, English, Timeout
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn.setOpkey("IBFBC  F");
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn.setIfxType(IfxType.PREPARE_RESTRICTION_REV_REPEAT);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn.setTrnType(TrnType.PREPARE_RESTRICTION);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn.setCurrency(currency);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn.setFit(FITType.PASARGAD);


		//Credit,Farsi
		atmRequestPreMaxAmtOnTransactionCreditFa.setOpkey("ACFBC   ");
		atmRequestPreMaxAmtOnTransactionCreditFa.setIfxType(IfxType.PREPARE_RESTRICTION);
		atmRequestPreMaxAmtOnTransactionCreditFa.setTrnType(TrnType.PREPARE_RESTRICTION);
		atmRequestPreMaxAmtOnTransactionCreditFa.setCurrency(currency);
		atmRequestPreMaxAmtOnTransactionCreditFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPreMaxAmtOnTransactionCreditFa.setFit(FITType.CREDIT_PASARGAD);
		//Creit,Farsi,Timeout
		atmRequestTimeOutPreMaxAmtOnTransactionCreditFa.setOpkey("ACFBC  F");
		atmRequestTimeOutPreMaxAmtOnTransactionCreditFa.setIfxType(IfxType.PREPARE_RESTRICTION_REV_REPEAT);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditFa.setTrnType(TrnType.PREPARE_RESTRICTION);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditFa.setCurrency(currency);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditFa.setFit(FITType.CREDIT_PASARGAD);
		
		
		//Credit,English
		atmRequestPreMaxAmtOnTransactionCreditEn.setOpkey("ICFBC   ");
		atmRequestPreMaxAmtOnTransactionCreditEn.setIfxType(IfxType.PREPARE_RESTRICTION);
		atmRequestPreMaxAmtOnTransactionCreditEn.setTrnType(TrnType.PREPARE_RESTRICTION);
		atmRequestPreMaxAmtOnTransactionCreditEn.setCurrency(currency);
		atmRequestPreMaxAmtOnTransactionCreditEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPreMaxAmtOnTransactionCreditEn.setFit(FITType.CREDIT_PASARGAD);
		//Credit,English,Timeout
		atmRequestTimeOutPreMaxAmtOnTransactionCreditEn.setOpkey("ICFBC  F");
		atmRequestTimeOutPreMaxAmtOnTransactionCreditEn.setIfxType(IfxType.PREPARE_RESTRICTION_REV_REPEAT);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditEn.setTrnType(TrnType.PREPARE_RESTRICTION);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditEn.setCurrency(currency);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditEn.setFit(FITType.CREDIT_PASARGAD);
		
		/***************************************************************************************************/
		
		
		/*********************** MaxAmiOnTransaction: Farsi-English , Pasargad-Credit *********************/
		//Pasargad,Farsi
		atmRequestPasargadFa.setOpkey("ABFBA   ");
		atmRequestPasargadFa.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestPasargadFa.setTrnType(TrnType.RESTRICTION);
		atmRequestPasargadFa.setCurrency(currency);
		atmRequestPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPasargadFa.setFit(FITType.PASARGAD);
		
		//Pasargad,Farsi,Timeout
		atmRequestTimeOutPasargadFa.setOpkey("ABFBA  F");
		atmRequestTimeOutPasargadFa.setIfxType(IfxType.RESTRICTION_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadFa.setTrnType(TrnType.RESTRICTION);
		atmRequestTimeOutPasargadFa.setCurrency(currency);
		atmRequestTimeOutPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPasargadFa.setFit(FITType.PASARGAD);
		
		//Pasargad,Farsi,Receipt
		atmRequestReceiptOptionPasargadFa.setOpkey("ABFBA  B");
		atmRequestReceiptOptionPasargadFa.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestReceiptOptionPasargadFa.setTrnType(TrnType.RESTRICTION);
		atmRequestReceiptOptionPasargadFa.setCurrency(currency);
		atmRequestReceiptOptionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestReceiptOptionPasargadFa.setFit(FITType.PASARGAD);		
		atmRequestReceiptOptionPasargadFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		
		//Pasargad,Farsi,ReceiptError
		atmRequestReceiptExceptionPasargadFa.setOpkey("ABFBA  A");
		atmRequestReceiptExceptionPasargadFa.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestReceiptExceptionPasargadFa.setTrnType(TrnType.RESTRICTION);
		...
		//Pasargad,English
		atmRequestPasargadEn.setOpkey("IBFBA   ");
		atmRequestPasargadEn.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestPasargadEn.setTrnType(TrnType.RESTRICTION);
		atmRequestPasargadEn.setCurrency(currency);
		atmRequestPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPasargadEn.setFit(FITType.PASARGAD);
		
		//Pasargad,English,Timeout
		atmRequestTimeOutPasargadEn.setOpkey("IBFBA  F");
		atmRequestTimeOutPasargadEn.setIfxType(IfxType.RESTRICTION_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadEn.setTrnType(TrnType.RESTRICTION);
		atmRequestTimeOutPasargadEn.setCurrency(currency);
		atmRequestTimeOutPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPasargadEn.setFit(FITType.PASARGAD);
		
		//Pasargad,English,Receipt
		atmRequestReceiptOptionPasargadEn.setOpkey("IBFBA  B");
		atmRequestReceiptOptionPasargadEn.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestReceiptOptionPasargadEn.setTrnType(TrnType.RESTRICTION);
		atmRequestReceiptOptionPasargadEn.setCurrency(currency);
		atmRequestReceiptOptionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestReceiptOptionPasargadEn.setFit(FITType.PASARGAD);		
		atmRequestReceiptOptionPasargadEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		//Pasargad,English,ReceiptError
		atmRequestReceiptExceptionPasargadEn.setOpkey("IBFBA  A");
		atmRequestReceiptExceptionPasargadEn.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestReceiptExceptionPasargadEn.setTrnType(TrnType.RESTRICTION);
		...
		//Credit,Farsi
		atmRequestCreditPasargadFa.setOpkey("ACFBA   ");
		atmRequestCreditPasargadFa.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestCreditPasargadFa.setTrnType(TrnType.RESTRICTION);
		atmRequestCreditPasargadFa.setCurrency(currency);
		atmRequestCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
		
		//Credit,Farsi,Timeout
		atmRequestTimeOutCreditPasargadFa.setOpkey("ACFBA  F");
		atmRequestTimeOutCreditPasargadFa.setIfxType(IfxType.RESTRICTION_REV_REPEAT_RQ);
		atmRequestTimeOutCreditPasargadFa.setTrnType(TrnType.RESTRICTION);
		atmRequestTimeOutCreditPasargadFa.setCurrency(currency);
		atmRequestTimeOutCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
		
		//Credit,Farsi,Receipt
		atmRequestReceiptOptionCreditPasargadFa.setOpkey("ACFBA  B");
		atmRequestReceiptOptionCreditPasargadFa.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestReceiptOptionCreditPasargadFa.setTrnType(TrnType.RESTRICTION);
		atmRequestReceiptOptionCreditPasargadFa.setCurrency(currency);
		atmRequestReceiptOptionCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestReceiptOptionCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);		
		atmRequestReceiptOptionCreditPasargadFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		
		//Credit,Farsi,ReceiptError
		atmRequestReceiptExceptionCreditPasargadFa.setOpkey("ACFBA  A");
		atmRequestReceiptExceptionCreditPasargadFa.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestReceiptExceptionCreditPasargadFa.setTrnType(TrnType.RESTRICTION);
		...
		//Credit,English
		atmRequestCreditPasargadEn.setOpkey("ICFBA   ");
		atmRequestCreditPasargadEn.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestCreditPasargadEn.setTrnType(TrnType.RESTRICTION);
		atmRequestCreditPasargadEn.setCurrency(currency);
		atmRequestCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
		
		//Credit,English,Timeout
		atmRequestTimeOutCreditPasargadEn.setOpkey("ICFBA  F");
		atmRequestTimeOutCreditPasargadEn.setIfxType(IfxType.RESTRICTION_REV_REPEAT_RQ);
		atmRequestTimeOutCreditPasargadEn.setTrnType(TrnType.RESTRICTION);
		atmRequestTimeOutCreditPasargadEn.setCurrency(currency);
		atmRequestTimeOutCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
		
		//Credit,English,Receipt
		atmRequestReceiptOptionCreditPasargadEn.setOpkey("ICFBA  B");
		atmRequestReceiptOptionCreditPasargadEn.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestReceiptOptionCreditPasargadEn.setTrnType(TrnType.RESTRICTION);
		atmRequestReceiptOptionCreditPasargadEn.setCurrency(currency);
		atmRequestReceiptOptionCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestReceiptOptionCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);		
		atmRequestReceiptOptionCreditPasargadEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);		

		//Credit,English,ReceiptError
		atmRequestReceiptExceptionCreditPasargadEn.setOpkey("ICFBA  A");
		atmRequestReceiptExceptionCreditPasargadEn.setIfxType(IfxType.RESTRICTION_RQ);
		atmRequestReceiptExceptionCreditPasargadEn.setTrnType(TrnType.RESTRICTION);
		...
		/********************************/
		String textFa = "[GR simpleRestrictionReceiptFa()]";		
		String textEn =
			headerEn
			+ (!atmType.equals(ATMType.NCR) ? "[LF][LF][GR center('Restriction Receipt')]" : "[LF][LF][GR center(GR c2NCRE('Restriction'))]")
			+ newLine
			+ lineEn
			+ receivedDateEn
			+ newLine + newLine
			+ formatAppPanEn
			+ newLine + newLine
			+ (!atmType.equals(ATMType.NCR) ? "[GR center('Your restriction is putted successfully')]" : "[GR center(GR c2NCRE('Your restriction is putted successfully'))]")
			+ "[GR putLF(7)]"
			+ footerEn;
			;

		String textJournal00 = "[GR simpleRestrictionJournal()]" ;			
		...
		/*********************************** Screen Prepare *********************************/
//		ib ghesmat niaz be eslahat darad: trnType , terminalType taidie
		
		List<ResponseScreen> screenPrepareMaxAmtPasargadList = new ArrayList<ResponseScreen>();

		ResponseScreen screenCheckOrganizationFa = new ResponseScreen();
		screenCheckOrganizationFa.setScreenno("095");
		screenCheckOrganizationFa.setDesc("تایید نوع و مبلغ محدودیت-موفق-فارسی");
		screenCheckOrganizationFa.setLanguage(UserLanguage.FARSI_LANG);
		if (!atmType.equals(ATMType.NCR)) {
			screenCheckOrganizationFa.setScreenData("095[ESC]P2150[ESC]\\"
					+ "[ESC](K[ESC][OC]"
					+ updateablePageFontColor
					+ "[SI]G0[GR c2F(typeOfRestriction_Farsi(ifx.atmSpecificData.bufferB))]"
					+ "[SI]H0[GR c2F(cycleTypeOfRestriction_Farsi(ifx.atmSpecificData.bufferC))]"
			...
			screenCheckOrganizationFa.setScreenData("095[ESC]P2150[ESC]\\"
					+ "[ESC](6[ESC][OC]"
					+ updateablePageFontColor
					+ "[SI]G0[GR typeOfRestriction_Farsi(ifx.atmSpecificData.bufferB)]"
					+ "[SI]H0[GR cycleTypeOfRestriction_Farsi(ifx.atmSpecificData.bufferC)]"
					+ "[SI]I0[GR ifx.Auth_Amt]");
		}
		screenPrepareMaxAmtPasargadList.add(screenCheckOrganizationFa);
		getGeneralDao().saveOrUpdate(screenCheckOrganizationFa);

		ResponseScreen screenCheckOrganizationEn = new ResponseScreen();
		screenCheckOrganizationEn.setScreenno("495");
		screenCheckOrganizationEn.setDesc("تایید نوع و مبلغ محدودیت-موفق-انگلیسی");
		screenCheckOrganizationEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenCheckOrganizationEn.setScreenData("495[ESC]P2550[ESC]\\"
				+ "[ESC](1[ESC][OC]"
				+ updateablePageFontColor
				+ "[SI]G0[GR typeOfRestriction_English(ifx.atmSpecificData.bufferB)]"
				+ "[SI]H0[GR cycleTypeOfRestriction_English(ifx.atmSpecificData.bufferC)]"
				+ "[SI]I0[GR ifx.Auth_Amt]");
		screenPrepareMaxAmtPasargadList.add(screenCheckOrganizationEn);
		getGeneralDao().saveOrUpdate(screenCheckOrganizationEn);
		/************************************************************************************/
		
		
		/*********************** Prepare_MAxAmntOnTransaction:  Pasargad ******************************/
		FunctionCommandResponse responsePreparePasargad = new FunctionCommandResponse();
		responsePreparePasargad.setName("تایید  نوع و مبلغ محدودیت-داخلی-موفق");
		responsePreparePasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responsePreparePasargad.setNextState("275");
		responsePreparePasargad.setScreen(screenPrepareMaxAmtPasargadList);
		getGeneralDao().saveOrUpdate(responsePreparePasargad);
		/***********************************************************************************************/	

		/****************************** MAxAmntOnTransaction:  Pasargad ***************************/
		List<ResponseScreen> screenPasargadList = new ArrayList<ResponseScreen>();
		
		ResponseScreen screenPasargadFa = new ResponseScreen();
		screenPasargadFa.setScreenno("378");
		screenPasargadFa.setDesc("اعمال محدودیت مبلغ تراکنش-داخلی-موفق-فارسی");
		screenPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		screenPasargadFa.setScreenData("378[FF][SI]@@[ESC]P2153[ESC]\\");
		...
		screenPasargadEn.setScreenno("778");
		screenPasargadEn.setDesc("اعمال محدودیت مبلغ تراکنش-داخلی-موفق-انگلیسی");
		screenPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenPasargadEn.setScreenData("778[FF][SI]@@[ESC]P2553[ESC]\\");
		...
		responsePasargad.setName("اعمال محدودیت مبلغ تراکنش-داخلی-موفق");
		...
		responsePasargad.setNextState("279"); 
		...
		/***************************** Prepare_MAxAmntOnTransaction:  Credit ****************************/
		FunctionCommandResponse responsePrepareCreditPasargad = new FunctionCommandResponse();
		responsePrepareCreditPasargad.setName("تایید  نوع و مبلغ محدودیت-اعتباری داخلی-موفق");
		responsePrepareCreditPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responsePrepareCreditPasargad.setNextState("448");
		responsePrepareCreditPasargad.setScreen(screenPrepareMaxAmtPasargadList);
		getGeneralDao().saveOrUpdate(responsePrepareCreditPasargad);
		/************************************************************************************************/
			
		
		
		/********************************* MAxAmntOnTransaction: Credit *******************************/
		List<ResponseScreen> screenCreditList = new ArrayList<ResponseScreen>();
		
		ResponseScreen screenCreditFa = new ResponseScreen();
		screenCreditFa.setScreenno("378");
		screenCreditFa.setDesc("اعمال محدودیت مبلغ تراکنش-اعتباری داخلی-موفق-فارسی");
		screenCreditFa.setLanguage(UserLanguage.FARSI_LANG);
		screenCreditFa.setScreenData("378[FF][SI]@@[ESC]P2153[ESC]\\");
		...
		screenCreditEn.setScreenno("778");
		screenCreditEn.setDesc("اعمال محدودیت مبلغ تراکنش-اعتباری داخلی-موفق-انگلیسی");
		screenCreditEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenCreditEn.setScreenData("778[FF][SI]@@[ESC]P2553[ESC]\\");
		...
		responseCreditPasargad.setName("اعمال محدودیت مبلغ تراکنش-اعتباری داخلی-موفق");
		...
		responseCreditPasargad.setNextState("452"); 
		...
		/********************************** Continuing without Receipt **********************************/
		List<ResponseScreen> screenRecieptList = new ArrayList<ResponseScreen>();
		ResponseScreen screenRecieptFa = new ResponseScreen();
		screenRecieptFa.setScreenno("384");
		screenRecieptFa.setDesc("اعمال محدودیت مبلغ تراکنش-خطای رسید-فارسی");
		...
		screenRecieptEn.setDesc("اعمال محدودیت مبلغ تراکنش-خطای رسید-انگلیسی");
		screenRecieptEn.setLanguage(UserLanguage.ENGLISH_LANG);
		...
		responseReceiptExceptionPasargad.setName("اعمال محدودیت مبلغ تراکنش- داخلی-خطای رسید");
		...
		responseReceiptExceptionCreditPasargad.setName("اعمال محدودیت مبلغ تراکنش-اعتباری داخلی-خطای رسید");
		...
		ResponseScreen screenTimeoutFa = new ResponseScreen();
		screenTimeoutFa.setScreenno("398");
		screenTimeoutFa.setDesc("اعمال محدودیت مبلغ تراکنش-time out-فارسی");
		screenTimeoutFa.setLanguage(UserLanguage.FARSI_LANG);
		screenTimeoutFa.setScreenData(null);
		screenTimeoutList.add(screenTimeoutFa);
		getGeneralDao().saveOrUpdate(screenTimeoutFa);
		...
		ResponseScreen screenTimeoutEn = new ResponseScreen();
		screenTimeoutEn.setScreenno("798");
		screenTimeoutEn.setDesc("اعمال محدودیت مبلغ تراکنش-time out-انگلیسی");
		screenTimeoutEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenTimeoutEn.setScreenData(null);
		screenTimeoutList.add(screenTimeoutEn);
		getGeneralDao().saveOrUpdate(screenTimeoutEn);
		...
		FunctionCommandResponse responseTimeOut = new FunctionCommandResponse();
		responseTimeOut.setName("اعمال محدودیت مبلغ تراکنش-time out");
		responseTimeOut.setBeRetain(false);
		responseTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseTimeOut.setNextState("713");
		responseTimeOut.setScreen(screenTimeoutList);
		...
		atmRequestReceiptExceptionPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptExceptionPasargad);
		atmRequestReceiptExceptionPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptExceptionPasargad);
		atmRequestReceiptExceptionCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptExceptionCreditPasargad);
		atmRequestReceiptExceptionCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptExceptionCreditPasargad);

		/*****************************/

		atmRequestPreMaxAmtOnTransactionPasargadFa.addAtmResponse(ATMErrorCodes.PREPARE_RESTRICTION, responsePreparePasargad);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa.addAtmResponse(ATMErrorCodes.PREPARE_RESTRICTION, responseTimeOut);
		
		atmRequestPreMaxAmtOnTransactionPasargadEn.addAtmResponse(ATMErrorCodes.PREPARE_RESTRICTION, responsePreparePasargad);
		atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn.addAtmResponse(ATMErrorCodes.PREPARE_RESTRICTION, responseTimeOut);
		
		atmRequestPreMaxAmtOnTransactionCreditFa.addAtmResponse(ATMErrorCodes.PREPARE_RESTRICTION, responsePrepareCreditPasargad);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditFa.addAtmResponse(ATMErrorCodes.PREPARE_RESTRICTION, responseTimeOut);
		
		atmRequestPreMaxAmtOnTransactionCreditEn.addAtmResponse(ATMErrorCodes.PREPARE_RESTRICTION, responsePrepareCreditPasargad);
		atmRequestTimeOutPreMaxAmtOnTransactionCreditEn.addAtmResponse(ATMErrorCodes.PREPARE_RESTRICTION, responseTimeOut);
		...
		getGeneralDao().saveOrUpdate(atmRequestPreMaxAmtOnTransactionPasargadFa);
		getGeneralDao().saveOrUpdate(atmRequestPreMaxAmtOnTransactionPasargadEn);
		getGeneralDao().saveOrUpdate(atmRequestPreMaxAmtOnTransactionCreditFa);
		getGeneralDao().saveOrUpdate(atmRequestPreMaxAmtOnTransactionCreditEn);

		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa);
		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn);
		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreMaxAmtOnTransactionCreditFa);
		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreMaxAmtOnTransactionCreditEn);
		...
		requests.add(atmRequestPreMaxAmtOnTransactionPasargadFa);
		requests.add(atmRequestPreMaxAmtOnTransactionPasargadEn);
		requests.add(atmRequestPreMaxAmtOnTransactionCreditFa);
		requests.add(atmRequestPreMaxAmtOnTransactionCreditEn);

		requests.add(atmRequestTimeOutPreMaxAmtOnTransactionPasargadFa);
		requests.add(atmRequestTimeOutPreMaxAmtOnTransactionPasargadEn);
		requests.add(atmRequestTimeOutPreMaxAmtOnTransactionCreditFa);
		requests.add(atmRequestTimeOutPreMaxAmtOnTransactionCreditEn);
	...
	//TASK Task019 : Receipt Option
	List<ATMRequest> CharityHelp(ATMConfiguration configuration,OARResponse oarResponse) throws Exception{
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
...
//		atmRequestReceiptOptionCreditPasargadEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		if (!atmType.equals(ATMType.NCR)) {
			screenCheckOrganizationFa.setScreenData("067[ESC]P2131[ESC]\\"
					+ "[ESC](K[ESC][OC]"
					+ updateablePageFontColor
					+ "[SI]H0[GR c2F(ifx.networkTrnInfo.ThirdPartyName)]"
					+ "[SI]I0[GR ifx.Auth_Amt]");
...
//				+ "[ESC](1[ESC][OC]00;67;80;m"
				+ "[ESC](1[ESC][OC]"
				+ updateablePageFontColor
				+ "[SI]H0[GR safeEn(ifx.networkTrnInfo.ThirdPartyNameEn)]"
				+ "[SI]I0[GR ifx.Auth_Amt]");
...
//		requests.add(atmRequestReceiptOptionCreditPasargadEn);//Task019
	...
	private List<ATMRequest> OnlineBillPayment(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
...
//		ATMRequest atmRequestPreOnlineBillShetabFa = new ATMRequest();
//		ATMRequest atmRequestPreOnlineBillShetabEn = new ATMRequest();
		ATMRequest atmRequestPreOnlineBillPasargadFa = new ATMRequest();
		ATMRequest atmRequestPreOnlineBillPasargadEn = new ATMRequest();
//		ATMRequest atmRequestPreOnlineBillCreditPasargadFa = new ATMRequest();
//		ATMRequest atmRequestPreOnlineBillCreditPasargadEn = new ATMRequest();

//		ATMRequest atmRequestTimeOutPreOnlineBillShetabFa = new ATMRequest();
//		ATMRequest atmRequestTimeOutPreOnlineBillShetabEn = new ATMRequest();
		ATMRequest atmRequestTimeOutPreOnlineBillPasargadFa = new ATMRequest();
		ATMRequest atmRequestTimeOutPreOnlineBillPasargadEn = new ATMRequest();
//		ATMRequest atmRequestTimeOutPreOnlineBillCreditPasargadFa = new ATMRequest();
//		ATMRequest atmRequestTimeOutPreOnlineBillCreditPasargadEn = new ATMRequest();

		String textFa = "[GR simpleOnlineBillPaymentReceiptFa()]"
//				headerFa
//				+ "[LF][LF][GR center(GR c2F('رسید پرداخت قبض نوپاد'))]"
//				+ newLine
//				+ lineFa
//				+ receivedDateFa
//				+ newLine + newLine
...
//				+ seqCntrFa
//				+ newLine
//				+ "[GR justify(GR c2F('توضیحات'), GR c2F(ifx.OnlineBillPaymentDescription))]"
//				+ newLine
//				+ "[GR justify(GR c2F('شماره قبض نوپاد'), GR c2F(ifx.OnlineBillPaymentRefNum))]"
//				+ newLine
//				+ amountFa
//				+ "[GR putLF(8)]"
//				+ footerFa
		...
		String textEn =
			headerEn
			+ (!atmType.equals(ATMType.NCR) ? "[LF][LF][GR center('NOPAD bill Payment Receipt')]" : "[LF][LF][GR center(GR c2NCRE('NOPAD bill Payment Receipt'))]")
			+ newLine
			+ lineEn
			+ receivedDateEn
			+ newLine + newLine
			...
			+ seqCntrEn
			+ newLine
			+ (!atmType.equals(ATMType.NCR) ? "[GR justify( GR c2E(ifx.OnlineBillPaymentDescription), 'Description')]" : "[GR justify( GR c2NCRE(ifx.OnlineBillPaymentDescription), GR c2NCRE('Description'))]")
			+ newLine
			+ (!atmType.equals(ATMType.NCR) ? "[GR justify(GR c2E(ifx.OnlineBillPaymentRefNum), 'NOPAD bill number')]" : "[GR justify(GR c2NCRE(ifx.OnlineBillPaymentRefNum), GR c2NCRE('NOPAD bill number'))]")
			+ newLine
			+ amountEn
			+ "[GR putLF(8)]"
			+ footerEn
		...
		String textJournal00 = "[GR simpleOnlineBillPaymentJournal()]";
//			"[LF]Ticket Purchase:[SO]1[GR ifx.Auth_Amt][SO]1REF:[GR ifx.Src_TrnSeqCntr][SO]1PAN:[GR ifx.actualAppPAN][SO]1TIME:[GR ifx.receivedDt][SO]1TERMINAL:[GR ifx.TerminalId][SO]1OnlineRefNum:[ifx.OnlineBillPaymentRefNum]";
		...
		/*****************************/
//		atmRequestPreOnlineBillShetabFa.setOpkey("AAHC    ");
//		atmRequestPreOnlineBillShetabFa.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestPreOnlineBillShetabFa.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestPreOnlineBillShetabFa.setCurrency(currency);
//		atmRequestPreOnlineBillShetabFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestPreOnlineBillShetabFa.setFit(FITType.SHETAB);
//
//		atmRequestTimeOutPreOnlineBillShetabFa.setOpkey("AAHC   F");
//		atmRequestTimeOutPreOnlineBillShetabFa.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT_REV_REPEAT);
//		atmRequestTimeOutPreOnlineBillShetabFa.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestTimeOutPreOnlineBillShetabFa.setCurrency(currency);
//		atmRequestTimeOutPreOnlineBillShetabFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestTimeOutPreOnlineBillShetabFa.setFit(FITType.SHETAB);
//
//		atmRequestPreOnlineBillShetabEn.setOpkey("IAHC    ");
//		atmRequestPreOnlineBillShetabEn.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestPreOnlineBillShetabEn.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestPreOnlineBillShetabEn.setCurrency(currency);
//		atmRequestPreOnlineBillShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPreOnlineBillShetabEn.setFit(FITType.SHETAB);
//
//		atmRequestTimeOutPreOnlineBillShetabEn.setOpkey("IAHC   F");
//		atmRequestTimeOutPreOnlineBillShetabEn.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT_REV_REPEAT);
//		atmRequestTimeOutPreOnlineBillShetabEn.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestTimeOutPreOnlineBillShetabEn.setCurrency(currency);
//		atmRequestTimeOutPreOnlineBillShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestTimeOutPreOnlineBillShetabEn.setFit(FITType.SHETAB);

		atmRequestPreOnlineBillPasargadFa.setOpkey("ABHC    ");
		atmRequestPreOnlineBillPasargadFa.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT);
		atmRequestPreOnlineBillPasargadFa.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
		atmRequestPreOnlineBillPasargadFa.setCurrency(currency);
		atmRequestPreOnlineBillPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPreOnlineBillPasargadFa.setFit(FITType.PASARGAD);

		atmRequestTimeOutPreOnlineBillPasargadFa.setOpkey("ABHC   F");
		atmRequestTimeOutPreOnlineBillPasargadFa.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT_REV_REPEAT);
		atmRequestTimeOutPreOnlineBillPasargadFa.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
		atmRequestTimeOutPreOnlineBillPasargadFa.setCurrency(currency);
		atmRequestTimeOutPreOnlineBillPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPreOnlineBillPasargadFa.setFit(FITType.PASARGAD);

		atmRequestPreOnlineBillPasargadEn.setOpkey("IBHC    ");
		atmRequestPreOnlineBillPasargadEn.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT);
		atmRequestPreOnlineBillPasargadEn.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
		atmRequestPreOnlineBillPasargadEn.setCurrency(currency);
		atmRequestPreOnlineBillPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPreOnlineBillPasargadEn.setFit(FITType.PASARGAD);

		atmRequestTimeOutPreOnlineBillPasargadEn.setOpkey("IBHC   F");
		atmRequestTimeOutPreOnlineBillPasargadEn.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT_REV_REPEAT);
		atmRequestTimeOutPreOnlineBillPasargadEn.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
		atmRequestTimeOutPreOnlineBillPasargadEn.setCurrency(currency);
		atmRequestTimeOutPreOnlineBillPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPreOnlineBillPasargadEn.setFit(FITType.PASARGAD);

//		atmRequestPreOnlineBillCreditPasargadFa.setOpkey("ACHC    ");
//		atmRequestPreOnlineBillCreditPasargadFa.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestPreOnlineBillCreditPasargadFa.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestPreOnlineBillCreditPasargadFa.setCurrency(currency);
//		atmRequestPreOnlineBillCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestPreOnlineBillCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
//
//		atmRequestTimeOutPreOnlineBillCreditPasargadFa.setOpkey("ACHC   F");
//		atmRequestTimeOutPreOnlineBillCreditPasargadFa.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT_REV_REPEAT);
//		atmRequestTimeOutPreOnlineBillCreditPasargadFa.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestTimeOutPreOnlineBillCreditPasargadFa.setCurrency(currency);
//		atmRequestTimeOutPreOnlineBillCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestTimeOutPreOnlineBillCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
//
//		atmRequestPreOnlineBillCreditPasargadEn.setOpkey("ICHC    ");
//		atmRequestPreOnlineBillCreditPasargadEn.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestPreOnlineBillCreditPasargadEn.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestPreOnlineBillCreditPasargadEn.setCurrency(currency);
//		atmRequestPreOnlineBillCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPreOnlineBillCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
//
//		atmRequestTimeOutPreOnlineBillCreditPasargadEn.setOpkey("ICHC   F");
//		atmRequestTimeOutPreOnlineBillCreditPasargadEn.setIfxType(IfxType.PREPARE_ONLINE_BILLPAYMENT_REV_REPEAT);
//		atmRequestTimeOutPreOnlineBillCreditPasargadEn.setTrnType(TrnType.PREPARE_ONLINE_BILLPAYMENT);
//		atmRequestTimeOutPreOnlineBillCreditPasargadEn.setCurrency(currency);
//		atmRequestTimeOutPreOnlineBillCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestTimeOutPreOnlineBillCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);

		/*****************************/

//		atmRequestShetabFa.setOpkey("AAHD    ");
//		atmRequestShetabFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
//		atmRequestShetabFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestShetabFa.setCurrency(currency);
//		atmRequestShetabFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestShetabFa.setFit(FITType.SHETAB);
//
//		atmRequestTimeOutShetabFa.setOpkey("AAHD   F");
//		atmRequestTimeOutShetabFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_REV_REPEAT_RQ);
//		atmRequestTimeOutShetabFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestTimeOutShetabFa.setCurrency(currency);
//		atmRequestTimeOutShetabFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestTimeOutShetabFa.setFit(FITType.SHETAB);
//
//		atmRequestReceiptExceptionShetabFa.setOpkey("AAHD   A");
//		atmRequestReceiptExceptionShetabFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
//		atmRequestReceiptExceptionShetabFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestReceiptExceptionShetabFa.setForceReceipt(false);
//		atmRequestReceiptExceptionShetabFa.setCurrency(currency);
//		atmRequestReceiptExceptionShetabFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestReceiptExceptionShetabFa.setFit(FITType.SHETAB);
...
//		atmRequestShetabEn.setOpkey("IAHD    ");
//		atmRequestShetabEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
//		atmRequestShetabEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestShetabEn.setCurrency(currency);
//		atmRequestShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestShetabEn.setFit(FITType.SHETAB);
//
//		atmRequestTimeOutShetabEn.setOpkey("IAHD   F");
//		atmRequestTimeOutShetabEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_REV_REPEAT_RQ);
//		atmRequestTimeOutShetabEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestTimeOutShetabEn.setCurrency(currency);
//		atmRequestTimeOutShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestTimeOutShetabEn.setFit(FITType.SHETAB);
//
//		atmRequestReceiptExceptionShetabEn.setOpkey("IAHD   A");
//		atmRequestReceiptExceptionShetabEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
//		atmRequestReceiptExceptionShetabEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestReceiptExceptionShetabEn.setForceReceipt(false);
//		atmRequestReceiptExceptionShetabEn.setCurrency(currency);
//		atmRequestReceiptExceptionShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestReceiptExceptionShetabEn.setFit(FITType.SHETAB);
		...
		atmRequestPasargadFa.setOpkey("ABHDA   ");
		atmRequestPasargadFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
		atmRequestPasargadFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestPasargadFa.setCurrency(currency);
		atmRequestPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPasargadFa.setFit(FITType.PASARGAD);

		atmRequestTimeOutPasargadFa.setOpkey("ABHDA  F");
		atmRequestTimeOutPasargadFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestTimeOutPasargadFa.setCurrency(currency);
		atmRequestTimeOutPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPasargadFa.setFit(FITType.PASARGAD);

		atmRequestReceiptExceptionPasargadFa.setOpkey("ABHDA  A");
		atmRequestReceiptExceptionPasargadFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
		atmRequestReceiptExceptionPasargadFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestReceiptExceptionPasargadFa.setForceReceipt(false);
		atmRequestReceiptExceptionPasargadFa.setCurrency(currency);
		atmRequestReceiptExceptionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestReceiptExceptionPasargadFa.setFit(FITType.PASARGAD);
		...
		atmRequestPasargadSubFa.setOpkey("ABHDB   ");
		atmRequestPasargadSubFa.setNextOpkey("ABHDA   ");
		atmRequestPasargadSubFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
		atmRequestPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestPasargadSubFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestPasargadSubFa.setCurrency(currency);
		atmRequestPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPasargadSubFa.setFit(FITType.PASARGAD);

		atmRequestTimeOutPasargadSubFa.setOpkey("ABHDB  F");
		atmRequestTimeOutPasargadSubFa.setNextOpkey("ABHDB  F");
		atmRequestTimeOutPasargadSubFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
//		atmRequestTimeOutPasargadSubFa.setSecondaryIfxType(IfxType.BILL_PMT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestTimeOutPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestTimeOutPasargadSubFa.setCurrency(currency);
		atmRequestTimeOutPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPasargadSubFa.setFit(FITType.PASARGAD);
		...
		//TODO: double check for English version
		atmRequestReceiptExceptionPasargadSubFa.setOpkey("ABHDB  A");
		atmRequestReceiptExceptionPasargadSubFa.setNextOpkey("ABHDA  A");
		atmRequestReceiptExceptionPasargadSubFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
//		atmRequestReceiptExceptionPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestReceiptExceptionPasargadSubFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestReceiptExceptionPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestReceiptExceptionPasargadSubFa.setForceReceipt(false);
		atmRequestReceiptExceptionPasargadSubFa.setCurrency(currency);
		atmRequestReceiptExceptionPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
		...
		atmRequestPasargadEn.setOpkey("IBHDA   ");
		atmRequestPasargadEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
		atmRequestPasargadEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestPasargadEn.setCurrency(currency);
		atmRequestPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPasargadEn.setFit(FITType.PASARGAD);

		atmRequestTimeOutPasargadEn.setOpkey("IBHDA  F");
		atmRequestTimeOutPasargadEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestTimeOutPasargadEn.setCurrency(currency);
		atmRequestTimeOutPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPasargadEn.setFit(FITType.PASARGAD);

		atmRequestReceiptExceptionPasargadEn.setOpkey("IBHDA  A");
		atmRequestReceiptExceptionPasargadEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
		atmRequestReceiptExceptionPasargadEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestReceiptExceptionPasargadEn.setForceReceipt(false);
		atmRequestReceiptExceptionPasargadEn.setCurrency(currency);
		atmRequestReceiptExceptionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestReceiptExceptionPasargadEn.setFit(FITType.PASARGAD);
		...
		atmRequestPasargadSubEn.setOpkey("IBHDB   ");
		atmRequestPasargadSubEn.setNextOpkey("IBHDA   ");
		atmRequestPasargadSubEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
		atmRequestPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestPasargadSubEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestPasargadSubEn.setCurrency(currency);
		atmRequestPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPasargadSubEn.setFit(FITType.PASARGAD);

		atmRequestTimeOutPasargadSubEn.setOpkey("IBHDB  F");
		atmRequestTimeOutPasargadSubEn.setNextOpkey("IBHDB  F");
		atmRequestTimeOutPasargadSubEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestTimeOutPasargadSubEn.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestTimeOutPasargadSubEn.setCurrency(currency);
		atmRequestTimeOutPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPasargadSubEn.setFit(FITType.PASARGAD);
...
//		atmRequestCreditPasargadFa.setOpkey("ACHD    ");
//		atmRequestCreditPasargadFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
//		atmRequestCreditPasargadFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestCreditPasargadFa.setCurrency(currency);
//		atmRequestCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
//
//		atmRequestTimeOutCreditPasargadFa.setOpkey("ACHD   F");
//		atmRequestTimeOutCreditPasargadFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_REV_REPEAT_RQ);
//		atmRequestTimeOutCreditPasargadFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestTimeOutCreditPasargadFa.setCurrency(currency);
//		atmRequestTimeOutCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestTimeOutCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
//
//		atmRequestReceiptExceptionCreditPasargadFa.setOpkey("ACHD   A");
//		atmRequestReceiptExceptionCreditPasargadFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
//		atmRequestReceiptExceptionCreditPasargadFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestReceiptExceptionCreditPasargadFa.setForceReceipt(false);
//		atmRequestReceiptExceptionCreditPasargadFa.setCurrency(currency);
//		atmRequestReceiptExceptionCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestReceiptExceptionCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
...
//		atmRequestCreditPasargadEn.setOpkey("ICHD    ");
//		atmRequestCreditPasargadEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
//		atmRequestCreditPasargadEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestCreditPasargadEn.setCurrency(currency);
//		atmRequestCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
//
//		atmRequestTimeOutCreditPasargadEn.setOpkey("ICHD   F");
//		atmRequestTimeOutCreditPasargadEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_REV_REPEAT_RQ);
//		atmRequestTimeOutCreditPasargadEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestTimeOutCreditPasargadEn.setCurrency(currency);
//		atmRequestTimeOutCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestTimeOutCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
//
//		atmRequestReceiptExceptionCreditPasargadEn.setOpkey("ICHD   A");
//		atmRequestReceiptExceptionCreditPasargadEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_RQ);
//		atmRequestReceiptExceptionCreditPasargadEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
//		atmRequestReceiptExceptionCreditPasargadEn.setForceReceipt(false);
//		atmRequestReceiptExceptionCreditPasargadEn.setCurrency(currency);
//		atmRequestReceiptExceptionCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestReceiptExceptionCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
		...
		/*****************************/
		List<ResponseScreen> screenOnlineBillPaymentList = new ArrayList<ResponseScreen>();

		ResponseScreen screenOnlineBillPayFa = new ResponseScreen();
		screenOnlineBillPayFa.setScreenno("388");//382 bud ghablan alan kardamesh 388 bebinam moshkele hal shod ya na
		screenOnlineBillPayFa.setDesc("خرید بلیط-موفق-فارسی");
		screenOnlineBillPayFa.setLanguage(UserLanguage.FARSI_LANG);
		screenOnlineBillPayFa.setScreenData("388[FF][SI]@@[ESC]P2128[ESC]\\");
		screenOnlineBillPaymentList.add(screenOnlineBillPayFa);
		getGeneralDao().saveOrUpdate(screenOnlineBillPayFa);

		ResponseScreen screenBillPayEn = new ResponseScreen();
		screenBillPayEn.setScreenno("788");
		screenBillPayEn.setDesc("خرید بلیط-موفق-انگلیسی");
		screenBillPayEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenBillPayEn.setScreenData("788[FF][SI]@@[ESC]P2528[ESC]\\");
		screenOnlineBillPaymentList.add(screenBillPayEn);
		getGeneralDao().saveOrUpdate(screenBillPayEn);

		List<ResponseScreen> screenCheckOrganizationList = new ArrayList<ResponseScreen>();

		ResponseScreen screenCheckOrganizationFa = new ResponseScreen();
		screenCheckOrganizationFa.setScreenno("062");
		screenCheckOrganizationFa.setDesc("تایید خرید بلیط-موفق-فارسی");
		screenCheckOrganizationFa.setLanguage(UserLanguage.FARSI_LANG);
		if (!atmType.equals(ATMType.NCR)) {
			screenCheckOrganizationFa.setScreenData("062[ESC]P2088[ESC]\\"
					+ "[ESC](K[ESC][OC]80;m"
					+ "[SI]G0[GR ifx.OnlineBillPaymentRefNum]"
					+ "[SI]H0[GR c2F(ifx.OnlineBillPaymentDescription)]"
					+ "[SI]I0[GR ifx.Auth_Amt]");
		} else {
			screenCheckOrganizationFa.setScreenData("062[ESC]P2088[ESC]\\"
					+ "[ESC](6[ESC][OC]80;m"
...
//		+ "[SI]H0[GR ifx.actualAppPAN]"
		...
		ResponseScreen screenCheckOrganizationEn = new ResponseScreen();
		screenCheckOrganizationEn.setScreenno("462");
		screenCheckOrganizationEn.setDesc("تایید خرید بلیط-موفق-انگلیسی");
		screenCheckOrganizationEn.setLanguage(UserLanguage.ENGLISH_LANG);
		if (!atmType.equals(ATMType.NCR)) {
			screenCheckOrganizationEn.setScreenData("462[ESC]P2488[ESC]\\"
					+ "[ESC](1[ESC][OC]80;m"
					+ "[SI]G0[GR ifx.OnlineBillPaymentRefNum]"
					+ "[SI]H0[GR c2E(ifx.OnlineBillPaymentDescription)]"
					+ "[SI]I0[GR c2E(ifx.Auth_Amt)]");
		} else {
			screenCheckOrganizationEn.setScreenData("462[ESC]P2488[ESC]\\"
					+ "[ESC](1[ESC][OC]80;m"
					+ "[SI]G0[GR ifx.OnlineBillPaymentRefNum]"
					+ "[SI]H0[GR c2NCR_SCR_E(ifx.OnlineBillPaymentDescription)]"
					+ "[SI]I0[GR c2NCR_SCR_E(ifx.Auth_Amt)]");
		}
		screenCheckOrganizationList.add(screenCheckOrganizationEn);
		getGeneralDao().saveOrUpdate(screenCheckOrganizationEn);
		...
		ResponseScreen screenRecieptFa = new ResponseScreen();
		screenRecieptFa.setScreenno("384");
		screenRecieptFa.setDesc("بلیط-خطای رسید-فارسی");
		screenRecieptFa.setLanguage(UserLanguage.FARSI_LANG);
		screenRecieptFa.setScreenData("384[FF][SI]@@[ESC]P2142[ESC]\\");
		screenRecieptList.add(screenRecieptFa);
		getGeneralDao().saveOrUpdate(screenRecieptFa);
		...
		ResponseScreen screenRecieptEn = new ResponseScreen();
		screenRecieptEn.setScreenno("784");
		screenRecieptEn.setDesc("بلیط-خطای رسید-انگلیسی");
		screenRecieptEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenRecieptEn.setScreenData("784[FF][SI]@@[ESC]P2542[ESC]\\");
		screenRecieptList.add(screenRecieptEn);
		getGeneralDao().saveOrUpdate(screenRecieptEn);
		...
		/*****************************/
//		FunctionCommandResponse responseShetab = new FunctionCommandResponse();
//		responseShetab.setName("تایید خرید بلیط-شتابی-موفق");
//		responseShetab.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
...
//		getGeneralDao().saveOrUpdate(responseShetab);
		...
		FunctionCommandResponse responsePasargad = new FunctionCommandResponse();
		responsePasargad.setName("تایید خرید بلیط-داخلی-موفق");
		responsePasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responsePasargad.setNextState("085");
//		responsePasargad.setNextScreen("032");
//		responsePasargad.setScreenData("032[ESC]P2086[ESC]\\"
//				+ "[ESC](K[ESC][OC]80;m"
//				+ "[SI]F0[GR ifx.BillID]"
...
//		FunctionCommandResponse responseCreditPasargad = new FunctionCommandResponse();
//		responseCreditPasargad.setName("تایید خرید بلیط-اعتباری داخلی-موفق");
//		responseCreditPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
...
//		responseBillShetab.setName("پرداخت خرید بلیط-شتابی-موفق");
...
////		responseBillShetab.setNextScreen("388");
////		responseBillShetab.setScreenData("388[FF][SI]@@[ESC]P2126[ESC]\\");
//		responseBillShetab.setScreen(screenOnlineBillPaymentList);
//		responseBillShetab.setReceipt(receiptList);
//		getGeneralDao().saveOrUpdate(responseBillShetab);
//
//		FunctionCommandResponse responseReceiptExceptionShetab = new FunctionCommandResponse();
//		responseReceiptExceptionShetab.setName("پرداخت خرید بلیط-شتابی-خطای رسید");
//		responseReceiptExceptionShetab.setBeRetain(false);
//		responseReceiptExceptionShetab.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseReceiptExceptionShetab.setNextState("592");
////		responseReceiptExceptionShetab.setNextScreen("384");
...
//		getGeneralDao().saveOrUpdate(responseReceiptExceptionShetab);
		...
		responseBillPasargad.setName("پرداخت خرید بلیط-داخلی-موفق");
...
//		responseBillPasargad.setNextScreen("388");
//		responseBillPasargad.setScreenData("388[FF][SI]@@[ESC]P2126[ESC]\\");
		responseBillPasargad.setScreen(screenOnlineBillPaymentList);
		responseBillPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseBillPasargad);

		FunctionCommandResponse responseReceiptExceptionPasargad = new FunctionCommandResponse();
		responseReceiptExceptionPasargad.setName("پرداخت خرید بلیط-داخلی-خطای رسید");
		responseReceiptExceptionPasargad.setBeRetain(false);
		responseReceiptExceptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseReceiptExceptionPasargad.setNextState("092");
//		responseReceiptExceptionPasargad.setNextScreen("384");
...
//		responseBillCreditPasargad.setName("پرداخت خرید بلیط-اعتباری داخلی-موفق");
...
////		responseBillCreditPasargad.setNextScreen("388");
////		responseBillCreditPasargad.setScreenData("388[FF][SI]@@[ESC]P2126[ESC]\\");
//		responseBillCreditPasargad.setScreen(screenOnlineBillPaymentList);
//		responseBillCreditPasargad.setReceipt(receiptList);
//		getGeneralDao().saveOrUpdate(responseBillCreditPasargad);
//
//		FunctionCommandResponse responseReceiptExceptionCreditPasargad = new FunctionCommandResponse();
//		responseReceiptExceptionCreditPasargad.setName("پرداخت خرید بلیط-اعتباری داخلی-خطای رسید");
//		responseReceiptExceptionCreditPasargad.setBeRetain(false);
//		responseReceiptExceptionCreditPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseReceiptExceptionCreditPasargad.setNextState("192");
////		responseReceiptExceptionCreditPasargad.setNextScreen("384");
...
//		getGeneralDao().saveOrUpdate(responseReceiptExceptionCreditPasargad);
		...
		/*****************************/
		FunctionCommandResponse responseTimeOut = new FunctionCommandResponse();
		responseTimeOut.setName("پرداخت خرید بلیط-time out");
		responseTimeOut.setBeRetain(false);
		responseTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseTimeOut.setNextState("713");
//		responseTimeOut.setNextScreen("398");
...
//		atmRequestPreOnlineBillShetabEn.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseShetab);
//		atmRequestTimeOutPreOnlineBillShetabEn.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseTimeOut);
//		atmRequestPreOnlineBillShetabFa.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseShetab);
//		atmRequestTimeOutPreOnlineBillShetabFa.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseTimeOut);
		atmRequestPreOnlineBillPasargadFa.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responsePasargad);
		atmRequestTimeOutPreOnlineBillPasargadFa.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseTimeOut);
		atmRequestPreOnlineBillPasargadEn.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responsePasargad);
		atmRequestTimeOutPreOnlineBillPasargadEn.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseTimeOut);
//		atmRequestPreOnlineBillCreditPasargadFa.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseCreditPasargad);
//		atmRequestTimeOutPreOnlineBillCreditPasargadFa.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseTimeOut);
//		atmRequestPreOnlineBillCreditPasargadEn.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseCreditPasargad);
//		atmRequestTimeOutPreOnlineBillCreditPasargadEn.addAtmResponse(ATMErrorCodes.PREPARE_ONLINE_BILLPAYMENT, responseTimeOut);
...
//		getGeneralDao().saveOrUpdate(atmRequestPreOnlineBillShetabFa);
//		getGeneralDao().saveOrUpdate(atmRequestPreOnlineBillShetabEn);
		getGeneralDao().saveOrUpdate(atmRequestPreOnlineBillPasargadFa);
		getGeneralDao().saveOrUpdate(atmRequestPreOnlineBillPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestPreOnlineBillCreditPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestPreOnlineBillCreditPasargadEn);

//		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreOnlineBillShetabFa);
//		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreOnlineBillShetabEn);
		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreOnlineBillPasargadFa);
		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreOnlineBillPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreOnlineBillCreditPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestTimeOutPreOnlineBillCreditPasargadEn);
...
//		requests.add(atmRequestPreOnlineBillShetabFa);
//		requests.add(atmRequestPreOnlineBillShetabEn);
		requests.add(atmRequestPreOnlineBillPasargadFa);
		requests.add(atmRequestPreOnlineBillPasargadEn);
//		requests.add(atmRequestPreOnlineBillCreditPasargadFa);
//		requests.add(atmRequestPreOnlineBillCreditPasargadEn);

//		requests.add(atmRequestTimeOutPreOnlineBillShetabFa);
//		requests.add(atmRequestTimeOutPreOnlineBillShetabEn);
		requests.add(atmRequestTimeOutPreOnlineBillPasargadFa);
		requests.add(atmRequestTimeOutPreOnlineBillPasargadEn);
//		requests.add(atmRequestTimeOutPreOnlineBillCreditPasargadFa);
//		requests.add(atmRequestTimeOutPreOnlineBillCreditPasargadEn);

		return requests;
	}
	
	private List<ATMRequest> OnlineBillPaymentTracking(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
...
//		ATMRequest atmRequestTimeOutPreOnlineBillCreditPasargadEn = new ATMRequest();
		...
		String textFa = "[GR simpleOnlineBillPaymentTrackingReceiptFa()]"
//				headerFa
//				+ "[LF][LF][GR center(GR c2F('رسید پیگیری پرداخت قبض نوپاد'))]"
//				+ newLine
//				+ lineFa
//				+ receivedDateFa
//				+ newLine + newLine
...
//				+ "[GR justify(GR c2F('شماره قبض نوپاد'), GR c2F(ifx.OnlineBillPaymentRefNum))]"
//				+ newLine
//				+ "[GR justify(GR c2F('وضعیت'), GR c2F(ifx.onlineBillPaymentData.onlineBillPayment.paymentStatus))]"
//				+ newLine
//				+ amountFa
//				+ "[GR putLF(8)]"
//				+ footerFa
		...
		String textEn =
			headerEn
			+ (!atmType.equals(ATMType.NCR) ? "[LF][LF][GR center('NOPAD bill payment tracking Receipt')]" : "[LF][LF][GR center(GR c2NCRE('NOPAD bill payment tracking Receipt'))]")
			+ newLine
			+ lineEn
			+ receivedDateEn
			+ newLine + newLine
			...
			+ (!atmType.equals(ATMType.NCR) ? "[GR justify( GR c2E(ifx.OnlineBillPaymentDescription), 'Description')]" : "[GR justify( GR c2NCRE(ifx.OnlineBillPaymentDescription), GR c2NCRE('Description'))]")
			+ newLine
			+ (!atmType.equals(ATMType.NCR) ? "[GR justify(GR c2E(ifx.OnlineBillPaymentRefNum), 'ticket number')]" : "[GR justify(GR c2NCRE(ifx.OnlineBillPaymentRefNum), GR c2NCRE('ticket number'))]")
			+ newLine
			+ (!atmType.equals(ATMType.NCR) ? "[GR justify(GR c2E(ifx.onlineBillPaymentData.onlineBillPayment.paymentStatus), 'NOPAD bil number')]" : "[GR justify(GR c2NCRE(ifx.onlineBillPaymentData.onlineBillPayment.paymentStatus), GR c2NCRE('NOPAD bil number'))]")
			+ newLine
			+ amountEn
			+ "[GR putLF(8)]"
			+ footerEn
...
//		atmRequestTimeOutPreOnlineBillShetabEn.setFit(FITType.SHETAB);
		...
		atmRequestPreOnlineBillPasargadFa.setOpkey("ABHF    ");
		atmRequestPreOnlineBillPasargadFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_TRACKING);
		atmRequestPreOnlineBillPasargadFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestPreOnlineBillPasargadFa.setCurrency(currency);
		atmRequestPreOnlineBillPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPreOnlineBillPasargadFa.setFit(FITType.PASARGAD);

		atmRequestTimeOutPreOnlineBillPasargadFa.setOpkey("ABHF   F");
		atmRequestTimeOutPreOnlineBillPasargadFa.setIfxType(IfxType.ONLINE_BILLPAYMENT_TRACKING_REV_REPEAT);
		atmRequestTimeOutPreOnlineBillPasargadFa.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestTimeOutPreOnlineBillPasargadFa.setCurrency(currency);
		atmRequestTimeOutPreOnlineBillPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPreOnlineBillPasargadFa.setFit(FITType.PASARGAD);

		atmRequestPreOnlineBillPasargadEn.setOpkey("IBHF    ");
		atmRequestPreOnlineBillPasargadEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_TRACKING);
		atmRequestPreOnlineBillPasargadEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestPreOnlineBillPasargadEn.setCurrency(currency);
		atmRequestPreOnlineBillPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPreOnlineBillPasargadEn.setFit(FITType.PASARGAD);

		atmRequestTimeOutPreOnlineBillPasargadEn.setOpkey("IBHF   F");
		atmRequestTimeOutPreOnlineBillPasargadEn.setIfxType(IfxType.ONLINE_BILLPAYMENT_TRACKING_REV_REPEAT);
		atmRequestTimeOutPreOnlineBillPasargadEn.setTrnType(TrnType.ONLINE_BILLPAYMENT);
		atmRequestTimeOutPreOnlineBillPasargadEn.setCurrency(currency);
		atmRequestTimeOutPreOnlineBillPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPreOnlineBillPasargadEn.setFit(FITType.PASARGAD);
...
//		atmRequestReceiptExceptionCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
		...
		ResponseScreen screenOnlineBillPayFa = new ResponseScreen();
		screenOnlineBillPayFa.setScreenno("382");
		screenOnlineBillPayFa.setDesc("پیگیری خرید بلیط-موفق-فارسی");
		screenOnlineBillPayFa.setLanguage(UserLanguage.FARSI_LANG);
		screenOnlineBillPayFa.setScreenData("382[FF][SI]@@[ESC]P2129[ESC]\\");
		screenOnlineBillPaymentList.add(screenOnlineBillPayFa);
		getGeneralDao().saveOrUpdate(screenOnlineBillPayFa);

		ResponseScreen screenBillPayEn = new ResponseScreen();
		screenBillPayEn.setScreenno("782");
		screenBillPayEn.setDesc("خرید بلیط-موفق-انگلیسی");
		screenBillPayEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenBillPayEn.setScreenData("782[FF][SI]@@[ESC]P2529[ESC]\\");
		screenOnlineBillPaymentList.add(screenBillPayEn);
		getGeneralDao().saveOrUpdate(screenBillPayEn);
		...
		ResponseScreen screenCheckOrganizationFa = new ResponseScreen();
		screenCheckOrganizationFa.setScreenno("388");
		screenCheckOrganizationFa.setDesc("پیگیری بلیط-موفق-فارسی");
		screenCheckOrganizationFa.setLanguage(UserLanguage.FARSI_LANG);
		if (!atmType.equals(ATMType.NCR)){
			screenCheckOrganizationFa.setScreenData("388[ESC]P2129[ESC]\\"
					+ "[ESC](K[ESC][OC]80;m"
					+ "[SI]F0[GR ifx.OnlineBillPaymentRefNum]"
					+ "[SI]G0[GR c2F(ifx.OnlineBillPaymentDescription)]"
					+ "[SI]I0[GR ifx.Auth_Amt]"
					+ "[SI]H0 [GR c2F(ifx.onlineBillPaymentData.onlineBillPayment.paymentStatus)]");
		} else {
			screenCheckOrganizationFa.setScreenData("388[ESC]P2129[ESC]\\"
					+ "[ESC](6[ESC][OC]80;m"
					+ "[SI]F0[GR ifx.OnlineBillPaymentRefNum]"
...
//		+ "[SI]H0[GR ifx.actualAppPAN]"
		...
		ResponseScreen screenCheckOrganizationEn = new ResponseScreen();
		screenCheckOrganizationEn.setScreenno("788");
		screenCheckOrganizationEn.setDesc("پیگیری بلیط-موفق-انگلیسی");
		screenCheckOrganizationEn.setLanguage(UserLanguage.ENGLISH_LANG);
		if (!atmType.equals(ATMType.NCR)){
			screenCheckOrganizationEn.setScreenData("788[ESC]P2529[ESC]\\"
					+ "[ESC](1[ESC][OC]80;m"
					+ "[SI]F0[GR ifx.OnlineBillPaymentRefNum]"
					+ "[SI]G0[GR c2E(ifx.OnlineBillPaymentDescription)]"
					+ "[SI]I0[GR c2E(ifx.Auth_Amt)]"
					+ "[SI]H0[GR c2E(ifx.onlineBillPaymentData.onlineBillPayment.paymentStatus)]");
		} else {
			screenCheckOrganizationEn.setScreenData("788[ESC]P2529[ESC]\\"
					+ "[ESC](1[ESC][OC]80;m"
					+ "[SI]F0[GR ifx.OnlineBillPaymentRefNum]"
					+ "[SI]G0[GR c2NCR_SCR_E(ifx.OnlineBillPaymentDescription)]"
					+ "[SI]I0[GR c2NCR_SCR_E(ifx.Auth_Amt)]"
					+ "[SI]H0[GR c2NCR_SCR_E(ifx.onlineBillPaymentData.onlineBillPayment.paymentStatus)]");
		}
		screenCheckOrganizationList.add(screenCheckOrganizationEn);
		getGeneralDao().saveOrUpdate(screenCheckOrganizationEn);
...
//		getGeneralDao().saveOrUpdate(responseReceiptExceptionShetab);
		...
		/*****************************/
		//TODO: in fekr konam bayad hazf beshe
		FunctionCommandResponse responseBillPasargad = new FunctionCommandResponse();
		responseBillPasargad.setName("پرداخت خرید بلیط-داخلی-موفق");
		responseBillPasargad.setBeRetain(false);
		responseBillPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
...
//		atmRequestPreOnlineBillPasargadFa.addAtmResponse(ATMErrorCodes.ONLINE_BILLPAYMNET_TRACKING, responsePasargad);
//		atmRequestTimeOutPreOnlineBillPasargadFa.addAtmResponse(ATMErrorCodes.ONLINE_BILLPAYMNET_TRACKING, responseTimeOut);
//		atmRequestPreOnlineBillPasargadEn.addAtmResponse(ATMErrorCodes.ONLINE_BILLPAYMNET_TRACKING, responsePasargad);
//		atmRequestTimeOutPreOnlineBillPasargadEn.addAtmResponse(ATMErrorCodes.ONLINE_BILLPAYMNET_TRACKING, responseTimeOut);

		atmRequestPreOnlineBillPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responsePasargad);
		atmRequestTimeOutPreOnlineBillPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseTimeOut);
		atmRequestPreOnlineBillPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responsePasargad);
		atmRequestTimeOutPreOnlineBillPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseTimeOut);
...
//orig				+ "[SI]H0[GR c2E(ifx.ThirdPartyNameEn)]"
				+ "[SI]I0[GR ifx.Auth_Amt]");
		screenCheckOrganizationList.add(screenCheckOrganizationEn);
		getGeneralDao().saveOrUpdate(screenCheckOrganizationEn);
...
//			+ newLine + newLine 
			...
			+ transferBankNameFa //TASK Task029 : Print Bank Name
			+ newLine  
			+ transferAppPanFa
//			+ newLine + newLine 
			+ newLine  //TASK Task029 : Print Bank Name
			+ transferSecBankNameFa //TASK Task029 : Print Bank Name
			+ newLine  
			+ transferSecAppPanFa
//			+ newLine + newLine 
			+ newLine  
			...
			+ "))]" 
//			+ newLine //TASK Task029 : Print Bank Name
//			+ "[GR banknameFa(ifx.DestBankId)]"  //TASK Task029 : Print Bank Name
			+ "[GR putLF(10)]"
			+ footerFa;*/
...
//		responseCheckAccountTimeOut.setNextScreen("398");
	...
	//TASK Task002 : Transfer Card To Account by shenase
	private List<ATMRequest> TransferToAccountByShenase(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		...
		//------------------------------- Pasargad -----------------------
		//*****************************************Farsi Version****************************************
		atmRequestCheckAcountPasargadPart1Fa.setOpkey("ABICAB  ");//StateNo: 357//ABICA
		...
		atmRequestCheckAcountPasargadPart2Fa.setOpkey("ABICBA  ");// StateNo: 358//ABICB
		...
		atmRequestCheckAcountPasargadPart3Fa.setOpkey("ABICAA  ");//StateNo:359 //ABICC
		...
		atmRequestCheckAcountPasargadLastPartFa.setOpkey("ABICBB  ");//StateNo: //ABIC
		...
		atmRequestCheckAcountTimeOutPasargadPart1Fa.setOpkey("ABICAB F");
		atmRequestCheckAcountTimeOutPasargadPart1Fa.setNextOpkey("ABICAB F");
		...
		atmRequestCheckAcountTimeOutPasargadPart2Fa.setOpkey("ABICBA F");
		atmRequestCheckAcountTimeOutPasargadPart2Fa.setNextOpkey("ABICBA F");
		...
		atmRequestCheckAcountTimeOutPasargadPart3Fa.setOpkey("ABICAA F");
		atmRequestCheckAcountTimeOutPasargadPart3Fa.setNextOpkey("ABICAA F");
		...
		atmRequestCheckAcountTimeOutPasargadLastPartFa.setOpkey("ABICBB F");
		atmRequestCheckAcountTimeOutPasargadLastPartFa.setNextOpkey("ABICBB F");
		...
		atmRequestCheckAcountPasargadPart1En.setOpkey("IBICAB  ");//StateNo: 357//ABICA
		...
		atmRequestCheckAcountPasargadPart2En.setOpkey("IBICBA  ");// StateNo: 358//ABICB
		...
		atmRequestCheckAcountPasargadPart3En.setOpkey("IBICAA  ");//StateNo:359 //ABICC
		...
		atmRequestCheckAcountPasargadLastPartEn.setOpkey("IBICBB  ");//StateNo:362 //IBIC
		...
		atmRequestCheckAcountTimeOutPasargadPart1En.setOpkey("IBICAB F");
		atmRequestCheckAcountTimeOutPasargadPart1En.setNextOpkey("IBICAB F");
		...
		atmRequestCheckAcountTimeOutPasargadPart2En.setOpkey("IBICBA F");
		atmRequestCheckAcountTimeOutPasargadPart2En.setNextOpkey("IBICBA F");
		...
		atmRequestCheckAcountTimeOutPasargadPart3En.setOpkey("IBICAA F");
		atmRequestCheckAcountTimeOutPasargadPart3En.setNextOpkey("IBICAA F");
		...
		atmRequestCheckAcountTimeOutPasargadLastPartEn.setOpkey("IBICBB F");
		atmRequestCheckAcountTimeOutPasargadLastPartEn.setNextOpkey("IBICBB F");
		...
		/*String textFa =
			headerFa
			+ "[LF][LF][GR center(GR c2F('رسید انتقال به سپرده'))]"
			+ newLine
			+ lineFa
			+ receivedDateFa
//			+ newLine + newLine + newLine
...
//			+ "[GR ifx.CardHolderFamily]"
		...
		/************************/
		//-------------------------------- Pasargad --------------------------------------
		atmRequestTransferPasargadFa.setOpkey("ABIDAA  ");
		...
		atmRequestTransferTimeOutPasargadFa.setOpkey("ABIDAA F");
		atmRequestTransferTimeOutPasargadFa.setNextOpkey("ABIDAA F");
		...
		atmRequestTransferReceiptExceptionPasargadFa.setOpkey("ABIDAA A");
...
//		--------------------------------Start-------------------------------------
//		                           این قسمت در فایل اکسل موجود نبود
//		--------------------------------------------------------------------------
		...
		//Original
/*		atmRequestTransferTimeOutPasargadSubFa.setOpkey("ABIDB  F");
		atmRequestTransferTimeOutPasargadSubFa.setNextOpkey("ABIDA  F");
		atmRequestTransferTimeOutPasargadSubFa.setIfxType(IfxType.TRANSFER_CARD_TO_ACCOUNT_REV_REPEAT_RQ);
		atmRequestTransferTimeOutPasargadSubFa.setSecondaryIfxType(IfxType.TRANSFER_REV_REPEAT_RQ);
		atmRequestTransferTimeOutPasargadSubFa.setTrnType(TrnType.TRANSFER_CARD_TO_ACCOUNT);
		atmRequestTransferTimeOutPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT); 
...
//		----------------------------------End------------------------------------------
		...
		atmRequestTransferPasargadEn.setOpkey("IBIDAA  ");
		...
		atmRequestTransferTimeOutPasargadEn.setOpkey("IBIDAA F");
		...
		atmRequestTransferReceiptExceptionPasargadEn.setOpkey("IBIDAA A");
...
//		433[ESC]P2485[ESC]\[ESC](1[ESC][OC]00;80m[SI]GL[GR safeEn(ifx.CardHolderFamily)][GR safeEn(ifx.CardHolderName)][SI]HL[GR ifx.AppPAN][SI]IL[GR ifx.Auth_Amt]
		...
		responseCheckAccountPasargadPart1.setNextState("358");
		...
		responseCheckAccountPasargadPart2.setNextState("359");
		...
		responseCheckAccountPasargadPart3.setNextState("360");
		...
		responseCheckAccountPasargadLastPart.setNextState("371"); 
...
//AldComment Task002 : Backup		atmRequestTransferReceiptExceptionPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
	...
	//TASK Task001 : Add Sheba
	//TASK Task019 : Receipt Option
	private List<ATMRequest> Sheba(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
...
//		ATMRequest atmRequestReceiptOptionPasargadEn = new ATMRequest(); //Task019	
		...
		//AldTODO Task019 : Receipt Option use simple....()
		String textFa = "[GR simpleShebaReceiptFa()]";
//				headerFa
////				+ newLine + newLine 
//				+ newLine  
//				+ "[GR center(GR c2F('رسید شبا')) ]"
//				+ newLine
//				+ lineFa
//				+ receivedDateFa 
////				+ newLine + newLine + newLine
...
//				+ newLine + newLine 
				+ newLine  
				+(!atmType.equals(ATMType.NCR) ? "[GR center('Sheba Receipt') ]" : "[GR center(GR c2NCRE('Sheba Receipt')) ]")
				+ newLine
				+ lineEn
				+ receivedDateEn 
//				+ newLine + newLine + newLine
...
//				+ newLine + newLine 
				...
				+ footerEn
				;		
		//TODO AD: Journal Monaseb Eijad shavad
		String textJournal00 =  "[GR simpleShebaJournal()]";
				//"[LF]Sheba:[SO]1REF:[GR ifx.Src_TrnSeqCntr][SO]1PAN:[GR ifx.actualAppPAN][SO]1TIME:[GR ifx.receivedDt]";
		...
		atmRequestPasargadFa.setOpkey("ABCBA   ");
		atmRequestPasargadFa.setIfxType(IfxType.SHEBA_INQ_RQ);
		atmRequestPasargadFa.setTrnType(TrnType.SHEBAINQUIRY);
		atmRequestPasargadFa.setCurrency(currency);
		atmRequestPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPasargadFa.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadFa.setOpkey("ABCBA  F");
		atmRequestTimeOutPasargadFa.setIfxType(IfxType.SHEBA_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadFa.setTrnType(TrnType.SHEBAINQUIRY);
		atmRequestTimeOutPasargadFa.setCurrency(currency);
		atmRequestTimeOutPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPasargadFa.setFit(FITType.PASARGAD);

		//Task019
//		atmRequestReceiptOptionPasargadFa.setOpkey("ABCBA  B");
//		atmRequestReceiptOptionPasargadFa.setIfxType(IfxType.SHEBA_INQ_RQ);
//		atmRequestReceiptOptionPasargadFa.setTrnType(TrnType.SHEBAINQUIRY);
//		atmRequestReceiptOptionPasargadFa.setCurrency(currency);
//		atmRequestReceiptOptionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestReceiptOptionPasargadFa.setFit(FITType.PASARGAD);
//		atmRequestReceiptOptionPasargadFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
...
/********************************/
		...
		atmRequestPasargadEn.setOpkey("IBCBA   ");
		atmRequestPasargadEn.setIfxType(IfxType.SHEBA_INQ_RQ);
		atmRequestPasargadEn.setTrnType(TrnType.SHEBAINQUIRY);
		atmRequestPasargadEn.setCurrency(currency);
		atmRequestPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPasargadEn.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadEn.setOpkey("IBCBA  F");
		atmRequestTimeOutPasargadEn.setIfxType(IfxType.SHEBA_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadEn.setTrnType(TrnType.SHEBAINQUIRY);
		atmRequestTimeOutPasargadEn.setCurrency(currency);
		atmRequestTimeOutPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPasargadEn.setFit(FITType.PASARGAD);
		
		//Task019
//		atmRequestReceiptOptionPasargadEn.setOpkey("IBCBA  B");
//		atmRequestReceiptOptionPasargadEn.setIfxType(IfxType.SHEBA_INQ_RQ);
//		atmRequestReceiptOptionPasargadEn.setTrnType(TrnType.SHEBAINQUIRY);
//		atmRequestReceiptOptionPasargadEn.setCurrency(currency);
//		atmRequestReceiptOptionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestReceiptOptionPasargadEn.setFit(FITType.PASARGAD);		
//		atmRequestReceiptOptionPasargadEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);		
		...
		/********************************/
		List<ResponseScreen> screenShebaList = new ArrayList<ResponseScreen>();
		
		ResponseScreen screenShebaFa = new ResponseScreen();
		screenShebaFa.setScreenno("388");
		screenShebaFa.setDesc("اعلام شماره شبا-موفق-فارسی");
		screenShebaFa.setLanguage(UserLanguage.FARSI_LANG);
		screenShebaFa.setScreenData("388[FF][SI]@@[ESC]P2112[ESC]\\");
		screenShebaList.add(screenShebaFa);
		getGeneralDao().saveOrUpdate(screenShebaFa);
		
		ResponseScreen screenShebaEn = new ResponseScreen();
		screenShebaEn.setScreenno("788");
		screenShebaEn.setDesc("اعلام شماره شبا-موفق-انگلیسی");
		screenShebaEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenShebaEn.setScreenData("788[FF][SI]@@[ESC]P2512[ESC]\\");
		screenShebaList.add(screenShebaEn);
		getGeneralDao().saveOrUpdate(screenShebaEn);
		
		List<ResponseScreen> screenRecieptList = new ArrayList<ResponseScreen>();
		
		ResponseScreen screenReceiptFa = new ResponseScreen();
		screenReceiptFa.setScreenno("388"); //387 -> 388  //Task019
		screenReceiptFa.setDesc("اعلام شماره شبا-عدم چاپ رسید-فارسی");
		screenReceiptFa.setLanguage(UserLanguage.FARSI_LANG);
		
		
		screenReceiptFa.setScreenData("388[FF][SI]@@[ESC]P2067[ESC]\\[ESC](1[ESC][OC]"+updateablePageFontColor+"[SI]HB[GR ifx.shebaCode]"); //Task019
//		screenReceiptFa.setScreenData("387[FF][SI]@@[ESC]P2067[ESC]\\[ESC](1[ESC][OC]"+updateablePageFontColor+"[SI]HB[GR ifx.shebaCode]");//TODO AD:Position & Color Sheba Code ra pas az tasvib emal konim
//		screenReceiptFa.setScreenData("387[FF][SI]@@[ESC]P2067[ESC]\\[ESC](1[ESC][OC]00;67;m[SI]HB[GR ifx.shebaCode]");//TODO AD:Position & Color Sheba Code ra pas az tasvib emal konim
		...
		ResponseScreen screenRecieptEn = new ResponseScreen();
		screenRecieptEn.setScreenno("788"); //787 -> 788 //Task019
		screenRecieptEn.setDesc("اعلام شماره شبا-عدم چاپ رسید-انگلیسی"); //Task019
		screenRecieptEn.setLanguage(UserLanguage.ENGLISH_LANG);
		
		screenRecieptEn.setScreenData("788[FF][SI]@@[ESC]P2467[ESC]\\[ESC](1[ESC][OC]"+updateablePageFontColor+"[SI]HC[GR ifx.shebaCode]");//Task019
//		screenRecieptEn.setScreenData("787[FF][SI]@@[ESC]P2467[ESC]\\[ESC](1[ESC][OC]"+updateablePageFontColor+"[SI]HC[GR ifx.shebaCode]");//TODO AD:Position & Color Sheba Code ra pas az tasvib emal konim
//		screenRecieptEn.setScreenData("787[FF][SI]@@[ESC]P2467[ESC]\\[ESC](1[ESC][OC]80;m[SI]HC[GR ifx.shebaCode]");//TODO AD:Position & Color Sheba Code ra pas az tasvib emal konim
		...
		ResponseScreen screenTimeoutFa = new ResponseScreen();
		screenTimeoutFa.setScreenno("398");
		screenTimeoutFa.setDesc("اعلام شماره شبا-Timeout-فارسی");
		screenTimeoutFa.setLanguage(UserLanguage.FARSI_LANG);
		screenTimeoutFa.setScreenData(null);
		screenTimeoutList.add(screenTimeoutFa);
		getGeneralDao().saveOrUpdate(screenTimeoutFa);
		...
		ResponseScreen screenTimeoutEn = new ResponseScreen();
		screenTimeoutEn.setScreenno("798");
		screenTimeoutEn.setDesc("اعلام شماره-Timeout-انگلیسی");
		screenTimeoutEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenTimeoutEn.setScreenData(null);
		screenTimeoutList.add(screenTimeoutEn);
		getGeneralDao().saveOrUpdate(screenTimeoutEn);
		...
		FunctionCommandResponse responseShebaPasargad = new FunctionCommandResponse();
		responseShebaPasargad.setName("اعلام شماره شبا-داخلی-موفق");
		responseShebaPasargad.setBeRetain(false);
		responseShebaPasargad.setDispense(null);
		responseShebaPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseShebaPasargad.setNextState("096");
		responseShebaPasargad.setScreen(screenShebaList);
		responseShebaPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseShebaPasargad);

		FunctionCommandResponse responseReceiptOptionPasargad = new FunctionCommandResponse();
		responseReceiptOptionPasargad.setName("اعلام شماره شبا-داخلی-عدم چاپ رسید"); //Task019
		responseReceiptOptionPasargad.setBeRetain(false);
		responseReceiptOptionPasargad.setDispense(null);
		responseReceiptOptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseReceiptOptionPasargad.setNextState("096"); //098 -> 096 //Task019
		responseReceiptOptionPasargad.setScreen(screenRecieptList);
		responseReceiptOptionPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseReceiptOptionPasargad);
		...
		/********************************/
		FunctionCommandResponse responseTimeOut = new FunctionCommandResponse();
		responseTimeOut.setName("اعلام شماره شبا-time out");
		responseTimeOut.setBeRetain(false);
		responseTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseTimeOut.setNextState("713");
//		responseTimeOut.setNextScreen("398");
		...
		atmRequestPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseShebaPasargad);
		atmRequestPasargadFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestTimeOutPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
//		atmRequestReceiptOptionPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionPasargad); //Task019
		
		
		atmRequestPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseShebaPasargad);
		atmRequestPasargadEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestTimeOutPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
//		atmRequestReceiptOptionPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionPasargad); //Task019
...
//		requests.add(atmRequestReceiptOptionPasargadEn);//Task019
	...
	//TASK Task015 : HotCard
	private List<ATMRequest> HotCard(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
		...
		//TODO AD: Journal Monaseb Eijad shavad
		String textJournal00 = "[LF]HotCard:[SO]1REF:[GR ifx.Src_TrnSeqCntr][SO]1PAN:[GR ifx.actualAppPAN][SO]1TIME:[GR ifx.receivedDt][SO]1TERMINAL:[GR ifx.TerminalId]";
		...
		atmRequestShetabFa.setOpkey("AACCA   ");
		atmRequestShetabFa.setIfxType(IfxType.HOTCARD_INQ_RQ);
		atmRequestShetabFa.setTrnType(TrnType.HOTCARD);
		atmRequestShetabFa.setCurrency(currency);
		atmRequestShetabFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestShetabFa.setFit(FITType.SHETAB);
		
		atmRequestTimeOutShetabFa.setOpkey("AACCA  F");
		atmRequestTimeOutShetabFa.setIfxType(IfxType.HOTCARD_REV_REPEAT_RQ);
		atmRequestTimeOutShetabFa.setTrnType(TrnType.HOTCARD);
		atmRequestTimeOutShetabFa.setCurrency(currency);
		atmRequestTimeOutShetabFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutShetabFa.setFit(FITType.SHETAB);
		/********************************/
		...
		atmRequestShetabEn.setOpkey("IACCA   ");
		atmRequestShetabEn.setIfxType(IfxType.HOTCARD_INQ_RQ);
		atmRequestShetabEn.setTrnType(TrnType.HOTCARD);
		atmRequestShetabEn.setCurrency(currency);
		atmRequestShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestShetabEn.setFit(FITType.SHETAB);
		
		atmRequestTimeOutShetabEn.setOpkey("IACCA  F");
		atmRequestTimeOutShetabEn.setIfxType(IfxType.HOTCARD_REV_REPEAT_RQ);
		atmRequestTimeOutShetabEn.setTrnType(TrnType.HOTCARD);
		atmRequestTimeOutShetabEn.setCurrency(currency);
		atmRequestTimeOutShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutShetabEn.setFit(FITType.SHETAB);
		...
		atmRequestPasargadFa.setOpkey("ABCCA   ");
		atmRequestPasargadFa.setIfxType(IfxType.HOTCARD_INQ_RQ);
		atmRequestPasargadFa.setTrnType(TrnType.HOTCARD);
		atmRequestPasargadFa.setCurrency(currency);
		atmRequestPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPasargadFa.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadFa.setOpkey("ABCCA  F");
		atmRequestTimeOutPasargadFa.setIfxType(IfxType.HOTCARD_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadFa.setTrnType(TrnType.HOTCARD);
		atmRequestTimeOutPasargadFa.setCurrency(currency);
		atmRequestTimeOutPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPasargadFa.setFit(FITType.PASARGAD);
		/********************************/
		...
		atmRequestPasargadEn.setOpkey("IBCCA   ");
		atmRequestPasargadEn.setIfxType(IfxType.HOTCARD_INQ_RQ);
		atmRequestPasargadEn.setTrnType(TrnType.HOTCARD);
		atmRequestPasargadEn.setCurrency(currency);
		atmRequestPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPasargadEn.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadEn.setOpkey("IBCCA  F");
		atmRequestTimeOutPasargadEn.setIfxType(IfxType.HOTCARD_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadEn.setTrnType(TrnType.HOTCARD);
		atmRequestTimeOutPasargadEn.setCurrency(currency);
		atmRequestTimeOutPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPasargadEn.setFit(FITType.PASARGAD);
			
		/********************************/
		atmRequestCreditPasargadFa.setOpkey("ACCCA   ");
		atmRequestCreditPasargadFa.setIfxType(IfxType.HOTCARD_INQ_RQ);
		atmRequestCreditPasargadFa.setTrnType(TrnType.HOTCARD);
		atmRequestCreditPasargadFa.setCurrency(currency);
		atmRequestCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
		
		atmRequestTimeOutCreditPasargadFa.setOpkey("ACCCA  F");
		atmRequestTimeOutCreditPasargadFa.setIfxType(IfxType.HOTCARD_REV_REPEAT_RQ);
		atmRequestTimeOutCreditPasargadFa.setTrnType(TrnType.HOTCARD);
		atmRequestTimeOutCreditPasargadFa.setCurrency(currency);
		atmRequestTimeOutCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
		/********************************/
		...
		atmRequestCreditPasargadEn.setOpkey("ICCCA   ");
		atmRequestCreditPasargadEn.setIfxType(IfxType.HOTCARD_INQ_RQ);
		atmRequestCreditPasargadEn.setTrnType(TrnType.HOTCARD);
		atmRequestCreditPasargadEn.setCurrency(currency);
		atmRequestCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
		
		atmRequestTimeOutCreditPasargadEn.setOpkey("ICCCA  F");
		atmRequestTimeOutCreditPasargadEn.setIfxType(IfxType.HOTCARD_REV_REPEAT_RQ);
		atmRequestTimeOutCreditPasargadEn.setTrnType(TrnType.HOTCARD);
		atmRequestTimeOutCreditPasargadEn.setCurrency(currency);
		atmRequestTimeOutCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
		...
		List<ResponseScreen> screenHotCardList = new ArrayList<ResponseScreen>();
		
		ResponseScreen screenHotCardFa = new ResponseScreen();
		screenHotCardFa.setScreenno("385");
		screenHotCardFa.setDesc("مسدود کردن کارت-موفق-فارسی");
		screenHotCardFa.setLanguage(UserLanguage.FARSI_LANG);
		screenHotCardFa.setScreenData("385[FF][SI]@@[ESC]P2037[ESC]\\");
		screenHotCardList.add(screenHotCardFa);
		getGeneralDao().saveOrUpdate(screenHotCardFa);
		
		ResponseScreen screenHotCardEn = new ResponseScreen();
		screenHotCardEn.setScreenno("785");
		screenHotCardEn.setDesc("مسدود کردن  کارت-موفق-انگلیسی");
		screenHotCardEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenHotCardEn.setScreenData("785[FF][SI]@@[ESC]P2437[ESC]\\");
		screenHotCardList.add(screenHotCardEn);
		getGeneralDao().saveOrUpdate(screenHotCardEn);
		
		//AldTODO Task015 : Yek Fekri Baraye Khataye Resid Beshavad Felan Hazf Shode Ast
//		List<ResponseScreen> screenRecieptList = new ArrayList<ResponseScreen>();
		...
		ResponseScreen screenTimeoutFa = new ResponseScreen();
		screenTimeoutFa.setScreenno("398");
		screenTimeoutFa.setDesc("مسدود کردن کارت-Timeout-فارسی");
		screenTimeoutFa.setLanguage(UserLanguage.FARSI_LANG);
		screenTimeoutFa.setScreenData(null);
		screenTimeoutList.add(screenTimeoutFa);
		getGeneralDao().saveOrUpdate(screenTimeoutFa);
		...
		ResponseScreen screenTimeoutEn = new ResponseScreen();
		screenTimeoutEn.setScreenno("798");
		screenTimeoutEn.setDesc("مسدود کردن کارت-Timeout-انگلیسی");
		screenTimeoutEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenTimeoutEn.setScreenData(null);
		screenTimeoutList.add(screenTimeoutEn);
		getGeneralDao().saveOrUpdate(screenTimeoutEn);				
		...
		/********************************/
		//TASK Task015 : add in 92.03.11
		List<ResponseScreen> screenInactiveCardList = new ArrayList<ResponseScreen>();
		ResponseScreen screenInactiveCardFa = new ResponseScreen();
		screenInactiveCardFa.setScreenno("385");
		screenInactiveCardFa.setDesc("مسدود کردن کارت-InactiveCard-فارسی");
		screenInactiveCardFa.setLanguage(UserLanguage.FARSI_LANG);
		screenInactiveCardFa.setScreenData("385[FF][SI]@@[ESC]P2038[ESC]\\");
		screenInactiveCardList.add(screenInactiveCardFa);
		getGeneralDao().saveOrUpdate(screenInactiveCardFa);
		
		ResponseScreen screenInactiveCardEn = new ResponseScreen();
		screenInactiveCardEn.setScreenno("785");
		screenInactiveCardEn.setDesc("مسدود کردن کارت-InactiveCard-انگلیسی");
		screenInactiveCardEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenInactiveCardEn.setScreenData("785[FF][SI]@@[ESC]P2438[ESC]\\");
		screenInactiveCardList.add(screenInactiveCardEn);
		getGeneralDao().saveOrUpdate(screenInactiveCardEn);
		
		/*********************************/
		
		FunctionCommandResponse responseHotCardShetab = new FunctionCommandResponse();
		responseHotCardShetab.setName("مسدود کردن کارت-شتابی-موفق");
		responseHotCardShetab.setBeRetain(false);
		responseHotCardShetab.setDispense(null);
		responseHotCardShetab.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseHotCardShetab.setNextState("708");
		responseHotCardShetab.setScreen(screenHotCardList);
		responseHotCardShetab.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseHotCardShetab);

		/********************************/
		
		FunctionCommandResponse responseHotCardPasargad = new FunctionCommandResponse();
		responseHotCardPasargad.setName("مسدود کردن کارت-داخلی-موفق");
		responseHotCardPasargad.setBeRetain(false);
		responseHotCardPasargad.setDispense(null);
		responseHotCardPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseHotCardPasargad.setNextState("708");
		responseHotCardPasargad.setScreen(screenHotCardList);
		responseHotCardPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseHotCardPasargad);

		/********************************/
		
		FunctionCommandResponse responseHotCardCreditPasargad = new FunctionCommandResponse();
		responseHotCardCreditPasargad.setName("مسدود کردن کارت-اعتباری داخلی-موفق");
		responseHotCardCreditPasargad.setBeRetain(false);
		responseHotCardCreditPasargad.setDispense(null);
		responseHotCardCreditPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseHotCardCreditPasargad.setNextState("708");
		responseHotCardCreditPasargad.setScreen(screenHotCardList);
		responseHotCardCreditPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseHotCardCreditPasargad);
		
		/********************************/
		FunctionCommandResponse responseTimeOut = new FunctionCommandResponse();
		responseTimeOut.setName("مسدود کردن کارت-time out");
		responseTimeOut.setBeRetain(false);
		responseTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseTimeOut.setNextState("713");
		responseTimeOut.setScreen(screenTimeoutList);
		...
		getGeneralDao().saveOrUpdate(responseTimeOut);
		/********************************/
		FunctionCommandResponse responseInactiveCard = new FunctionCommandResponse();
		responseInactiveCard.setName("مسدود کردن کارت-Inactive Card");
		responseInactiveCard.setBeRetain(false);
		responseInactiveCard.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseInactiveCard.setNextState("708");
		responseInactiveCard.setScreen(screenInactiveCardList);
		responseInactiveCard.setReceipt(null);
		getGeneralDao().saveOrUpdate(responseInactiveCard);
		/********************************/		

		atmRequestShetabFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseHotCardShetab);
		atmRequestTimeOutShetabFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestShetabFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.INVALID_MERCHANT), responseInactiveCard); //Task Task015 : add in  92.03.11
		//AldComment Task015 : change in 92.03.20 
		
		atmRequestShetabEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseHotCardShetab);
		atmRequestTimeOutShetabEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestShetabEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.INVALID_MERCHANT), responseInactiveCard);//Task Task015 : add in  92.03.11
		
		
		atmRequestPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseHotCardPasargad);
		atmRequestTimeOutPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.INVALID_MERCHANT), responseInactiveCard);//Task Task015 : add in  92.03.11
		
		atmRequestPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseHotCardPasargad);
		atmRequestTimeOutPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.INVALID_MERCHANT), responseInactiveCard);//Task Task015 : add in  92.03.11
		
		
		atmRequestCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseHotCardCreditPasargad);
		atmRequestTimeOutCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.INVALID_MERCHANT), responseInactiveCard);//Task Task015 : add in  92.03.11
		
		atmRequestCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseHotCardCreditPasargad);
		atmRequestTimeOutCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.INVALID_MERCHANT), responseInactiveCard);//Task Task015 : add in  92.03.11
...
//		responseTimeOut.setNextScreen("398");
	...
	//TASK Task057 : ATM Topup 
	public List<ATMRequest> purchaseTopupCharge(ATMConfiguration configuration, OARResponse oarResponse)throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
		
		ATMRequest atmRequestShetabFa = new ATMRequest();
		ATMRequest atmRequestTimeOutShetabFa = new ATMRequest();
		ATMRequest atmRequestReceiptOptionShetabFa = new ATMRequest();
		
		ATMRequest atmRequestShetabEn = new ATMRequest();
		ATMRequest atmRequestTimeOutShetabEn = new ATMRequest();
		ATMRequest atmRequestReceiptOptionShetabEn = new ATMRequest();
		...
		String customerReceiptFaText = "[GR simplePurchaseTopupChargeReceiptFa()]";
//			  headerFa
//			+ "[LF][LF][GR center(c2F('رسید خرید شارژ مستقیم')) ]"
//			+ newLine
//			+ lineFa
//			+ receivedDateFa
////			+ newLine + newLine + newLine
...
//			+ "[GR center('-----------')]"
//			+ newLine  
//			+ "[GR justify(c2F('شماره موبایل'), GR c2F(GR ifx.TopupCellPhoneNumber))]"
//			+ newLine
//			+ amountFa
////			+ newLine + newLine 
////			+ newLine + newLine 
...
//			+ footerFa;
		...
		String customerReceiptEnText = 
			 headerEn
				+ (!atmType.equals(ATMType.NCR) ? "[LF][LF][GR center('Topup Charge Card') ]" : "[LF][LF][GR center(GR c2NCRE('Topup Charge Card')) ]")
				+ newLine
				+ lineEn
				+ receivedDateEn
//				+ newLine + newLine + newLine
...
//				+ newLine + newLine 
				...
				+ (!atmType.equals(ATMType.NCR) ?  "[GR justify(ifx.getTopupData().getCellPhoneNumber(),'Mobile No')]"
				  : "[GR justify(c2NCRE(ifx.getTopupData().getCellPhoneNumber()),GR c2NCRE('Mobile No'))]")
				+ newLine  
				+ amountEn
				+ newLine
				+ (!atmType.equals(ATMType.NCR) ?  "[GR center('IranCell HelpDesk Phone Number 140') ]"
		...
		String textJournal00 = "[GR simpleTopupChargeJournal()]"; 
				//"[LF]Topup Charge:[SO]1[GR ifx.Auth_Amt][SO]1REF:[GR ifx.Src_TrnSeqCntr][SO]1PAN:[GR ifx.actualAppPAN][SO]1TIME:[GR ifx.receivedDt][SO]1[GR ifx.getTopupData().getSerialNo()]";
		...
		/****************************/
		atmRequestShetabFa.setOpkey("AADI    ");
		atmRequestShetabFa.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestShetabFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestShetabFa.setCurrency(currency);
		atmRequestShetabFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestShetabFa.setFit(FITType.SHETAB);
		
		atmRequestTimeOutShetabFa.setOpkey("AADI   F");
		atmRequestTimeOutShetabFa.setIfxType(IfxType.PURCHASE_TOPUP_REV_REPEAT_RQ);
		atmRequestTimeOutShetabFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestTimeOutShetabFa.setCurrency(currency);
		atmRequestTimeOutShetabFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutShetabFa.setFit(FITType.SHETAB);
		
		atmRequestReceiptOptionShetabFa.setOpkey("AADI   B");
		atmRequestReceiptOptionShetabFa.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestReceiptOptionShetabFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestReceiptOptionShetabFa.setCurrency(currency);
		atmRequestReceiptOptionShetabFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestReceiptOptionShetabFa.setFit(FITType.SHETAB);	
		atmRequestReceiptOptionShetabFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		atmRequestShetabEn.setOpkey("IADI    ");
		atmRequestShetabEn.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestShetabEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestShetabEn.setCurrency(currency);
		atmRequestShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestShetabEn.setFit(FITType.SHETAB);
		
		atmRequestTimeOutShetabEn.setOpkey("IADI   F");
		atmRequestTimeOutShetabEn.setIfxType(IfxType.PURCHASE_TOPUP_REV_REPEAT_RQ);
		atmRequestTimeOutShetabEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestTimeOutShetabEn.setCurrency(currency);
		atmRequestTimeOutShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutShetabEn.setFit(FITType.SHETAB);
		
		atmRequestReceiptOptionShetabEn.setOpkey("IADI   B");
		atmRequestReceiptOptionShetabEn.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestReceiptOptionShetabEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestReceiptOptionShetabEn.setCurrency(currency);
		atmRequestReceiptOptionShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestReceiptOptionShetabEn.setFit(FITType.SHETAB);
		atmRequestReceiptOptionShetabEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		atmRequestPasargadFa.setOpkey("ABDIA   ");
		atmRequestPasargadFa.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestPasargadFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestPasargadFa.setCurrency(currency);
		atmRequestPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPasargadFa.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadFa.setOpkey("ABDIA  F");
		atmRequestTimeOutPasargadFa.setIfxType(IfxType.PURCHASE_TOPUP_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestTimeOutPasargadFa.setCurrency(currency);
		atmRequestTimeOutPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPasargadFa.setFit(FITType.PASARGAD);
		
		atmRequestReceiptOptionPasargadFa.setOpkey("ABDIA  B");
		atmRequestReceiptOptionPasargadFa.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestReceiptOptionPasargadFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestReceiptOptionPasargadFa.setCurrency(currency);
		atmRequestReceiptOptionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestReceiptOptionPasargadFa.setFit(FITType.PASARGAD);	
		atmRequestReceiptOptionPasargadFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		atmRequestPasargadSubFa.setOpkey("ABDIB   ");
		atmRequestPasargadSubFa.setNextOpkey("ABDIA   ");
		atmRequestPasargadSubFa.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestPasargadSubFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestPasargadSubFa.setCurrency(currency);
		atmRequestPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPasargadSubFa.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadSubFa.setOpkey("ABDIB  F");
		atmRequestTimeOutPasargadSubFa.setNextOpkey("ABDIB  F");
		atmRequestTimeOutPasargadSubFa.setIfxType(IfxType.PURCHASE_TOPUP_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestTimeOutPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestTimeOutPasargadSubFa.setCurrency(currency);
		atmRequestTimeOutPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPasargadSubFa.setFit(FITType.PASARGAD);
		
		atmRequestReceiptOptionPasargadSubFa.setOpkey("ABDIB  B");
		atmRequestReceiptOptionPasargadSubFa.setNextOpkey("ABDIA  B");
		atmRequestReceiptOptionPasargadSubFa.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestReceiptOptionPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestReceiptOptionPasargadSubFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestReceiptOptionPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestReceiptOptionPasargadSubFa.setCurrency(currency);
		atmRequestReceiptOptionPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestReceiptOptionPasargadSubFa.setFit(FITType.PASARGAD);
		...
		atmRequestPasargadEn.setOpkey("IBDIA   ");
		atmRequestPasargadEn.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestPasargadEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestPasargadEn.setCurrency(currency);
		atmRequestPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPasargadEn.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadEn.setOpkey("IBDIA  F");
		atmRequestTimeOutPasargadEn.setIfxType(IfxType.PURCHASE_TOPUP_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestTimeOutPasargadEn.setCurrency(currency);
		atmRequestTimeOutPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPasargadEn.setFit(FITType.PASARGAD);
		
		atmRequestReceiptOptionPasargadEn.setOpkey("IBDIA  B");
		atmRequestReceiptOptionPasargadEn.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestReceiptOptionPasargadEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestReceiptOptionPasargadEn.setCurrency(currency);
		atmRequestReceiptOptionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestReceiptOptionPasargadEn.setFit(FITType.PASARGAD);
		atmRequestReceiptOptionPasargadEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		/****************************/
		atmRequestPasargadSubEn.setOpkey("IBDIB   ");
		atmRequestPasargadSubEn.setNextOpkey("IBDIA   ");
		atmRequestPasargadSubEn.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestPasargadSubEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestPasargadSubEn.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestPasargadSubEn.setCurrency(currency);
		atmRequestPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPasargadSubEn.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadSubEn.setOpkey("IBDIB  F");
		atmRequestTimeOutPasargadSubEn.setNextOpkey("IBDIB  F");
		atmRequestTimeOutPasargadSubEn.setIfxType(IfxType.PURCHASE_TOPUP_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadSubEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestTimeOutPasargadSubEn.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestTimeOutPasargadSubEn.setCurrency(currency);
		atmRequestTimeOutPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPasargadSubEn.setFit(FITType.PASARGAD);
		
		atmRequestReceiptOptionPasargadSubEn.setOpkey("IBDIB  B");
		atmRequestReceiptOptionPasargadSubEn.setNextOpkey("IBDIA  B");
		atmRequestReceiptOptionPasargadSubEn.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestReceiptOptionPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
		atmRequestReceiptOptionPasargadSubEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestReceiptOptionPasargadSubEn.setSecondaryTrnType(TrnType.GETACCOUNT);
		atmRequestReceiptOptionPasargadSubEn.setCurrency(currency);
		atmRequestReceiptOptionPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestReceiptOptionPasargadSubEn.setFit(FITType.PASARGAD);		
		...
		/****************************/
		atmRequestCreditPasargadFa.setOpkey("ACDI    ");
		atmRequestCreditPasargadFa.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestCreditPasargadFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestCreditPasargadFa.setCurrency(currency);
		atmRequestCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
		
		atmRequestTimeOutCreditPasargadFa.setOpkey("ACDI   F");
		atmRequestTimeOutCreditPasargadFa.setIfxType(IfxType.PURCHASE_TOPUP_REV_REPEAT_RQ);
		atmRequestTimeOutCreditPasargadFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestTimeOutCreditPasargadFa.setCurrency(currency);
		atmRequestTimeOutCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
		
		atmRequestReceiptOptionCreditPasargadFa.setOpkey("ACDI   B");
		atmRequestReceiptOptionCreditPasargadFa.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestReceiptOptionCreditPasargadFa.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestReceiptOptionCreditPasargadFa.setCurrency(currency);
		atmRequestReceiptOptionCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestReceiptOptionCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);	
		atmRequestReceiptOptionCreditPasargadFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		atmRequestCreditPasargadEn.setOpkey("ICDI    ");
		atmRequestCreditPasargadEn.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestCreditPasargadEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestCreditPasargadEn.setCurrency(currency);
		atmRequestCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);

		atmRequestTimeOutCreditPasargadEn.setOpkey("ICDI   F");
		atmRequestTimeOutCreditPasargadEn.setIfxType(IfxType.PURCHASE_TOPUP_REV_REPEAT_RQ);
		atmRequestTimeOutCreditPasargadEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestTimeOutCreditPasargadEn.setCurrency(currency);
		atmRequestTimeOutCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
		
		atmRequestReceiptOptionCreditPasargadEn.setOpkey("ICDI   B");
		atmRequestReceiptOptionCreditPasargadEn.setIfxType(IfxType.PURCHASE_TOPUP_RQ);
		atmRequestReceiptOptionCreditPasargadEn.setTrnType(TrnType.PURCHASETOPUP);
		atmRequestReceiptOptionCreditPasargadEn.setCurrency(currency);
		atmRequestReceiptOptionCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestReceiptOptionCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);		
		atmRequestReceiptOptionCreditPasargadEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		/****************************/
		List<ResponseScreen> screenTopupChargeList = new ArrayList<ResponseScreen>();
		
		ResponseScreen screenTopupChargeFa = new ResponseScreen();
		screenTopupChargeFa.setScreenno("388");
		screenTopupChargeFa.setDesc("خرید شارژ مستقیم-موفق-فارسی");
		screenTopupChargeFa.setLanguage(UserLanguage.FARSI_LANG);
		screenTopupChargeFa.setScreenData("388[FF][SI]@@[ESC]P2134[ESC]\\");  
		screenTopupChargeList.add(screenTopupChargeFa);
		getGeneralDao().saveOrUpdate(screenTopupChargeFa);
		
		ResponseScreen screenTopupChargeEn = new ResponseScreen();
		screenTopupChargeEn.setScreenno("788");
		screenTopupChargeEn.setDesc("خرید شارژ مستقیم-موفق-انگلیسی");
		screenTopupChargeEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenTopupChargeEn.setScreenData("788[FF][SI]@@[ESC]P2534[ESC]\\");  
		screenTopupChargeList.add(screenTopupChargeEn);
		getGeneralDao().saveOrUpdate(screenTopupChargeEn);

		/*****************************/
		List<ResponseScreen> screenTopupChargeReceiptOptionList = new ArrayList<ResponseScreen>();
		
		ResponseScreen screenTopupChargeReceiptFa = new ResponseScreen();
		screenTopupChargeReceiptFa.setScreenno("388");
		screenTopupChargeReceiptFa.setDesc("خرید شارژ مستقیم-عدم چاپ رسید-فارسی");
		screenTopupChargeReceiptFa.setLanguage(UserLanguage.FARSI_LANG);
		screenTopupChargeReceiptFa.setScreenData("388[FF][SI]@@[ESC]P2129[ESC]\\");  
		screenTopupChargeReceiptOptionList.add(screenTopupChargeReceiptFa);
		getGeneralDao().saveOrUpdate(screenTopupChargeReceiptFa);	
		
		ResponseScreen screenTopupChargeReceiptEn = new ResponseScreen();
		screenTopupChargeReceiptEn.setScreenno("788");
		screenTopupChargeReceiptEn.setDesc("خرید شارژ مستقیم-عدم چاپ رسید-انگلیسی");
		screenTopupChargeReceiptEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenTopupChargeReceiptEn.setScreenData("788[FF][SI]@@[ESC]P2529[ESC]\\");  
		screenTopupChargeReceiptOptionList.add(screenTopupChargeReceiptEn);
		getGeneralDao().saveOrUpdate(screenTopupChargeReceiptEn);		
		...
		responseChargeShetab.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseChargeShetab.setNextState("596");
		responseChargeShetab.setScreen(screenTopupChargeList);
		responseChargeShetab.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseChargeShetab);
		
		FunctionCommandResponse responseChargeReceiptOptionShetab = new FunctionCommandResponse();
		responseChargeReceiptOptionShetab.setName("خرید شارژ-شتابی-عدم چاپ رسید");
		responseChargeReceiptOptionShetab.setBeRetain(false);
		responseChargeReceiptOptionShetab.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseChargeReceiptOptionShetab.setNextState("596");
		responseChargeReceiptOptionShetab.setScreen(screenTopupChargeReceiptOptionList);
		responseChargeReceiptOptionShetab.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseChargeReceiptOptionShetab);		
		...
		responseChargePasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseChargePasargad.setNextState("096");
		responseChargePasargad.setScreen(screenTopupChargeList);
		responseChargePasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseChargePasargad);
		
		FunctionCommandResponse responseChargeReceiptOptionPasargad = new FunctionCommandResponse();
		responseChargeReceiptOptionPasargad.setName("خرید شارژ-داخلی-عدم چاپ رسید");
		responseChargeReceiptOptionPasargad.setBeRetain(false);
		responseChargeReceiptOptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseChargeReceiptOptionPasargad.setNextState("096");
		responseChargeReceiptOptionPasargad.setScreen(screenTopupChargeReceiptOptionList);
		responseChargeReceiptOptionPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseChargeReceiptOptionPasargad);		
		...
		responseChargeCreditPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseChargeCreditPasargad.setNextState("196");
		responseChargeCreditPasargad.setScreen(screenTopupChargeList);
		responseChargeCreditPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseChargeCreditPasargad);
		
		FunctionCommandResponse responseChargeCreditReceiptOptionPasargad = new FunctionCommandResponse();
		responseChargeCreditReceiptOptionPasargad.setName("خرید شارژ-اعتباری داخلی-عدم چاپ");
		responseChargeCreditReceiptOptionPasargad.setBeRetain(false);
		responseChargeCreditReceiptOptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseChargeCreditReceiptOptionPasargad.setNextState("196");
		responseChargeCreditReceiptOptionPasargad.setScreen(screenTopupChargeReceiptOptionList);
		responseChargeCreditReceiptOptionPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseChargeCreditReceiptOptionPasargad);		
		...
		atmRequestShetabFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeShetab);
		atmRequestTimeOutShetabFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestShetabFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChargeReceiptOptionShetab);
		atmRequestReceiptOptionShetabFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeReceiptOptionShetab);
		
		atmRequestShetabEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeShetab);
		atmRequestTimeOutShetabEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestShetabEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChargeReceiptOptionShetab);
		atmRequestReceiptOptionShetabEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeReceiptOptionShetab);
		
		atmRequestPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargePasargad);
		atmRequestTimeOutPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestPasargadFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChargeReceiptOptionPasargad);
		atmRequestReceiptOptionPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeReceiptOptionPasargad);
		
		atmRequestPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
		atmRequestTimeOutPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestPasargadSubFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChargeReceiptOptionPasargad);  
		atmRequestReceiptOptionPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
		
		atmRequestPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargePasargad);
		atmRequestTimeOutPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestPasargadEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChargeReceiptOptionPasargad);
		atmRequestReceiptOptionPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeReceiptOptionPasargad);
		
		atmRequestPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
		atmRequestTimeOutPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestPasargadSubEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChargeReceiptOptionPasargad);
		atmRequestReceiptOptionPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);

		atmRequestCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeCreditPasargad);
		atmRequestTimeOutCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestCreditPasargadFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChargeCreditReceiptOptionPasargad);
		atmRequestReceiptOptionCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeCreditReceiptOptionPasargad);
		
		atmRequestCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeCreditPasargad);
		atmRequestTimeOutCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
		atmRequestCreditPasargadEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseChargeCreditReceiptOptionPasargad);
		atmRequestReceiptOptionCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseChargeCreditReceiptOptionPasargad);
	...
	//TASK Task081 : ATM Saham feature
	private List<ATMRequest> Stock(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
...
//		ATMRequest atmRequestReceiptOptionCreditPasargadEn = new ATMRequest(); 		
		...
		//AldTODO Task019 : Receipt Option use simple....()
		String textFa = "[GR simpleStockReceiptFa()]";
//				headerFa
////				+ newLine + newLine 
//				+ newLine  
//				+ "[GR center(GR c2F('رسید سهام')) ]"
//				+ newLine
//				+ lineFa
//				+ receivedDateFa 
////				+ newLine + newLine + newLine
...
//				;
		...
		String textEn = "[GR simpleStockReceiptEn()]"
//				headerEn
////				+ newLine + newLine 
//				+ newLine  
//				+(!atmType.equals(ATMType.NCR) ? "[GR center('Stock Receipt') ]" : "[GR center(GR c2NCRE('Stock Receipt')) ]")
//				+ newLine
//				+ lineEn
//				+ receivedDateEn 
////				+ newLine + newLine + newLine
...
//				+ footerEn
				;		
		//TODO AD: Journal Monaseb Eijad shavad
		String textJournal00 =  "[GR simpleStockJournal()]";
				//"[LF]Stock:[SO]1REF:[GR ifx.Src_TrnSeqCntr][SO]1PAN:[GR ifx.actualAppPAN][SO]1TIME:[GR ifx.receivedDt]";
		...
		atmRequestPasargadFa.setOpkey("ABCD    ");
		atmRequestPasargadFa.setIfxType(IfxType.STOCK_INQ_RQ);
		atmRequestPasargadFa.setTrnType(TrnType.STOCK);
		atmRequestPasargadFa.setCurrency(currency);
		atmRequestPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestPasargadFa.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadFa.setOpkey("ABCD   F");
		atmRequestTimeOutPasargadFa.setIfxType(IfxType.STOCK_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadFa.setTrnType(TrnType.STOCK);
		atmRequestTimeOutPasargadFa.setCurrency(currency);
		atmRequestTimeOutPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutPasargadFa.setFit(FITType.PASARGAD);

		//Task019
//		atmRequestReceiptOptionPasargadFa.setOpkey("ABCD   B");
//		atmRequestReceiptOptionPasargadFa.setIfxType(IfxType.STOCK_INQ_RQ);
//		atmRequestReceiptOptionPasargadFa.setTrnType(TrnType.STOCK);
//		atmRequestReceiptOptionPasargadFa.setCurrency(currency);
//		atmRequestReceiptOptionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestReceiptOptionPasargadFa.setFit(FITType.PASARGAD);
//		atmRequestReceiptOptionPasargadFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
...
/********************************/
		...
		atmRequestPasargadEn.setOpkey("IBCD    ");
		atmRequestPasargadEn.setIfxType(IfxType.STOCK_INQ_RQ);
		atmRequestPasargadEn.setTrnType(TrnType.STOCK);
		atmRequestPasargadEn.setCurrency(currency);
		atmRequestPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestPasargadEn.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutPasargadEn.setOpkey("IBCD   F");
		atmRequestTimeOutPasargadEn.setIfxType(IfxType.STOCK_REV_REPEAT_RQ);
		atmRequestTimeOutPasargadEn.setTrnType(TrnType.STOCK);
		atmRequestTimeOutPasargadEn.setCurrency(currency);
		atmRequestTimeOutPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
		atmRequestTimeOutPasargadEn.setFit(FITType.PASARGAD);
		
		//Task019
//		atmRequestReceiptOptionPasargadEn.setOpkey("IBCD   B");
//		atmRequestReceiptOptionPasargadEn.setIfxType(IfxType.STOCK_INQ_RQ);
//		atmRequestReceiptOptionPasargadEn.setTrnType(TrnType.STOCK);
//		atmRequestReceiptOptionPasargadEn.setCurrency(currency);
//		atmRequestReceiptOptionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestReceiptOptionPasargadEn.setFit(FITType.PASARGAD);		
//		atmRequestReceiptOptionPasargadEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);		
		...
		atmRequestCreditPasargadFa.setOpkey("ACCD    ");
		atmRequestCreditPasargadFa.setIfxType(IfxType.STOCK_INQ_RQ);
		atmRequestCreditPasargadFa.setTrnType(TrnType.STOCK);
		atmRequestCreditPasargadFa.setCurrency(currency);
		atmRequestCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestCreditPasargadFa.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutCreditPasargadFa.setOpkey("ACCD   F");
		atmRequestTimeOutCreditPasargadFa.setIfxType(IfxType.STOCK_REV_REPEAT_RQ);
		atmRequestTimeOutCreditPasargadFa.setTrnType(TrnType.STOCK);
		atmRequestTimeOutCreditPasargadFa.setCurrency(currency);
		atmRequestTimeOutCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutCreditPasargadFa.setFit(FITType.PASARGAD);

		//Task019
//		atmRequestReceiptOptionCreditPasargadFa.setOpkey("ACCD   B");
//		atmRequestReceiptOptionCreditPasargadFa.setIfxType(IfxType.STOCK_INQ_RQ);
//		atmRequestReceiptOptionCreditPasargadFa.setTrnType(TrnType.STOCK);
//		atmRequestReceiptOptionCreditPasargadFa.setCurrency(currency);
//		atmRequestReceiptOptionCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestReceiptOptionCreditPasargadFa.setFit(FITType.PASARGAD);
//		atmRequestReceiptOptionCreditPasargadFa.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		...
		atmRequestCreditPasargadEn.setOpkey("ICCD    ");
		atmRequestCreditPasargadEn.setIfxType(IfxType.STOCK_INQ_RQ);
		atmRequestCreditPasargadEn.setTrnType(TrnType.STOCK);
		atmRequestCreditPasargadEn.setCurrency(currency);
		atmRequestCreditPasargadEn.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestCreditPasargadEn.setFit(FITType.PASARGAD);
		
		atmRequestTimeOutCreditPasargadEn.setOpkey("ICCD   F");
		atmRequestTimeOutCreditPasargadEn.setIfxType(IfxType.STOCK_REV_REPEAT_RQ);
		atmRequestTimeOutCreditPasargadEn.setTrnType(TrnType.STOCK);
		atmRequestTimeOutCreditPasargadEn.setCurrency(currency);
		atmRequestTimeOutCreditPasargadEn.setLanguage(UserLanguage.FARSI_LANG);
		atmRequestTimeOutCreditPasargadEn.setFit(FITType.PASARGAD);

		//Task019
//		atmRequestReceiptOptionCreditPasargadEn.setOpkey("ICCD   B");
//		atmRequestReceiptOptionCreditPasargadEn.setIfxType(IfxType.STOCK_INQ_RQ);
//		atmRequestReceiptOptionCreditPasargadEn.setTrnType(TrnType.STOCK);
//		atmRequestReceiptOptionCreditPasargadEn.setCurrency(currency);
//		atmRequestReceiptOptionCreditPasargadEn.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestReceiptOptionCreditPasargadEn.setFit(FITType.PASARGAD);
//		atmRequestReceiptOptionCreditPasargadEn.setReceiptOption(ReceiptOptionType.WITHOUT_RECEIPT);
		
		/********************************/			
		
		List<ResponseScreen> screenStockList = new ArrayList<ResponseScreen>();
		
		ResponseScreen screenStockFa = new ResponseScreen();
		screenStockFa.setScreenno("388");
		screenStockFa.setDesc("اعلام سهام-موفق-فارسی");
		screenStockFa.setLanguage(UserLanguage.FARSI_LANG);
		screenStockFa.setScreenData("388[FF][SI]@@[ESC]P2112[ESC]\\");  //AldTODO Task081 : Ye Shomare As
		screenStockList.add(screenStockFa);
		getGeneralDao().saveOrUpdate(screenStockFa);
		
		ResponseScreen screenStockEn = new ResponseScreen();
		screenStockEn.setScreenno("788");
		screenStockEn.setDesc("اعلام سهام-موفق-انگلیسی");
		screenStockEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenStockEn.setScreenData("788[FF][SI]@@[ESC]P2512[ESC]\\");  //AldTODO Task081 : Ye Shomare As
		screenStockList.add(screenStockEn);
		getGeneralDao().saveOrUpdate(screenStockEn);
		
		List<ResponseScreen> screenRecieptList = new ArrayList<ResponseScreen>();
		
		ResponseScreen screenReceiptFa = new ResponseScreen();
		screenReceiptFa.setScreenno("388"); //387 -> 388  //Task019
		screenReceiptFa.setDesc("اعلام سهام-عدم چاپ رسید-فارسی");
		screenReceiptFa.setLanguage(UserLanguage.FARSI_LANG);
		
		
		//AldTODO Task081 : Havaset be NCR va OTHER bashe
		if (!atmType.equals(ATMType.NCR)) {		
			screenReceiptFa.setScreenData("388[FF][SI]@@[ESC]P2118[ESC]\\[ESC](K[ESC][OC]"+updateablePageFontColor+"[SI]GM[GR ifx.stockCode]"+"[SI]IM[GR ifx.stockCount]"); //Task019
		} else {
			screenReceiptFa.setScreenData("388[FF][SI]@@[ESC]P2118[ESC]\\[ESC](6[ESC][OC]"+updateablePageFontColor+"[SI]GM[GR ifx.stockCode]"+"[SI]IM[GR ifx.stockCount]"); //Task019
		}
		...
		ResponseScreen screenRecieptEn = new ResponseScreen();
		screenRecieptEn.setScreenno("788"); //787 -> 788 //Task019
		screenRecieptEn.setDesc("اعلام سهام-عدم چاپ رسید-انگلیسی"); //Task019
		screenRecieptEn.setLanguage(UserLanguage.ENGLISH_LANG);
		
		screenRecieptEn.setScreenData("788[FF][SI]@@[ESC]P2518[ESC]\\[ESC](1[ESC][OC]"+updateablePageFontColor+"[SI]GM[GR ifx.stockCode]"+"[SI]IM[GR ifx.stockCount]");//Task019
		...
		ResponseScreen screenTimeoutFa = new ResponseScreen();
		screenTimeoutFa.setScreenno("398");
		screenTimeoutFa.setDesc("اعلام سهام-Timeout-فارسی");
		screenTimeoutFa.setLanguage(UserLanguage.FARSI_LANG);
		screenTimeoutFa.setScreenData(null);
		screenTimeoutList.add(screenTimeoutFa);
		getGeneralDao().saveOrUpdate(screenTimeoutFa);
		...
		ResponseScreen screenTimeoutEn = new ResponseScreen();
		screenTimeoutEn.setScreenno("798");
		screenTimeoutEn.setDesc("اعلام سهام-Timeout-انگلیسی");
		screenTimeoutEn.setLanguage(UserLanguage.ENGLISH_LANG);
		screenTimeoutEn.setScreenData(null);
		screenTimeoutList.add(screenTimeoutEn);
		getGeneralDao().saveOrUpdate(screenTimeoutEn);
		...
		FunctionCommandResponse responseStockPasargad = new FunctionCommandResponse();
		responseStockPasargad.setName("اعلام سهام-داخلی-موفق");
		responseStockPasargad.setBeRetain(false);
		responseStockPasargad.setDispense(null);
		responseStockPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseStockPasargad.setNextState("096");
		responseStockPasargad.setScreen(screenStockList);
		responseStockPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseStockPasargad);

		FunctionCommandResponse responseReceiptOptionPasargad = new FunctionCommandResponse();
		responseReceiptOptionPasargad.setName("اعلام سهام-داخلی-عدم چاپ رسید"); //Task019
		responseReceiptOptionPasargad.setBeRetain(false);
		responseReceiptOptionPasargad.setDispense(null);
		responseReceiptOptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseReceiptOptionPasargad.setNextState("096"); //098 -> 096 //Task019
		...
		/********************************/
		FunctionCommandResponse responseStockCreditPasargad = new FunctionCommandResponse();
		responseStockCreditPasargad.setName("اعلام سهام-اعتباری داخلی-موفق");
		responseStockCreditPasargad.setBeRetain(false);
		responseStockCreditPasargad.setDispense(null);
		responseStockCreditPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseStockCreditPasargad.setNextState("196");
		responseStockCreditPasargad.setScreen(screenStockList);
		responseStockCreditPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseStockCreditPasargad);
		
		FunctionCommandResponse responseReceiptOptionCreditPasargad = new FunctionCommandResponse();  
		responseReceiptOptionCreditPasargad.setName("اعلام سهام-اعتباری داخلی-عدم چاپ رسید");
		responseReceiptOptionCreditPasargad.setBeRetain(false);
		responseReceiptOptionCreditPasargad.setDispense(null);
		responseReceiptOptionCreditPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseReceiptOptionCreditPasargad.setNextState("196"); 
		responseReceiptOptionCreditPasargad.setScreen(screenRecieptList);
		responseReceiptOptionCreditPasargad.setReceipt(receiptList);
		getGeneralDao().saveOrUpdate(responseReceiptOptionCreditPasargad);
		...
		FunctionCommandResponse responseTimeOut = new FunctionCommandResponse();
		responseTimeOut.setName("اعلام سهام-time out");
		responseTimeOut.setBeRetain(false);
		responseTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
		responseTimeOut.setNextState("713");
//		responseTimeOut.setNextScreen("398");
		...
		atmRequestPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseStockPasargad);
		atmRequestPasargadFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestTimeOutPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
//		atmRequestReceiptOptionPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionPasargad); //Task019
		
		
		atmRequestPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseStockPasargad);
		atmRequestPasargadEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestTimeOutPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
//		atmRequestReceiptOptionPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionPasargad); //Task019
		...
		//Credit
		atmRequestCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseStockCreditPasargad);
		atmRequestCreditPasargadFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestTimeOutCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
//		atmRequestReceiptOptionCreditPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionCreditPasargad); //Task019
		
		
		atmRequestCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseStockCreditPasargad);
		atmRequestCreditPasargadEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptOptionPasargad);
		atmRequestTimeOutCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseTimeOut);
//		atmRequestReceiptOptionCreditPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseReceiptOptionCreditPasargad); //Task019
...
//		requests.add(atmRequestReceiptOptionCreditPasargadEn);		
	...
	//TASK Task114 : Satna & Transfer
	private List<ATMRequest> SatnaTransfer(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
		
//		ATMRequest atmRequestSatnaPasargadFa = new ATMRequest();
//		ATMRequest atmRequestSatnaTimeOutPasargadFa = new ATMRequest();	
//		ATMRequest atmRequestSatnaReceiptExceptionPasargadFa = new ATMRequest(); 	
//		ATMRequest atmRequestSatnaPasargadSubFa = new ATMRequest();
//		ATMRequest atmRequestSatnaTimeOutPasargadSubFa = new ATMRequest();
//		ATMRequest atmRequestSatnaReceiptExceptionPasargadSubFa = new ATMRequest(); 	
//		
//	
//		ATMRequest atmRequestSatnaPasargadEn = new ATMRequest();
//		ATMRequest atmRequestSatnaTimeOutPasargadEn = new ATMRequest();
//		ATMRequest atmRequestSatnaReceiptExceptionPasargadEn = new ATMRequest(); 
//		ATMRequest atmRequestSatnaPasargadSubEn = new ATMRequest();
//		ATMRequest atmRequestSatnaTimeOutPasargadSubEn = new ATMRequest();
//		ATMRequest atmRequestSatnaReceiptExceptionPasargadSubEn = new ATMRequest(); 	
//		
//		String textFa = "[GR simpleSatnaTransferReceiptFa()]";
//		
//		String textEn = "[GR simpleSatnaTransferReceiptEn()]";
//		
//		String textJournal00 =  "[GR simpleSatnaTransferJournal()]";
//
//		ArrayList<Receipt> receiptList = new ArrayList<Receipt>();
//		
//		Receipt receiptFa = new Receipt();
...
//		/********************************/
//		
//		atmRequestSatnaPasargadFa.setOpkey("ABIFA   ");
//		atmRequestSatnaPasargadFa.setIfxType(IfxType.SATNA_RQ);
//		atmRequestSatnaPasargadFa.setTrnType(TrnType.SATNA);
//		atmRequestSatnaPasargadFa.setCurrency(currency);
//		atmRequestSatnaPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestSatnaPasargadFa.setFit(FITType.PASARGAD);
//		
//		atmRequestSatnaTimeOutPasargadFa.setOpkey("ABIFA  F");
//		atmRequestSatnaTimeOutPasargadFa.setIfxType(IfxType.SATNA_REV_REPEAT_RQ);
//		atmRequestSatnaTimeOutPasargadFa.setTrnType(TrnType.SATNA);
//		atmRequestSatnaTimeOutPasargadFa.setCurrency(currency);
//		atmRequestSatnaTimeOutPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestSatnaTimeOutPasargadFa.setFit(FITType.PASARGAD);
//
//		atmRequestSatnaReceiptExceptionPasargadFa.setOpkey("ABIFA  A");
//		atmRequestSatnaReceiptExceptionPasargadFa.setIfxType(IfxType.SATNA_RQ);
//		atmRequestSatnaReceiptExceptionPasargadFa.setTrnType(TrnType.SATNA);
//		atmRequestSatnaReceiptExceptionPasargadFa.setCurrency(currency);
//		atmRequestSatnaReceiptExceptionPasargadFa.setForceReceipt(false);
//		atmRequestSatnaReceiptExceptionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestSatnaReceiptExceptionPasargadFa.setFit(FITType.PASARGAD);
//		
///********************************/
//		
//		atmRequestSatnaPasargadEn.setOpkey("IBIFA   ");
//		atmRequestSatnaPasargadEn.setIfxType(IfxType.SATNA_RQ);
//		atmRequestSatnaPasargadEn.setTrnType(TrnType.SATNA);
//		atmRequestSatnaPasargadEn.setCurrency(currency);
//		atmRequestSatnaPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestSatnaPasargadEn.setFit(FITType.PASARGAD);
//		
//		atmRequestSatnaTimeOutPasargadEn.setOpkey("IBIFA  F");
//		atmRequestSatnaTimeOutPasargadEn.setIfxType(IfxType.SATNA_REV_REPEAT_RQ);
//		atmRequestSatnaTimeOutPasargadEn.setTrnType(TrnType.SATNA);
//		atmRequestSatnaTimeOutPasargadEn.setCurrency(currency);
//		atmRequestSatnaTimeOutPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestSatnaTimeOutPasargadEn.setFit(FITType.PASARGAD);
//		
//		atmRequestSatnaReceiptExceptionPasargadEn.setOpkey("IBIFA  A");
//		atmRequestSatnaReceiptExceptionPasargadEn.setIfxType(IfxType.SATNA_RQ);
//		atmRequestSatnaReceiptExceptionPasargadEn.setTrnType(TrnType.SATNA);
//		atmRequestSatnaReceiptExceptionPasargadEn.setCurrency(currency);
//		atmRequestSatnaReceiptExceptionPasargadEn.setForceReceipt(false);
//		atmRequestSatnaReceiptExceptionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestSatnaReceiptExceptionPasargadEn.setFit(FITType.PASARGAD);		
//			
//		/********************************/
//		
//		/************************/
//		atmRequestSatnaPasargadSubFa.setOpkey("ABIFB   ");
//		atmRequestSatnaPasargadSubFa.setNextOpkey("ABIFA   ");
//		atmRequestSatnaPasargadSubFa.setIfxType(IfxType.SATNA_RQ);
//		atmRequestSatnaPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
//		atmRequestSatnaPasargadSubFa.setTrnType(TrnType.SATNA);
//		atmRequestSatnaPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
//		atmRequestSatnaPasargadSubFa.setCurrency(currency);
//		atmRequestSatnaPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestSatnaPasargadSubFa.setFit(FITType.PASARGAD);
//		
//		atmRequestSatnaTimeOutPasargadSubFa.setOpkey("ABIFB  F");
//		atmRequestSatnaTimeOutPasargadSubFa.setNextOpkey("ABIFB  F");
//		atmRequestSatnaTimeOutPasargadSubFa.setIfxType(IfxType.SATNA_REV_REPEAT_RQ);
//		atmRequestSatnaTimeOutPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
//		atmRequestSatnaTimeOutPasargadSubFa.setTrnType(TrnType.SATNA);
//		atmRequestSatnaTimeOutPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
//		atmRequestSatnaTimeOutPasargadSubFa.setCurrency(currency);
//		atmRequestSatnaTimeOutPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestSatnaTimeOutPasargadSubFa.setFit(FITType.PASARGAD);
//		
//		atmRequestSatnaReceiptExceptionPasargadSubFa.setOpkey("ABIFB  A");
//		atmRequestSatnaReceiptExceptionPasargadSubFa.setNextOpkey("ABIFA  A");
//		atmRequestSatnaReceiptExceptionPasargadSubFa.setIfxType(IfxType.SATNA_RQ);
//		atmRequestSatnaReceiptExceptionPasargadSubFa.setTrnType(TrnType.SATNA);
//		atmRequestSatnaReceiptExceptionPasargadSubFa.setCurrency(currency);
//		atmRequestSatnaReceiptExceptionPasargadSubFa.setForceReceipt(false);
//		atmRequestSatnaReceiptExceptionPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestSatnaReceiptExceptionPasargadSubFa.setFit(FITType.PASARGAD);
//		
//		/************************/
//		
//		atmRequestSatnaPasargadSubEn.setOpkey("IBIFB   ");
//		atmRequestSatnaPasargadSubEn.setNextOpkey("IBIFA   ");
//		atmRequestSatnaPasargadSubEn.setIfxType(IfxType.SATNA_RQ);
//		atmRequestSatnaPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
//		atmRequestSatnaPasargadSubEn.setTrnType(TrnType.SATNA);
//		atmRequestSatnaPasargadSubEn.setSecondaryTrnType(TrnType.GETACCOUNT);
//		atmRequestSatnaPasargadSubEn.setCurrency(currency);
//		atmRequestSatnaPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestSatnaPasargadSubEn.setFit(FITType.PASARGAD);
//		
//		atmRequestSatnaTimeOutPasargadSubEn.setOpkey("IBIFB  F");
//		atmRequestSatnaTimeOutPasargadSubEn.setNextOpkey("IBIFB  F");
//		atmRequestSatnaTimeOutPasargadSubEn.setIfxType(IfxType.SATNA_REV_REPEAT_RQ);
//		atmRequestSatnaTimeOutPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
//		atmRequestSatnaTimeOutPasargadSubEn.setTrnType(TrnType.SATNA);
//		atmRequestSatnaTimeOutPasargadSubEn.setSecondaryTrnType(TrnType.GETACCOUNT);
//		atmRequestSatnaTimeOutPasargadSubEn.setCurrency(currency);
//		atmRequestSatnaTimeOutPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestSatnaTimeOutPasargadSubEn.setFit(FITType.PASARGAD);
//		
//		atmRequestSatnaReceiptExceptionPasargadSubEn.setOpkey("IBIFB  A");
//		atmRequestSatnaReceiptExceptionPasargadSubEn.setNextOpkey("IBIFA  A");
//		atmRequestSatnaReceiptExceptionPasargadSubEn.setIfxType(IfxType.SATNA_RQ);
//		atmRequestSatnaReceiptExceptionPasargadSubEn.setTrnType(TrnType.SATNA);
//		atmRequestSatnaReceiptExceptionPasargadSubEn.setCurrency(currency);
//		atmRequestSatnaReceiptExceptionPasargadSubEn.setForceReceipt(false);
//		atmRequestSatnaReceiptExceptionPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestSatnaReceiptExceptionPasargadSubEn.setFit(FITType.PASARGAD);
//		
//		/************************/		
//		
//		
//		List<ResponseScreen> screenSatnaList = new ArrayList<ResponseScreen>();
//		
//		ResponseScreen screenSatnaFa = new ResponseScreen();
//		screenSatnaFa.setScreenno("388");
//		screenSatnaFa.setDesc("انتقال ساتنا-موفق-فارسی");
//		screenSatnaFa.setLanguage(UserLanguage.FARSI_LANG);
//		screenSatnaFa.setScreenData("388[FF][SI]@@[ESC]P2112[ESC]\\");  //AldTODO Task114 : Ye Shomare As
//		screenSatnaList.add(screenSatnaFa);
//		getGeneralDao().saveOrUpdate(screenSatnaFa);
//		
//		ResponseScreen screenSatnaEn = new ResponseScreen();
//		screenSatnaEn.setScreenno("788");
//		screenSatnaEn.setDesc("انتقال ساتنا-موفق-انگلیسی");
//		screenSatnaEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		screenSatnaEn.setScreenData("788[FF][SI]@@[ESC]P2512[ESC]\\");  //AldTODO Task114 : Ye Shomare As
//		screenSatnaList.add(screenSatnaEn);
//		getGeneralDao().saveOrUpdate(screenSatnaEn);
//		
//		List<ResponseScreen> screenRecieptList = new ArrayList<ResponseScreen>();
//		
//		ResponseScreen screenRecieptFa = new ResponseScreen();
//		screenRecieptFa.setScreenno("384");
//		screenRecieptFa.setDesc("انتقال ساتنا-داخلی-خطای رسید-فارسی");
//		screenRecieptFa.setLanguage(UserLanguage.FARSI_LANG);
//		screenRecieptFa.setScreenData(null);
//		screenRecieptList.add(screenRecieptFa);
//		getGeneralDao().saveOrUpdate(screenRecieptFa);
...
//		ResponseScreen screenRecieptEn = new ResponseScreen();
//		screenRecieptEn.setScreenno("784");
//		screenRecieptEn.setDesc("انتقال ساتنا-داخلی-خطای رسید-انگلیسی");
//		screenRecieptEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		screenRecieptEn.setScreenData(null);
//		screenRecieptList.add(screenRecieptEn);
//		getGeneralDao().saveOrUpdate(screenRecieptEn);
...
//		ResponseScreen screenTimeoutFa = new ResponseScreen();
//		screenTimeoutFa.setScreenno("398");
//		screenTimeoutFa.setDesc("انتقال ساتنا-Timeout-فارسی");
//		screenTimeoutFa.setLanguage(UserLanguage.FARSI_LANG);
//		screenTimeoutFa.setScreenData(null);
//		screenTimeoutList.add(screenTimeoutFa);
//		getGeneralDao().saveOrUpdate(screenTimeoutFa);
...
//		ResponseScreen screenTimeoutEn = new ResponseScreen();
//		screenTimeoutEn.setScreenno("798");
//		screenTimeoutEn.setDesc("انتقال ساتنا-Timeout-انگلیسی");
//		screenTimeoutEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		screenTimeoutEn.setScreenData(null);
//		screenTimeoutList.add(screenTimeoutEn);
//		getGeneralDao().saveOrUpdate(screenTimeoutEn);
...
//		/********************************/
//		
//		FunctionCommandResponse responseSatnaPasargad = new FunctionCommandResponse();
//		responseSatnaPasargad.setName("انتقال ساتنا-داخلی-موفق");
//		responseSatnaPasargad.setBeRetain(false);
//		responseSatnaPasargad.setDispense(null);
//		responseSatnaPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseSatnaPasargad.setNextState("096");
//		responseSatnaPasargad.setScreen(screenSatnaList);
//		responseSatnaPasargad.setReceipt(receiptList);
//		getGeneralDao().saveOrUpdate(responseSatnaPasargad);
//		
//		FunctionCommandResponse responseSatnaReceiptExceptionPasargad = new FunctionCommandResponse();
//		responseSatnaReceiptExceptionPasargad.setName("انتقال ساتنا-داخلی-خطای رسید"); 
//		responseSatnaReceiptExceptionPasargad.setBeRetain(false);
//		responseSatnaReceiptExceptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseSatnaReceiptExceptionPasargad.setNextState("092"); 
//		responseSatnaReceiptExceptionPasargad.setScreen(screenRecieptList);
//		responseSatnaReceiptExceptionPasargad.setReceipt(null);
//		getGeneralDao().saveOrUpdate(responseSatnaReceiptExceptionPasargad);
//		
//		
//		/********************************/
//		FunctionCommandResponse responseSatnaTimeOut = new FunctionCommandResponse();
//		responseSatnaTimeOut.setName("انتقال ساتنا-time out");
//		responseSatnaTimeOut.setBeRetain(false);
//		responseSatnaTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseSatnaTimeOut.setNextState("713");
//		responseSatnaTimeOut.setScreen(screenTimeoutList);
//		responseSatnaTimeOut.setReceipt(null);
//		getGeneralDao().saveOrUpdate(responseSatnaTimeOut);
//		/********************************/
//		
//		
//		atmRequestSatnaPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseSatnaPasargad);
//		atmRequestSatnaPasargadFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseSatnaReceiptExceptionPasargad);
//		atmRequestSatnaTimeOutPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseSatnaTimeOut);
//		atmRequestSatnaReceiptExceptionPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseSatnaPasargad);
//		
//		atmRequestSatnaPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
//		atmRequestSatnaTimeOutPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseSatnaTimeOut);
//		atmRequestSatnaPasargadSubFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseSatnaReceiptExceptionPasargad);
//		atmRequestSatnaReceiptExceptionPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseSatnaPasargad);
//		
//		atmRequestSatnaPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseSatnaPasargad);
//		atmRequestSatnaPasargadEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseSatnaReceiptExceptionPasargad);
//		atmRequestSatnaTimeOutPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseSatnaTimeOut);
//		atmRequestSatnaReceiptExceptionPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseSatnaPasargad);
//		
//		atmRequestSatnaPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
//		atmRequestSatnaTimeOutPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseSatnaTimeOut);
//		atmRequestSatnaPasargadSubEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseSatnaReceiptExceptionPasargad);
//		atmRequestSatnaReceiptExceptionPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responseSatnaPasargad);
//		
//		/********************************/
//		
//		getGeneralDao().saveOrUpdate(atmRequestSatnaPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestSatnaPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestSatnaPasargadSubFa);
//		getGeneralDao().saveOrUpdate(atmRequestSatnaPasargadSubEn);
//		
//		getGeneralDao().saveOrUpdate(atmRequestSatnaTimeOutPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestSatnaTimeOutPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestSatnaTimeOutPasargadSubFa);
//		getGeneralDao().saveOrUpdate(atmRequestSatnaTimeOutPasargadSubEn);
//
//		getGeneralDao().saveOrUpdate(atmRequestSatnaReceiptExceptionPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestSatnaReceiptExceptionPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestSatnaReceiptExceptionPasargadSubFa);
//		getGeneralDao().saveOrUpdate(atmRequestSatnaReceiptExceptionPasargadSubEn);
//		
//		requests.add(atmRequestSatnaPasargadFa);
//		requests.add(atmRequestSatnaPasargadEn);
//		requests.add(atmRequestSatnaPasargadSubFa);
//		requests.add(atmRequestSatnaPasargadSubEn);
//		
//		requests.add(atmRequestSatnaTimeOutPasargadFa);
//		requests.add(atmRequestSatnaTimeOutPasargadEn);
//		requests.add(atmRequestSatnaTimeOutPasargadSubFa);
//		requests.add(atmRequestSatnaTimeOutPasargadSubEn);
//		
//		requests.add(atmRequestSatnaReceiptExceptionPasargadFa);
//		requests.add(atmRequestSatnaReceiptExceptionPasargadEn);
//		requests.add(atmRequestSatnaReceiptExceptionPasargadSubFa);
//		requests.add(atmRequestSatnaReceiptExceptionPasargadSubEn);
	...
	//TASK Task114 : Satna & Transfer
	private List<ATMRequest> PayaTransfer(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
		
//		ATMRequest atmRequestPayaPasargadFa = new ATMRequest();
//		ATMRequest atmRequestPayaTimeOutPasargadFa = new ATMRequest();	
//		ATMRequest atmRequestPayaReceiptExceptionPasargadFa = new ATMRequest(); 	
//		ATMRequest atmRequestPayaPasargadSubFa = new ATMRequest();
//		ATMRequest atmRequestPayaTimeOutPasargadSubFa = new ATMRequest();
//		ATMRequest atmRequestPayaReceiptExceptionPasargadSubFa = new ATMRequest(); 	
//		
//	
//		ATMRequest atmRequestPayaPasargadEn = new ATMRequest();
//		ATMRequest atmRequestPayaTimeOutPasargadEn = new ATMRequest();
//		ATMRequest atmRequestPayaReceiptExceptionPasargadEn = new ATMRequest(); 
//		ATMRequest atmRequestPayaPasargadSubEn = new ATMRequest();
//		ATMRequest atmRequestPayaTimeOutPasargadSubEn = new ATMRequest();
//		ATMRequest atmRequestPayaReceiptExceptionPasargadSubEn = new ATMRequest(); 	
//		
//		String textFa = "[GR simplePayaTransferReceiptFa()]";
//		
//		String textEn = "[GR simplePayaTransferReceiptEn()]";
//		
//		String textJournal00 =  "[GR simplePayaTransferJournal()]";
//
//		ArrayList<Receipt> receiptList = new ArrayList<Receipt>();
//		
//		Receipt receiptFa = new Receipt();
...
//		/********************************/
//		
//		atmRequestPayaPasargadFa.setOpkey("ABIGA   ");
//		atmRequestPayaPasargadFa.setIfxType(IfxType.PAYA_RQ);
//		atmRequestPayaPasargadFa.setTrnType(TrnType.PAYA);
//		atmRequestPayaPasargadFa.setCurrency(currency);
//		atmRequestPayaPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestPayaPasargadFa.setFit(FITType.PASARGAD);
//		
//		atmRequestPayaTimeOutPasargadFa.setOpkey("ABIGA  F");
//		atmRequestPayaTimeOutPasargadFa.setIfxType(IfxType.PAYA_REV_REPEAT_RQ);
//		atmRequestPayaTimeOutPasargadFa.setTrnType(TrnType.PAYA);
//		atmRequestPayaTimeOutPasargadFa.setCurrency(currency);
//		atmRequestPayaTimeOutPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestPayaTimeOutPasargadFa.setFit(FITType.PASARGAD);
//
//		atmRequestPayaReceiptExceptionPasargadFa.setOpkey("ABIGA  A");
//		atmRequestPayaReceiptExceptionPasargadFa.setIfxType(IfxType.PAYA_RQ);
//		atmRequestPayaReceiptExceptionPasargadFa.setTrnType(TrnType.PAYA);
//		atmRequestPayaReceiptExceptionPasargadFa.setCurrency(currency);
//		atmRequestPayaReceiptExceptionPasargadFa.setForceReceipt(false);
//		atmRequestPayaReceiptExceptionPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestPayaReceiptExceptionPasargadFa.setFit(FITType.PASARGAD);
//		
///********************************/
//		
//		atmRequestPayaPasargadEn.setOpkey("IBIGA   ");
//		atmRequestPayaPasargadEn.setIfxType(IfxType.PAYA_RQ);
//		atmRequestPayaPasargadEn.setTrnType(TrnType.PAYA);
//		atmRequestPayaPasargadEn.setCurrency(currency);
//		atmRequestPayaPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPayaPasargadEn.setFit(FITType.PASARGAD);
//		
//		atmRequestPayaTimeOutPasargadEn.setOpkey("IBIGA  F");
//		atmRequestPayaTimeOutPasargadEn.setIfxType(IfxType.PAYA_REV_REPEAT_RQ);
//		atmRequestPayaTimeOutPasargadEn.setTrnType(TrnType.PAYA);
//		atmRequestPayaTimeOutPasargadEn.setCurrency(currency);
//		atmRequestPayaTimeOutPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPayaTimeOutPasargadEn.setFit(FITType.PASARGAD);
//		
//		atmRequestPayaReceiptExceptionPasargadEn.setOpkey("IBIGA  A");
//		atmRequestPayaReceiptExceptionPasargadEn.setIfxType(IfxType.PAYA_RQ);
//		atmRequestPayaReceiptExceptionPasargadEn.setTrnType(TrnType.PAYA);
//		atmRequestPayaReceiptExceptionPasargadEn.setCurrency(currency);
//		atmRequestPayaReceiptExceptionPasargadEn.setForceReceipt(false);
//		atmRequestPayaReceiptExceptionPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPayaReceiptExceptionPasargadEn.setFit(FITType.PASARGAD);		
//			
//		/********************************/
//		
//		/************************/
//		atmRequestPayaPasargadSubFa.setOpkey("ABIGB   ");
//		atmRequestPayaPasargadSubFa.setNextOpkey("ABIGA   ");
//		atmRequestPayaPasargadSubFa.setIfxType(IfxType.PAYA_RQ);
//		atmRequestPayaPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
//		atmRequestPayaPasargadSubFa.setTrnType(TrnType.PAYA);
//		atmRequestPayaPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
//		atmRequestPayaPasargadSubFa.setCurrency(currency);
//		atmRequestPayaPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestPayaPasargadSubFa.setFit(FITType.PASARGAD);
//		
//		atmRequestPayaTimeOutPasargadSubFa.setOpkey("ABIGB  F");
//		atmRequestPayaTimeOutPasargadSubFa.setNextOpkey("ABIGB  F");
//		atmRequestPayaTimeOutPasargadSubFa.setIfxType(IfxType.PAYA_REV_REPEAT_RQ);
//		atmRequestPayaTimeOutPasargadSubFa.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
//		atmRequestPayaTimeOutPasargadSubFa.setTrnType(TrnType.PAYA);
//		atmRequestPayaTimeOutPasargadSubFa.setSecondaryTrnType(TrnType.GETACCOUNT);
//		atmRequestPayaTimeOutPasargadSubFa.setCurrency(currency);
//		atmRequestPayaTimeOutPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestPayaTimeOutPasargadSubFa.setFit(FITType.PASARGAD);
//		
//		atmRequestPayaReceiptExceptionPasargadSubFa.setOpkey("ABIGB  A");
//		atmRequestPayaReceiptExceptionPasargadSubFa.setNextOpkey("ABIGA  A");
//		atmRequestPayaReceiptExceptionPasargadSubFa.setIfxType(IfxType.PAYA_RQ);
//		atmRequestPayaReceiptExceptionPasargadSubFa.setTrnType(TrnType.PAYA);
//		atmRequestPayaReceiptExceptionPasargadSubFa.setCurrency(currency);
//		atmRequestPayaReceiptExceptionPasargadSubFa.setForceReceipt(false);
//		atmRequestPayaReceiptExceptionPasargadSubFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestPayaReceiptExceptionPasargadSubFa.setFit(FITType.PASARGAD);
//		
//		/************************/
//		
//		atmRequestPayaPasargadSubEn.setOpkey("IBIGB   ");
//		atmRequestPayaPasargadSubEn.setNextOpkey("IBIGA   ");
//		atmRequestPayaPasargadSubEn.setIfxType(IfxType.PAYA_RQ);
//		atmRequestPayaPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_RQ);
//		atmRequestPayaPasargadSubEn.setTrnType(TrnType.PAYA);
//		atmRequestPayaPasargadSubEn.setSecondaryTrnType(TrnType.GETACCOUNT);
//		atmRequestPayaPasargadSubEn.setCurrency(currency);
//		atmRequestPayaPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPayaPasargadSubEn.setFit(FITType.PASARGAD);
//		
//		atmRequestPayaTimeOutPasargadSubEn.setOpkey("IBIGB  F");
//		atmRequestPayaTimeOutPasargadSubEn.setNextOpkey("IBIGB  F");
//		atmRequestPayaTimeOutPasargadSubEn.setIfxType(IfxType.PAYA_REV_REPEAT_RQ);
//		atmRequestPayaTimeOutPasargadSubEn.setSecondaryIfxType(IfxType.GET_ACCOUNT_REV_REPEAT_RQ);
//		atmRequestPayaTimeOutPasargadSubEn.setTrnType(TrnType.PAYA);
//		atmRequestPayaTimeOutPasargadSubEn.setSecondaryTrnType(TrnType.GETACCOUNT);
//		atmRequestPayaTimeOutPasargadSubEn.setCurrency(currency);
//		atmRequestPayaTimeOutPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPayaTimeOutPasargadSubEn.setFit(FITType.PASARGAD);
//		
//		atmRequestPayaReceiptExceptionPasargadSubEn.setOpkey("IBIGB  A");
//		atmRequestPayaReceiptExceptionPasargadSubEn.setNextOpkey("IBIGA  A");
//		atmRequestPayaReceiptExceptionPasargadSubEn.setIfxType(IfxType.PAYA_RQ);
//		atmRequestPayaReceiptExceptionPasargadSubEn.setTrnType(TrnType.PAYA);
//		atmRequestPayaReceiptExceptionPasargadSubEn.setCurrency(currency);
//		atmRequestPayaReceiptExceptionPasargadSubEn.setForceReceipt(false);
//		atmRequestPayaReceiptExceptionPasargadSubEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestPayaReceiptExceptionPasargadSubEn.setFit(FITType.PASARGAD);
//		
//		/************************/		
//		
//		
//		List<ResponseScreen> screenPayaList = new ArrayList<ResponseScreen>();
//		
//		ResponseScreen screenPayaFa = new ResponseScreen();
//		screenPayaFa.setScreenno("388");
//		screenPayaFa.setDesc("انتقال پایا-موفق-فارسی");
//		screenPayaFa.setLanguage(UserLanguage.FARSI_LANG);
//		screenPayaFa.setScreenData("388[FF][SI]@@[ESC]P2112[ESC]\\");  //AldTODO Task114 : Ye Shomare As
//		screenPayaList.add(screenPayaFa);
//		getGeneralDao().saveOrUpdate(screenPayaFa);
//		
//		ResponseScreen screenPayaEn = new ResponseScreen();
//		screenPayaEn.setScreenno("788");
//		screenPayaEn.setDesc("انتقال پایا-موفق-انگلیسی");
//		screenPayaEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		screenPayaEn.setScreenData("788[FF][SI]@@[ESC]P2512[ESC]\\");  //AldTODO Task114 : Ye Shomare As
//		screenPayaList.add(screenPayaEn);
//		getGeneralDao().saveOrUpdate(screenPayaEn);
//		
//		List<ResponseScreen> screenRecieptList = new ArrayList<ResponseScreen>();
//		
//		ResponseScreen screenRecieptFa = new ResponseScreen();
//		screenRecieptFa.setScreenno("384");
//		screenRecieptFa.setDesc("انتقال پایا-داخلی-خطای رسید-فارسی");
//		screenRecieptFa.setLanguage(UserLanguage.FARSI_LANG);
//		screenRecieptFa.setScreenData(null);
//		screenRecieptList.add(screenRecieptFa);
//		getGeneralDao().saveOrUpdate(screenRecieptFa);
...
//		ResponseScreen screenRecieptEn = new ResponseScreen();
//		screenRecieptEn.setScreenno("784");
//		screenRecieptEn.setDesc("انتقال پایا-داخلی-خطای رسید-انگلیسی");
//		screenRecieptEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		screenRecieptEn.setScreenData(null);
//		screenRecieptList.add(screenRecieptEn);
//		getGeneralDao().saveOrUpdate(screenRecieptEn);
...
//		ResponseScreen screenTimeoutFa = new ResponseScreen();
//		screenTimeoutFa.setScreenno("398");
//		screenTimeoutFa.setDesc("انتقال پایا-Timeout-فارسی");
//		screenTimeoutFa.setLanguage(UserLanguage.FARSI_LANG);
//		screenTimeoutFa.setScreenData(null);
//		screenTimeoutList.add(screenTimeoutFa);
//		getGeneralDao().saveOrUpdate(screenTimeoutFa);
...
//		ResponseScreen screenTimeoutEn = new ResponseScreen();
//		screenTimeoutEn.setScreenno("798");
//		screenTimeoutEn.setDesc("انتقال پایا-Timeout-انگلیسی");
//		screenTimeoutEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		screenTimeoutEn.setScreenData(null);
//		screenTimeoutList.add(screenTimeoutEn);
//		getGeneralDao().saveOrUpdate(screenTimeoutEn);
...
//		/********************************/
//		
//		FunctionCommandResponse responsePayaPasargad = new FunctionCommandResponse();
//		responsePayaPasargad.setName("انتقال پایا-داخلی-موفق");
//		responsePayaPasargad.setBeRetain(false);
//		responsePayaPasargad.setDispense(null);
//		responsePayaPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responsePayaPasargad.setNextState("096");
//		responsePayaPasargad.setScreen(screenPayaList);
//		responsePayaPasargad.setReceipt(receiptList);
//		getGeneralDao().saveOrUpdate(responsePayaPasargad);
//		
//		FunctionCommandResponse responseReceiptExceptionPasargad = new FunctionCommandResponse();
//		responseReceiptExceptionPasargad.setName("انتقال پایا-داخلی-خطای رسید"); 
//		responseReceiptExceptionPasargad.setBeRetain(false);
//		responseReceiptExceptionPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseReceiptExceptionPasargad.setNextState("092"); 
//		responseReceiptExceptionPasargad.setScreen(screenRecieptList);
...
//		/********************************/
//		FunctionCommandResponse responseSatnaTimeOut = new FunctionCommandResponse();
//		responseSatnaTimeOut.setName("انتقال پایا-time out");
//		responseSatnaTimeOut.setBeRetain(false);
//		responseSatnaTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseSatnaTimeOut.setNextState("713");
//		responseSatnaTimeOut.setScreen(screenTimeoutList);
...
//		
//		
//		atmRequestPayaPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responsePayaPasargad);
//		atmRequestPayaPasargadFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptExceptionPasargad);
//		atmRequestPayaTimeOutPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseSatnaTimeOut);
//		atmRequestPayaReceiptExceptionPasargadFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responsePayaPasargad);
//		
//		atmRequestPayaPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
//		atmRequestPayaTimeOutPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseSatnaTimeOut);
//		atmRequestPayaPasargadSubFa.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptExceptionPasargad);
//		atmRequestPayaReceiptExceptionPasargadSubFa.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responsePayaPasargad);
//		
//		atmRequestPayaPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responsePayaPasargad);
//		atmRequestPayaPasargadEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptExceptionPasargad);
//		atmRequestPayaTimeOutPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseSatnaTimeOut);
//		atmRequestPayaReceiptExceptionPasargadEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responsePayaPasargad);
//		
//		atmRequestPayaPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), oarResponse);
//		atmRequestPayaTimeOutPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.CARD_EXPIRED), responseSatnaTimeOut);
//		atmRequestPayaPasargadSubEn.addAtmResponse(ATMErrorCodes.ATM_NOT_PAPER_RECEIPT, responseReceiptExceptionPasargad);
//		atmRequestPayaReceiptExceptionPasargadSubEn.addAtmResponse(Integer.parseInt(ISOResponseCodes.APPROVED), responsePayaPasargad);
//		
//		/********************************/
//		
//		getGeneralDao().saveOrUpdate(atmRequestPayaPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestPayaPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestPayaPasargadSubFa);
//		getGeneralDao().saveOrUpdate(atmRequestPayaPasargadSubEn);
//		
//		getGeneralDao().saveOrUpdate(atmRequestPayaTimeOutPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestPayaTimeOutPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestPayaTimeOutPasargadSubFa);
//		getGeneralDao().saveOrUpdate(atmRequestPayaTimeOutPasargadSubEn);
//
//		getGeneralDao().saveOrUpdate(atmRequestPayaReceiptExceptionPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestPayaReceiptExceptionPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestPayaReceiptExceptionPasargadSubFa);
//		getGeneralDao().saveOrUpdate(atmRequestPayaReceiptExceptionPasargadSubEn);
//		
//		requests.add(atmRequestPayaPasargadFa);
//		requests.add(atmRequestPayaPasargadEn);
//		requests.add(atmRequestPayaPasargadSubFa);
//		requests.add(atmRequestPayaPasargadSubEn);
//		
//		requests.add(atmRequestPayaTimeOutPasargadFa);
//		requests.add(atmRequestPayaTimeOutPasargadEn);
//		requests.add(atmRequestPayaTimeOutPasargadSubFa);
//		requests.add(atmRequestPayaTimeOutPasargadSubEn);
//		
//		requests.add(atmRequestPayaReceiptExceptionPasargadFa);
//		requests.add(atmRequestPayaReceiptExceptionPasargadEn);
//		requests.add(atmRequestPayaReceiptExceptionPasargadSubFa);
//		requests.add(atmRequestPayaReceiptExceptionPasargadSubEn);
		
		return requests;
	}
	
	// TASK Task117 (3404) : Charge Statement
	private List<ATMRequest> ChargeStatement(ATMConfiguration configuration, OARResponse oarResponse) throws Exception {
		List<ATMRequest> requests = new ArrayList<ATMRequest>();
		
//		ATMRequest atmRequestChargeStatementShetabFa = new ATMRequest();
//		ATMRequest atmRequestChargeStatementShetabEn = new ATMRequest();
//		ATMRequest atmRequestChargeStatementPasargadFa = new ATMRequest();
//		ATMRequest atmRequestChargeStatementPasargadEn = new ATMRequest();
//		ATMRequest atmRequestChargeStatementCreditPasargadFa = new ATMRequest();
//		ATMRequest atmRequestChargeStatementCreditPasargadEn = new ATMRequest();
//
//		ATMRequest atmRequestTimeOutChargeStatementShetabFa = new ATMRequest();
//		ATMRequest atmRequestTimeOutChargeStatementShetabEn = new ATMRequest();
//		ATMRequest atmRequestTimeOutChargeStatementPasargadFa = new ATMRequest();
//		ATMRequest atmRequestTimeOutChargeStatementPasargadEn = new ATMRequest();
//		ATMRequest atmRequestTimeOutChargeStatementCreditPasargadFa = new ATMRequest();
//		ATMRequest atmRequestTimeOutChargeStatementCreditPasargadEn = new ATMRequest();
//		
//		String textFa = "[GR simpleChargeStatementReceiptFa()]";
//		
//		String textEn = "[GR simpleChargeStatementReceiptEn()]";
//		
//		String textJournal00 = "[GR simpleChargeStatementJournal()]" ;
//
//		
//		ArrayList<Receipt> receiptList = new ArrayList<Receipt>();
//		
...
//
//		/*****************************/
//		atmRequestChargeStatementShetabFa.setOpkey("AAFC    ");
//		atmRequestChargeStatementShetabFa.setIfxType(IfxType.CHARGE_STATEMENT);
//		atmRequestChargeStatementShetabFa.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestChargeStatementShetabFa.setCurrency(currency);
//		atmRequestChargeStatementShetabFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestChargeStatementShetabFa.setFit(FITType.SHETAB);
//
//		atmRequestTimeOutChargeStatementShetabFa.setOpkey("AAFC   F");
//		atmRequestTimeOutChargeStatementShetabFa.setIfxType(IfxType.CHARGE_STATEMENT_REV_REPEAT);
//		atmRequestTimeOutChargeStatementShetabFa.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestTimeOutChargeStatementShetabFa.setCurrency(currency);
//		atmRequestTimeOutChargeStatementShetabFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestTimeOutChargeStatementShetabFa.setFit(FITType.SHETAB);
//		
//		atmRequestChargeStatementShetabEn.setOpkey("IAFC    ");
//		atmRequestChargeStatementShetabEn.setIfxType(IfxType.CHARGE_STATEMENT);
//		atmRequestChargeStatementShetabEn.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestChargeStatementShetabEn.setCurrency(currency);
//		atmRequestChargeStatementShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestChargeStatementShetabEn.setFit(FITType.SHETAB);
//		
//		atmRequestTimeOutChargeStatementShetabEn.setOpkey("IAFC   F");
//		atmRequestTimeOutChargeStatementShetabEn.setIfxType(IfxType.CHARGE_STATEMENT_REV_REPEAT);
//		atmRequestTimeOutChargeStatementShetabEn.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestTimeOutChargeStatementShetabEn.setCurrency(currency);
//		atmRequestTimeOutChargeStatementShetabEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestTimeOutChargeStatementShetabEn.setFit(FITType.SHETAB);
//		
//		atmRequestChargeStatementPasargadFa.setOpkey("ABFC    ");
//		atmRequestChargeStatementPasargadFa.setIfxType(IfxType.CHARGE_STATEMENT);
//		atmRequestChargeStatementPasargadFa.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestChargeStatementPasargadFa.setCurrency(currency);
//		atmRequestChargeStatementPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestChargeStatementPasargadFa.setFit(FITType.PASARGAD);
//		
//		atmRequestTimeOutChargeStatementPasargadFa.setOpkey("ABFC   F");
//		atmRequestTimeOutChargeStatementPasargadFa.setIfxType(IfxType.CHARGE_STATEMENT_REV_REPEAT);
//		atmRequestTimeOutChargeStatementPasargadFa.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestTimeOutChargeStatementPasargadFa.setCurrency(currency);
//		atmRequestTimeOutChargeStatementPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestTimeOutChargeStatementPasargadFa.setFit(FITType.PASARGAD);
//		
//		atmRequestChargeStatementPasargadEn.setOpkey("IBFC    ");
//		atmRequestChargeStatementPasargadEn.setIfxType(IfxType.CHARGE_STATEMENT);
//		atmRequestChargeStatementPasargadEn.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestChargeStatementPasargadEn.setCurrency(currency);
//		atmRequestChargeStatementPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestChargeStatementPasargadEn.setFit(FITType.PASARGAD);
//		
//		atmRequestTimeOutChargeStatementPasargadEn.setOpkey("IBFC   F");
//		atmRequestTimeOutChargeStatementPasargadEn.setIfxType(IfxType.CHARGE_STATEMENT_REV_REPEAT);
//		atmRequestTimeOutChargeStatementPasargadEn.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestTimeOutChargeStatementPasargadEn.setCurrency(currency);
//		atmRequestTimeOutChargeStatementPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestTimeOutChargeStatementPasargadEn.setFit(FITType.PASARGAD);
//		
//		atmRequestChargeStatementCreditPasargadFa.setOpkey("ACFC    ");
//		atmRequestChargeStatementCreditPasargadFa.setIfxType(IfxType.CHARGE_STATEMENT);
//		atmRequestChargeStatementCreditPasargadFa.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestChargeStatementCreditPasargadFa.setCurrency(currency);
//		atmRequestChargeStatementCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestChargeStatementCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
//		
//		atmRequestTimeOutChargeStatementCreditPasargadFa.setOpkey("ACFC   F");
//		atmRequestTimeOutChargeStatementCreditPasargadFa.setIfxType(IfxType.CHARGE_STATEMENT_REV_REPEAT);
//		atmRequestTimeOutChargeStatementCreditPasargadFa.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestTimeOutChargeStatementCreditPasargadFa.setCurrency(currency);
//		atmRequestTimeOutChargeStatementCreditPasargadFa.setLanguage(UserLanguage.FARSI_LANG);
//		atmRequestTimeOutChargeStatementCreditPasargadFa.setFit(FITType.CREDIT_PASARGAD);
//		
//		atmRequestChargeStatementCreditPasargadEn.setOpkey("ICFC    ");
//		atmRequestChargeStatementCreditPasargadEn.setIfxType(IfxType.CHARGE_STATEMENT);
//		atmRequestChargeStatementCreditPasargadEn.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestChargeStatementCreditPasargadEn.setCurrency(currency);
//		atmRequestChargeStatementCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestChargeStatementCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
//		
//		atmRequestTimeOutChargeStatementCreditPasargadEn.setOpkey("ICFC   F");
//		atmRequestTimeOutChargeStatementCreditPasargadEn.setIfxType(IfxType.CHARGE_STATEMENT_REV_REPEAT);
//		atmRequestTimeOutChargeStatementCreditPasargadEn.setTrnType(TrnType.CHARGE_STATEMENT);
//		atmRequestTimeOutChargeStatementCreditPasargadEn.setCurrency(currency);
//		atmRequestTimeOutChargeStatementCreditPasargadEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		atmRequestTimeOutChargeStatementCreditPasargadEn.setFit(FITType.CREDIT_PASARGAD);
//		
//		/*****************************/
//		List<ResponseScreen> screenChargeStatementList = new ArrayList<ResponseScreen>();
//		
//		ResponseScreen screenCheckOrganizationFa = new ResponseScreen();
//		screenCheckOrganizationFa.setScreenno("388");
//		screenCheckOrganizationFa.setDesc("صورتحساب شارژ-موفق-فارسی");
//		screenCheckOrganizationFa.setLanguage(UserLanguage.FARSI_LANG);
//		screenCheckOrganizationFa.setScreenData("388[FF][SI]@@[ESC]P2126[ESC]\\");  //AldTODO Task117 : Akse jadid niaz ast shomare akse jadid gerefte shavad
//		screenChargeStatementList.add(screenCheckOrganizationFa);
//		getGeneralDao().saveOrUpdate(screenCheckOrganizationFa);
//		
//		ResponseScreen screenCheckOrganizationEn = new ResponseScreen();
//		screenCheckOrganizationEn.setScreenno("788");
//		screenCheckOrganizationEn.setDesc("صورتحساب شارژ-موفق-انگلیسی");
//		screenCheckOrganizationEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		screenCheckOrganizationEn.setScreenData("788[FF][SI]@@[ESC]P2526[ESC]\\");  //AldTODO Task117 : Akse jadid niaz ast shomare akse jadid gerefte shavad
//		screenChargeStatementList.add(screenCheckOrganizationEn);
//		getGeneralDao().saveOrUpdate(screenCheckOrganizationEn);		
//
//		List<ResponseScreen> screenRecieptList = new ArrayList<ResponseScreen>();
//		
//		ResponseScreen screenRecieptFa = new ResponseScreen();
//		screenRecieptFa.setScreenno("384");
//		screenRecieptFa.setDesc("صورتحساب شارژ-خطای رسید-فارسی");
//		screenRecieptFa.setLanguage(UserLanguage.FARSI_LANG);
//		screenRecieptFa.setScreenData("384[FF][SI]@@[ESC]P2142[ESC]\\");
//		screenRecieptList.add(screenRecieptFa);
//		getGeneralDao().saveOrUpdate(screenRecieptFa);
...
//		ResponseScreen screenRecieptEn = new ResponseScreen();
//		screenRecieptEn.setScreenno("784");
//		screenRecieptEn.setDesc("صورتحساب شارژ-خطای رسید-انگلیسی");
//		screenRecieptEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		screenRecieptEn.setScreenData("784[FF][SI]@@[ESC]P2542[ESC]\\");
//		screenRecieptList.add(screenRecieptEn);
//		getGeneralDao().saveOrUpdate(screenRecieptEn);
...
//		ResponseScreen screenTimeoutFa = new ResponseScreen();
//		screenTimeoutFa.setScreenno("398");
//		screenTimeoutFa.setDesc("صورتحساب شارژ-Timeout-فارسی");
//		screenTimeoutFa.setLanguage(UserLanguage.FARSI_LANG);
//		screenTimeoutFa.setScreenData(null);
//		screenTimeoutList.add(screenTimeoutFa);
//		getGeneralDao().saveOrUpdate(screenTimeoutFa);
...
//		ResponseScreen screenTimeoutEn = new ResponseScreen();
//		screenTimeoutEn.setScreenno("798");
//		screenTimeoutEn.setDesc("صورتحساب شارژ-Timeout-انگلیسی");
//		screenTimeoutEn.setLanguage(UserLanguage.ENGLISH_LANG);
//		screenTimeoutEn.setScreenData(null);
//		screenTimeoutList.add(screenTimeoutEn);
//		getGeneralDao().saveOrUpdate(screenTimeoutEn);
...
//		/*****************************/
//		FunctionCommandResponse responseShetab = new FunctionCommandResponse();
//		responseShetab.setName("صورتحساب شارژ-شتابی-موفق");
//		responseShetab.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseShetab.setNextState("596");
//		responseShetab.setScreen(screenChargeStatementList);
//		responseShetab.setReceipt(receiptList);
//		getGeneralDao().saveOrUpdate(responseShetab);
//		
//		/*****************************/
//		
//		FunctionCommandResponse responsePasargad = new FunctionCommandResponse();
//		responsePasargad.setName("صورتحساب شارژ-داخلی-موفق");
//		responsePasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responsePasargad.setNextState("096");
//		responsePasargad.setScreen(screenChargeStatementList);
//		responsePasargad.setReceipt(receiptList);
//		getGeneralDao().saveOrUpdate(responsePasargad);
//		
//		/*****************************/
//		
//		FunctionCommandResponse responseCreditPasargad = new FunctionCommandResponse();
//		responseCreditPasargad.setName("صورتحساب شارژ-اعتباری داخلی-موفق");
//		responseCreditPasargad.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseCreditPasargad.setNextState("196");
//		responseCreditPasargad.setScreen(screenChargeStatementList);
//		responseCreditPasargad.setReceipt(receiptList);
//		getGeneralDao().saveOrUpdate(responseCreditPasargad);
//		
//		/*****************************/
...
//		/*****************************/
//		FunctionCommandResponse responseTimeOut = new FunctionCommandResponse();
//		responseTimeOut.setName("صورتحساب شارژ-time out");
//		responseTimeOut.setBeRetain(false);
//		responseTimeOut.setFunctionCommand(NDCFunctionIdentifierConstants.SET_NEXT_STATE_AND_PRINT);
//		responseTimeOut.setNextState("713");
//		responseTimeOut.setScreen(screenTimeoutList);
...
//		/*****************************/
//		
//		atmRequestChargeStatementShetabEn.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseShetab);
//		atmRequestTimeOutChargeStatementShetabEn.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseTimeOut);
//		atmRequestChargeStatementShetabFa.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseShetab);
//		atmRequestTimeOutChargeStatementShetabFa.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseTimeOut);
//		atmRequestChargeStatementPasargadFa.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responsePasargad);
//		atmRequestTimeOutChargeStatementPasargadFa.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseTimeOut);
//		atmRequestChargeStatementPasargadEn.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responsePasargad);
//		atmRequestTimeOutChargeStatementPasargadEn.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseTimeOut);
//		atmRequestChargeStatementCreditPasargadFa.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseCreditPasargad);
//		atmRequestTimeOutChargeStatementCreditPasargadFa.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseTimeOut);
//		atmRequestChargeStatementCreditPasargadEn.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseCreditPasargad);
//		atmRequestTimeOutChargeStatementCreditPasargadEn.addAtmResponse(ATMErrorCodes.CHARGE_STATEMENT, responseTimeOut);
//		
//		/*****************************/
//		getGeneralDao().saveOrUpdate(atmRequestChargeStatementShetabFa);
//		getGeneralDao().saveOrUpdate(atmRequestChargeStatementShetabEn);
//		getGeneralDao().saveOrUpdate(atmRequestChargeStatementPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestChargeStatementPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestChargeStatementCreditPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestChargeStatementCreditPasargadEn);
//		
//		getGeneralDao().saveOrUpdate(atmRequestTimeOutChargeStatementShetabFa);
//		getGeneralDao().saveOrUpdate(atmRequestTimeOutChargeStatementShetabEn);
//		getGeneralDao().saveOrUpdate(atmRequestTimeOutChargeStatementPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestTimeOutChargeStatementPasargadEn);
//		getGeneralDao().saveOrUpdate(atmRequestTimeOutChargeStatementCreditPasargadFa);
//		getGeneralDao().saveOrUpdate(atmRequestTimeOutChargeStatementCreditPasargadEn);
//
//		requests.add(atmRequestChargeStatementShetabFa);
//		requests.add(atmRequestChargeStatementShetabEn);
//		requests.add(atmRequestChargeStatementPasargadFa);
//		requests.add(atmRequestChargeStatementPasargadEn);
//		requests.add(atmRequestChargeStatementCreditPasargadFa);
//		requests.add(atmRequestChargeStatementCreditPasargadEn);
//		
//		requests.add(atmRequestTimeOutChargeStatementShetabFa);
//		requests.add(atmRequestTimeOutChargeStatementShetabEn);
//		requests.add(atmRequestTimeOutChargeStatementPasargadFa);
//		requests.add(atmRequestTimeOutChargeStatementPasargadEn);
//		requests.add(atmRequestTimeOutChargeStatementCreditPasargadFa);
//		requests.add(atmRequestTimeOutChargeStatementCreditPasargadEn);
...
//		List<ATMRequest> restriction = Restriction(configuration/*,responsePasargadSubsidiary*/);
//		if(restriction != null)
//			requests.addAll(restriction);
