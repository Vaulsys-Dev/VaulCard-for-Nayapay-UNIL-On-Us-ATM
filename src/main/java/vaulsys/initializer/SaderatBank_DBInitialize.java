...
public class SaderatBank_DBInitialize {
	public static final long SADERAT_BIN = 505416;
	public static final String BANK_NAME = "گردشگری";

	// Institutions
	public static final long INST_MYSELF_CODE = SADERAT_BIN;
...
//	private static final String EPAY_FNP_TERMINAL_PUBLIC_KEY = "";
	...
	public static void main(String[] args) {
		...
		try {
			new SaderatBank_DBInitialize().cereateDB();
		} catch (Exception e) {
			e.printStackTrace();
		...
		GeneralDao.Instance.beginTransaction();
		try {
			new SaderatBank_DBInitialize().createCycleAccountJob();
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(2);
		}
	...
	private void cereateDB() throws Exception {
		...
		System.out.println("------- Creating Default Security Profile -------");
		...
		System.out.println("------- Creating Apacs Security Profile -------");
		SecurityProfile securityProfileAPACS = AddSecurityProfile.createAPACSSecurityProfile(DBInitializeUtil.APACS_SECURITY_PROFILE_NAME);
				
		System.out.println("------- Creating Default Authorization Profile -------");
...
//		System.out.println("------- Creating Epay Authorization Profile -------");
//		AuthorizationProfile authorizationProfile_EPAY = AddAuthorization.createAuthorizationProfile(AddAuthorization.EPAY_AUTHORIZATION_PROFILE_NAME);
		...
		System.out.println("------- Creating Pos Authorization Profile -------");
...
//		System.out.println("------- Creating ATM Authorization Profile -------");
...
//					add(new Long(SADERAT_BIN).intValue());
//			}});
...
//		authorizationProfile_ATM.addPolicy(fitPolicy);
		GeneralDao.Instance.saveOrUpdate(authorizationProfile_POS);
...
//		ClearingProfile clearingProfileATMDaily = new AddClearingProfile().createPerDayClearingProfile(new ATMDailyCycleSettlementJob());
...
//		ClearingProfile clearingProfileMCI = new AddClearingProfile().createPerDayClearingProfile(new MCIBillPaymentCycleSettlementJob());
//		ClearingProfile clearingProfileOnline = new AddClearingProfile().createPerDayClearingProfile(new OnlineCycleSettlementJob());
...
//		GeneralDao.Instance.beginTransaction();
		...
		AddInstitution.initMyInst(SADERAT_BIN, SADERAT_BIN, MYSELF_ACQUIER_TERMINAL_CODE, MYSELF_ISSUER_TERMINAL_CODE, switchTerminalGroup, securityProfileDefault, authorizationProfileDefault, null, feeProfileDefault, null, My_MAC_KEY, My_PIN_KEY, null, switchName, switchName);
		...
		AddInstitution.initGeneralInst(INST_SHETAB_CODE, INST_SHETAB_CODE, FinancialEntityRole.MASTER, SHETAB_ACQUIER_TERMINAL_CODE,
				...
				null, null, null, SHETAB_KEY, SHETAB_KEY, SHETAB_KEY, SHETAB_KEY, SHETAB_KEY, "سوئیچ خدمات",
				"سوئیچ خدمات");

//		System.out.println("------- Creating Fanap Epayment_Institution as Slave -------");
//		AddInstitution.initGeneralInst(INST_FNP_EPAY_CODE, GARDESHGARY_BIN, FinancialEntityRole.SLAVE, EPAY_FNP_TERMINAL_CODE,
