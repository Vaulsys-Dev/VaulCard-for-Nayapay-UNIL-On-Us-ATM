...
public class TatBank_DBInitialize {

	public static final long TAT_BIN = 636214;
	public static final String BANK_NAME = "تات";

	// Institutions
	public static final long INST_MYSELF_CODE = TAT_BIN;
...
//	public static final long EPAY_FNP_SHOP_CODE = 1024;
	...
	public static final String ATM_CONFIG_FILE = "C:/Documents and Settings/saber/My Documents/ATM-Config/TaatATMConfig.2010-02-22.xlsx";
...
//	private static final String EPAY_FNP_TERMINAL_PUBLIC_KEY = "";
	...
	public static void main(String[] args) {
		...
		try {
			new TatBank_DBInitialize().cereateDB();
		} catch (Exception e) {
			e.printStackTrace();
		...
		GeneralDao.Instance.beginTransaction();
		try {
			new TatBank_DBInitialize().createCycleAccountJob();
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(2);
		}
	...
	private void cereateDB() throws Exception {
		...
		SecurityProfile securityProfileAPACS = AddSecurityProfile.createDefaultSecurityProfile(
				DBInitializeUtil.DEFAULT_SECURITY_PROFILE_NAME);
...
//		MerchantCategory merchantCategory = DBInitializeUtil.createMerchantCategory(3L, "توسعه", rootMerchantCategory);
		...
		AddInstitution.initMyInst(TAT_BIN, TAT_BIN, MYSELF_ACQUIER_TERMINAL_CODE, MYSELF_ISSUER_TERMINAL_CODE, switchTerminalGroup, securityProfileDefault, authorizationProfileDefault, null, feeProfileDefault, null, My_MAC_KEY, My_PIN_KEY, null, switchName, switchName);
...
//		AddInstitution.initGeneralInst(INST_FNP_EPAY_CODE, TAT_BIN, FinancialEntityRole.SLAVE, EPAY_FNP_TERMINAL_CODE,
//				NO_TERMINAL_CODE, epayTerminalGroup, securityProfileDefault, authorizationProfile_EPAY, null,
//				feeProfileDefault, chargeAssignmentPolicy, null, null, EPAY_FNP_MASTER_KEY, "سايت اينترنتی" ,
//				"سايت اینترنتی "+switchName);
		
		
		System.out.println("------- Creating Merchant -------");
		/*Merchant merchant = DBInitializeAddingPos.initMerchant(false, MERCHANT_GENERAL_CODE, feeProfileDefault,authorizationProfileDefault, MERCHANT_ACCOUNT, MERCHANT_OWNERNAME, merchantFinancialEntityGroup, merchantCategory);
