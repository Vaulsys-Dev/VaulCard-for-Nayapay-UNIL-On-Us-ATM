...
public class GardeshgaryBank_DBInitialize {
	public static final long GARDESHGARY_BIN = 505416;
	public static final String BANK_NAME = "گردشگری";

	// Institutions
	public static final long INST_MYSELF_CODE = GARDESHGARY_BIN;
...
//	private static final String EPAY_FNP_TERMINAL_PUBLIC_KEY = "";
	...
	public static void main(String[] args) {
		...
		try {
			new GardeshgaryBank_DBInitialize().cereateDB();
		} catch (Exception e) {
			e.printStackTrace();
		...
		GeneralDao.Instance.beginTransaction();
		try {
			new GardeshgaryBank_DBInitialize().createCycleAccountJob();
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(2);
		}
	...
	private void cereateDB() throws Exception {
		...
		PanPrefixTransactionPolicy panPrefixTrxPolicy = initializer.addPanPrefixTransactionPolicy(authorizationProfile_POS, 
				new ArrayList<Integer>(){{
					add(new Long(GARDESHGARY_BIN).intValue());
			}});
...
//		GeneralDao.Instance.beginTransaction();
		...
		AddInstitution.initMyInst(GARDESHGARY_BIN, GARDESHGARY_BIN, MYSELF_ACQUIER_TERMINAL_CODE, MYSELF_ISSUER_TERMINAL_CODE, switchTerminalGroup, securityProfileDefault, authorizationProfileDefault, null, feeProfileDefault, null, My_MAC_KEY, My_PIN_KEY, null, switchName, switchName);
