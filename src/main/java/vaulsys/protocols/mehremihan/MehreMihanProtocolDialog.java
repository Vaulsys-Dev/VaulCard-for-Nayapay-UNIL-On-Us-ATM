...
public class MehreMihanProtocolDialog implements ProtocolDialog {
	transient Logger logger = Logger.getLogger(MehreMihanProtocolDialog.class);
	...
	public ProtocolMessage refine(ProtocolMessage protocolMessage) {
		...
		int[] msg200 = new int[]{2, 3, 4, 6, 7,/*10,*/11, 12, 13, 14, /*15,*/ 17,/*18,*/25, 32, 33, 35, 37, 41, 42, 43, 48, 49,/*51,*/52, 100/*,64*/};
		...
		int[] msg400 = new int[]{2, 3, 4, 6, 7, 10, 11, 12, 13, /*15,*/ 17, 32, 33, 35, 37, 38, 39, 41, 42, 43, 48, 49, 51, 90, 95, 100/*,128*/};
	...
	{
		//logger.info("Translating incoming message from MehreMihan...");
		return protocolMessage;
	}
	...
	{
		//logger.info("Translating outgoing message for MehreMihan...");
		return protocolMessage;
	}
