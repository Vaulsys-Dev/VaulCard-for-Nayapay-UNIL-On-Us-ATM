...
public class Shetab87ProtocolDialog implements ProtocolDialog {

    transient Logger logger = Logger.getLogger(Shetab87ProtocolDialog.class);
...
//    }
    ...
    {
        //logger.info("Translating incoming message from Shetab...");
        return protocolMessage;
    }
    ...
    {
        //logger.info("Translating outgoing message for Shetab...");
        return protocolMessage;
    }
