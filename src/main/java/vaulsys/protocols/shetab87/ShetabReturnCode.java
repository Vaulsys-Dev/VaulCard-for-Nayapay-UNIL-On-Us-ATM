...
public class ShetabReturnCode {
    ...
    static {
        addCode(ShetabReturnCode.approved, "000");
        map(IFXReturnCode.getErrorCode(IFXReturnCode.NoError), "000");

        addCode(ShetabReturnCode.do_not_honour, "100");


        addCode(ShetabReturnCode.expired_card, "101");
        addCode(ShetabReturnCode.suspected_fraud, "102");
        addCode(ShetabReturnCode.restricted_card, "104");

        addCode(ShetabReturnCode.no_destination, "908");
