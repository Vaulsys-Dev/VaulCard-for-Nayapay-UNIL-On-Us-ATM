...
public class InfotechProtocolDialog implements ProtocolDialog {

    transient Logger logger = Logger.getLogger(InfotechProtocolDialog.class);
    ...
    public ProtocolMessage refine(ProtocolMessage protocolMessage) {
        ...
        InfotechRequiredFieldsRepository requiredFields = new InfotechRequiredFieldsRepository();
    ...
    {
        //logger.info("Translating incoming message from Infotech...");
        return protocolMessage;
    }
    ...
    {
        //logger.info("Translating outgoing message for Infotech...");
        return protocolMessage;
    }
