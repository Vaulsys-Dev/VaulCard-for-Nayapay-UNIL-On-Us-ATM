...
public class NeginReturnCode {
    ...
    static {
        addCode(NeginReturnCode.approved, "000");
        map(IFXReturnCode.getErrorCode(IFXReturnCode.NoError), "000");

        addCode(NeginReturnCode.do_not_honour, "100");


        addCode(NeginReturnCode.expired_card, "101");
        addCode(NeginReturnCode.suspected_fraud, "102");
        addCode(NeginReturnCode.restricted_card, "104");

        addCode(NeginReturnCode.no_destination, "908");
