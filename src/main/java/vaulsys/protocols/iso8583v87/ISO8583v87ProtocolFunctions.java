...
public class ISO8583v87ProtocolFunctions extends ISOFunctions {

    transient Logger logger = Logger.getLogger(ISO8583v87ProtocolFunctions.class);
...
//        			getFinancialEntityService().getLastValidWorkingDay((Institution) endPointTerminal.getOwner());
	...
	public ISOPackager getPackager() {
		return ((ISO8583v87Protocol) ProtocolProvider
                .Instance.getByClass(ISO8583v87Protocol.class))
                .getPackager();
	}

	@Override
	public IfxToProtocolMapper getIfxToProtocolMapper() {
		return ISO8583v87IFXToISOMapper.Instance; 
	}

	@Override
	public ProtocolToIfxMapper getProtocolToIfxMapper() {
		return ISO8583v87ISOToIFXMapper.Instance;
	}

	@Override
	public ProtocolDialog getDialog() {
		return new ISO8583v87ProtocolDialog();
	}
