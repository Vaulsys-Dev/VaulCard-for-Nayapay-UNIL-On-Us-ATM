...
public class ISO8583v87ProtocolDialog implements ProtocolDialog {

    transient Logger logger = Logger.getLogger(ISO8583v87ProtocolDialog.class);
    ...
    public ProtocolMessage refine(ProtocolMessage protocolMessage) {
        ...
        int[] msg400 = new int[]{2, 3, 4, 6, 7, 10, 11, 12, 13, 15, 17, 32, 33, 35, 37, 38, 39, 41, 42, 43, 48, 49, 51, 90, 95/*,128*/};
    ...
    {
        //logger.info("Translating incoming message from ISO8583v87...");
        return protocolMessage;
    }
    ...
    {
        //logger.info("Translating outgoing message for ISO8583v87...");
        return protocolMessage;
    }
}
