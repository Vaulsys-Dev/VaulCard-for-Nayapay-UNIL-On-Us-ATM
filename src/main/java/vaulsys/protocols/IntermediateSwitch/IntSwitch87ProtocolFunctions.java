...
public class IntSwitch87ProtocolFunctions extends ISOFunctions {

    transient Logger logger = Logger.getLogger(IntSwitch87ProtocolFunctions.class);
...
//        	}
	...
	public ISOPackager getPackager() {
		return ((IntSwitch87Protocol) ProtocolProvider
                .Instance.getByClass(IntSwitch87Protocol.class))
                .getPackager();
	}

	@Override
	public IfxToProtocolMapper getIfxToProtocolMapper() {
		return IntSwitch87IFXToISOMapper.Instance;
	}

	@Override
	public ProtocolToIfxMapper getProtocolToIfxMapper() {
		return IntSwitch87ISOToIFXMapper.Instance;
	}

	@Override
	public ProtocolDialog getDialog() {
		return new IntSwitch87ProtocolDialog();
	}
