...
public class JCBProtocolFunctions extends ISOFunctions {
    @Override
    public ISOPackager getPackager() {
        return ((JCBProtocol) ProtocolProvider
                .Instance.getByClass(JCBProtocol.class))
                .getPackager();
    }

    @Override
    public ProtocolDialog getDialog() {
        return new JCBProtocolDialog();
    }

    @Override
    public IfxToProtocolMapper getIfxToProtocolMapper() {
        return JCBIFXToISOMapper.Instance;
    }

    @Override
    public ProtocolToIfxMapper getProtocolToIfxMapper() {
        return JCBISOToIFXMapper.Instance;
    }
