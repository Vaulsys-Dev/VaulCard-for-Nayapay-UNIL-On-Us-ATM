...
public class OnelinkProtocolDialog implements ProtocolDialog {

    private Map<String, Map<Integer, Character>> msgElementDefinition;

    transient Logger logger = Logger.getLogger(OnelinkProtocolDialog.class);

    OnelinkProtocolDialog() {
    ...
    {
        logger.info("Translating incoming message from OneLink...");
        return protocolMessage;
    }
    ...
    {
        logger.info("Translating outgoing message for OneLink...");
        return protocolMessage;
    }
