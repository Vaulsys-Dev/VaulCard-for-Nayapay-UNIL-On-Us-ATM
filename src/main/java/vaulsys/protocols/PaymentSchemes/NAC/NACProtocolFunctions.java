...
public class NACProtocolFunctions extends ISOFunctions {
    @Override
    public ISOPackager getPackager() {
        return ((NACProtocol) ProtocolProvider
                .Instance.getByClass(NACProtocol.class))
                .getPackager();
    }

    @Override
    public ProtocolDialog getDialog() {
        return new NACProtocolDialog();
    }

    @Override
    public IfxToProtocolMapper getIfxToProtocolMapper() {
        return NACIFXToISOMapper.Instance;
    }

    @Override
    public ProtocolToIfxMapper getProtocolToIfxMapper() {
        return NACISOToIFXMapper.Instance;
    }
