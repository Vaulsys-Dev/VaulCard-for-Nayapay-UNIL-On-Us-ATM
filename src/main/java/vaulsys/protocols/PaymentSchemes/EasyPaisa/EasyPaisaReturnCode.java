...
public class EasyPaisaReturnCode {
    ...
    static {
        addCode(EasyPaisaReturnCode.approved, "000");
        map(IFXReturnCode.getErrorCode(IFXReturnCode.NoError), "000");

        addCode(EasyPaisaReturnCode.do_not_honour, "100");


        addCode(EasyPaisaReturnCode.expired_card, "101");
        addCode(EasyPaisaReturnCode.suspected_fraud, "102");
        addCode(EasyPaisaReturnCode.restricted_card, "104");

        addCode(EasyPaisaReturnCode.no_destination, "908");
