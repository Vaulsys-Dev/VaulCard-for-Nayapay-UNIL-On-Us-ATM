...
public class EasyPaisaISOToIFXMapper extends ISOtoIfxMapper {

	public static final EasyPaisaISOToIFXMapper Instance = new EasyPaisaISOToIFXMapper();
	
	protected EasyPaisaISOToIFXMapper(){}
