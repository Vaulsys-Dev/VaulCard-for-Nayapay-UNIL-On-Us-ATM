...
public class EasyPaisaIFXToISOMapper extends IfxToISOMapper{

	transient Logger logger = Logger.getLogger(EasyPaisaIFXToISOMapper.class);
	public static final EasyPaisaIFXToISOMapper Instance = new EasyPaisaIFXToISOMapper();
	
	protected EasyPaisaIFXToISOMapper(){}
	
    public ISOMsg map(Ifx ifx, EncodingConvertor convertor) throws ISOException {
		ISOMsg isoMsg = new ISOMsg();
		ISOPackager packager = ((EasyPaisaProtocol) ProtocolProvider.Instance
				.getByClass(EasyPaisaProtocol.class)).getPackager();
