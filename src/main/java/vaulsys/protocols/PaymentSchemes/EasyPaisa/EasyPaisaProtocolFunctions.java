...
public class EasyPaisaProtocolFunctions extends ISOFunctions {

    transient Logger logger = Logger.getLogger(EasyPaisaProtocolFunctions.class);
...
//        	}
	...
	public ISOPackager getPackager() {
		return ((EasyPaisaProtocol) ProtocolProvider
                .Instance.getByClass(EasyPaisaProtocol.class))
                .getPackager();
	}

	@Override
	public IfxToProtocolMapper getIfxToProtocolMapper() {
		return EasyPaisaIFXToISOMapper.Instance;
	}

	@Override
	public ProtocolToIfxMapper getProtocolToIfxMapper() {
		return EasyPaisaISOToIFXMapper.Instance;
	}

	@Override
	public ProtocolDialog getDialog() {
		return new EasyPaisaProtocolDialog();
	}
