...
public class EasyPaisaProtocolDialog implements ProtocolDialog {

    private Map<String, Map<Integer, Character>> msgElementDefinition;
    public EasyPaisaProtocolDialog() {
        ...
        //msgElementDefinition.get("0100").put(53, 'C'); //Not Required
    ...
    transient Logger logger = Logger.getLogger(EasyPaisaProtocolDialog.class);
...
//    }
    ...
    {
        //logger.info("Translating incoming message from EasyPaisa...");
        return protocolMessage;
    }
    ...
    {
        //logger.info("Translating outgoing message for EsayPaisa...");
        return protocolMessage;
    }
