 ...
 */
public class VisaBaseIIFXToISOMapper extends IfxToISOMapper {

    transient Logger logger = Logger.getLogger(VisaBaseIIFXToISOMapper.class);
    public static final VisaBaseIIFXToISOMapper Instance = new VisaBaseIIFXToISOMapper();

    protected VisaBaseIIFXToISOMapper() {
    }
    ...
    public ProtocolMessage map(Ifx ifxObj, EncodingConvertor convertor) throws Exception {
        ...
        ISOPackager isoPackager = ((VisaBaseIProtocol) ProtocolProvider.Instance.getByClass(VisaBaseIProtocol.class)).getPackager();
