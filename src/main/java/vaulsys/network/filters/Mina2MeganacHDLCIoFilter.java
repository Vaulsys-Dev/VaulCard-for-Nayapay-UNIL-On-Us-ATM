...
public class Mina2MeganacHDLCIoFilter extends IoFilterAdapter {
	transient Logger logger = Logger.getLogger(Mina2MeganacHDLCIoFilter.class);
...
//	public static int realLen = 4 + syncHDLCHeader.length + 2 + 2;
