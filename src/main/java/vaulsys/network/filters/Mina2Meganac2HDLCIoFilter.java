...
public class Mina2Meganac2HDLCIoFilter extends IoFilterAdapter {
	transient Logger logger = Logger.getLogger(Mina2Meganac2HDLCIoFilter.class);
...
//	public static int realLen = 2 + syncHDLCHeader.length + 2 + 2;
	...
	public void filterWrite(NextFilter nextFilter, IoSession session, WriteRequest writeRequest) throws Exception {
		...
		binData[index + 0] = (byte) (data.length / 256);
		binData[index + 1] = (byte) ((data.length % 256));
