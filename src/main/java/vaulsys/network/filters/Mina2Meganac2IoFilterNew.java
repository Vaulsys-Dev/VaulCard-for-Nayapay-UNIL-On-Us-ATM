...
public class Mina2Meganac2IoFilterNew extends IoFilterAdapter {
	transient Logger logger = Logger.getLogger(Mina2Meganac2IoFilterNew.class);
...
//			logger.info("binaryReceiveBytes.get(index)= "+binaryReceiveBytes.get(index));
