...
public class TimerData extends ATMCustomizationData {

	@ManyToOne
    @JoinColumn(name = "timer_atmconfig")
    @ForeignKey(name="timer_atmconfig_fk")
	...
	public ATMCustomizationDataType getType() {
		return ATMCustomizationDataType.TIMER;
	}
