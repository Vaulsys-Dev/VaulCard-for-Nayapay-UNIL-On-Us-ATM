 ...
 */
@Entity
@Table(name = "CMS_DEBIT_REMAININGLIMIT")
public class CMSDebitRemainingLimit implements IEntity<Long> {
    ...
    @ForeignKey(name="cms_prod_debit_limit_fk")
    private CMSProductDebitLimit limitId;
    ...
    @ForeignKey(name = "ind_limit_debit_limit_fk")
    ...
    public CMSProductDebitLimit getLimitId() {
        return limitId;
    }

    public void setLimitId(CMSProductDebitLimit limitId) {
