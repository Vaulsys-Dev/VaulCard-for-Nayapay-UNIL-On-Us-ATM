 ...
 */
@Entity
@Table(name = "CMS_PRODUCT_DEBIT_LIMIT")
public class CMSProductDebitLimit implements IEntity<Long> {
    ...
    @ForeignKey(name = "debit_limit_prod_fk")
...
//    private Long parentLimitId;
    ...
    @ForeignKey(name = "debit_limit_parent_fk")
    private CMSProductDebitLimit parentLimitId;
    ...
    public CMSProductDebitLimit getParentLimitId() {
        return parentLimitId;
    }

    public void setParentLimitId(CMSProductDebitLimit parentLimitId) {
