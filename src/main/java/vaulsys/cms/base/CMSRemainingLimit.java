 ...
 */
@Entity
@Table(name = "CMS_REMAININGLIMIT")
public class CMSRemainingLimit implements IEntity<Long> {
    ...
    @ForeignKey(name="cms_prodlimit_fk")
    private CMSProductLimit limitId;
    ...
    public CMSProductLimit getLimitId() {
        return limitId;
    }

    public void setLimitId(CMSProductLimit limitId) {
