 ...
 * Created by Raza
 */
public class CardNotFoundException extends DecisionMakerExceptionImp {
    ...
    public CardNotFoundException(String s, Boolean returnError) {
        super(s);
        this.returnError = returnError;
    }

    public CardNotFoundException(Boolean returnError) {
        super();
        this.returnError = returnError;
    }

    public CardNotFoundException(String arg0, Throwable arg1, Boolean returnError) {
        super(arg0, arg1);
        this.returnError = returnError;
    }

    public CardNotFoundException(Throwable arg0, Boolean returnError) {
        super(arg0);
        this.returnError = returnError;
    }
