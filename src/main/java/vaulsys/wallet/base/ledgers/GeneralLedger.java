...
public class GeneralLedger implements IEntity<Long>, Cloneable {

    @Id
    @GeneratedValue(generator="GENERAL_LEDGER_SEQ-gen")
    @org.hibernate.annotations.GenericGenerator(name = "GENERAL_LEDGER_SEQ-gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @org.hibernate.annotations.Parameter(name = "optimizer", value = "pooled"),
                    @org.hibernate.annotations.Parameter(name = "increment_size", value = "1"),
                    @org.hibernate.annotations.Parameter(name = "sequence_name", value = "GENERAL_LEDGER_ID_SEQ")
            })
    private Long id;
    ...
    @ForeignKey(name="GNRLLEDGR_ACCT_FK")
