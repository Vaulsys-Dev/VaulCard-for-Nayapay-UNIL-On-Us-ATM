 ...
 * 
 */
@WebServiceClient(name = "WebServiceService", targetNamespace = "http://nayapaybankservice/", wsdlLocation = "http://localhost:9000/BankService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://nayapaybankservice/", "WebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9000/BankService?wsdl");
    ...
    public WebService getWebServicePort() {
        return super.getPort(new QName("http://nayapaybankservice/", "WebServicePort"), WebService.class);
    }
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://nayapaybankservice/", "WebServicePort"), WebService.class, features);
    }
