...
public class WalletCMSWSServer implements Runnable {
    ...
    public void run() {
        try {
            ...
            connector.setPort(GlobalContext.getInstance().getChannelbyId(ChannelCodes.WALLETUNILONUSATM).getPort());// Huzaifa: 11/08/2023: FW: NAP-P5-23 ==> [ Logging email ] ==> Segregation of ATM On Us Channels Bank - UBL & BAFL
