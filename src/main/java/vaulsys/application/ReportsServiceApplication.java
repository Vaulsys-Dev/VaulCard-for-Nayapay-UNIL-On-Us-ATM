...
import vaulsys.util.SwitchReportsServiceApplication;
import vaulsys.wfe.GlobalContext;
import vaulsys.wfe.process.SwitchThreadPool;
import org.apache.log4j.Logger;

public class ReportsServiceApplication extends BaseApp {
    transient Logger logger = Logger.getLogger(ReportsServiceApplication.class);
    ...
    public void startup() {
        ...
        try {
            JobServiceQuartz.init(JobServiceQuartz.REPORT_CONFIG);

            SwitchReportsServiceApplication.get().startup();
